{-# LANGUAGE PackageImports,RecordWildCards,DeriveDataTypeable,LambdaCase,OverloadedStrings,StandaloneDeriving,ExplicitForAll,DeriveGeneric,FlexibleInstances,TupleSections #-}
...
deriving instance GHCG.Generic GlobalDecls

deriving instance Data GlobalDecls
deriving instance Typeable GlobalDecls
...
identDeclType :: Ident -> CFilter VarDecl Type
identDeclType ident (VarDecl (VarName varident _) _ ty) | ident==varident = [ ty ]
identDeclType _ _ = []

identType :: Ident -> CFilter GlobalDecls Type
identType ident = findAll (identDeclType ident)