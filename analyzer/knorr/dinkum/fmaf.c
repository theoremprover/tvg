...
float (fmaf)(float x, float y, float z)
 ...
 if ((errx = _FDunscale(&expx, &xp)) == 2)
  ...
  if (errx != 0 && erry != 0
   && (errz != 1 || ((((_Fval *)(char *)&(x))->_Sh[1] & ((unsigned short)0x8000)) ^ (((_Fval *)(char *)&(y))->_Sh[1] & ((unsigned short)0x8000))) == (((_Fval *)(char *)&(z))->_Sh[1] & ((unsigned short)0x8000))))
   return (x * y + z);
  else
   {
   _Feraise(0x01);
  ...
  expz -= expw;
  if (((((_Fval *)(char *)&(x))->_Sh[1] & ((unsigned short)0x8000)) ^ (((_Fval *)(char *)&(y))->_Sh[1] & ((unsigned short)0x8000)) ^ (((_Fval *)(char *)&(z))->_Sh[1] & ((unsigned short)0x8000))) == 0
   || expz < -2 || 2 < expz)
   return (x * y + z);
  else
   {
