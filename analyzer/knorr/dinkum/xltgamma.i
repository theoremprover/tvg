...
static const struct Approx approx0[] = {




 {174.0L, 35.0L / 3132.0L, s10, ((sizeof (s10) / sizeof ((s10)[0])) - 1), c10, ((sizeof (c10) / sizeof ((c10)[0])) - 1)},

 };
static long double stirling(long double *px, short *pex)
 {
 int i;
 long double x = *px;
 ...
 *px = _LPoly(y, approx0[i].den, approx0[i].dsize)
  / _LPoly(y, approx0[i].num, approx0[i].nsize);
 *px /= rootxx * expl(-x);
 return (0.0L);
  }
 }
