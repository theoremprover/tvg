...
long double *_LXp_sqrtx(long double *, int, long double *);
                   ...
                   _Dconst _LDenorm = {{1, 0, 0, 0}};
                   _Dconst _LEps = {
 {0, 0, 0, (0x3fe - (48 + 4) - 1) << 4}};
                   _Dconst _LInf = {{0, 0, 0, ((unsigned short)((1 << (15 - 4)) - 1)) << 4}};
                   _Dconst _LNan = {{0, 0, 0, (((unsigned short)((1 << (15 - 4)) - 1)) << 4) | (1 << (4 - 1))}
                      };
                   _Dconst _LSnan = {{1, 0, 0, ((unsigned short)((1 << (15 - 4)) - 1)) << 4}};
                   _Dconst _LRteps = {
 {0, 0, 0, (0x3fe - (48 + 4) / 2) << 4}};
                   long double _LXbig = ((48 + 4) + 1) * 347L / 1000;
                   long double _LZero = 0.0L;
