...
_Dcomplex (catanh)(_Dcomplex x)
 ...
 if (errx == 2)
  ...
  if (errx == 1 || errx == 0)
   {
   u = (((_Dval *)(char *)&(re))->_Sh[3] & ((unsigned short)0x8000)) ? -_Zero : 0.0;
   v = im;
   }
  else
   {
  ...
  {
  u = re < 0.0 ? -_Zero : 0.0;
  v = (((_Dval *)(char *)&(im))->_Sh[3] & ((unsigned short)0x8000)) ? -piby2 : piby2;
  }
 else
  {
  int neg;
  double magim = (((_Dval *)(char *)&(im))->_Sh[3] & ((unsigned short)0x8000)) ? -im : im;
