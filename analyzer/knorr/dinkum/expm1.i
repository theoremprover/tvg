...
static const double lnhalf = -0.69314718055994530941723212145817658;
static const double lnone_half = 0.40546510810816438197801311546434915;
...
double (expm1)(double x)
 ...
 case 0:
  return (x);
 case 1:
  return ((((_Dval *)(char *)&(x))->_Sh[3] & ((unsigned short)0x8000)) ? -1.0 : x);
 default:
