...
_Lcomplex (catanhl)(_Lcomplex x)
 ...
 if (errx == 2)
  ...
  if (errx == 1 || errx == 0)
   {
   u = (((_Lval *)(char *)&(re))->_Sh[3] & ((unsigned short)0x8000)) ? -_LZero : 0.0L;
   v = im;
   }
  else
   {
  ...
  v = (((_Lval *)(char *)&(im))->_Sh[3] & ((unsigned short)0x8000)) ? -piby2 : piby2;
  }
 else
  {
  int neg;
  long double magim = (((_Lval *)(char *)&(im))->_Sh[3] & ((unsigned short)0x8000)) ? -im : im;
