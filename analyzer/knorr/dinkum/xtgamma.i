...
static const struct Approx approx0[] = {
 ...
 {174.0, 35.0 / 3132.0, s10, ((sizeof (s10) / sizeof ((s10)[0])) - 1), c10, ((sizeof (c10) / sizeof ((c10)[0])) - 1)},

 };
static double stirling(double *px, short *pex)
 {
 int i;
 double x = *px;
 ...
 *px = _Poly(y, approx0[i].den, approx0[i].dsize)
  / _Poly(y, approx0[i].num, approx0[i].nsize);
 *px /= rootxx * exp(-x);
 return (0.0);
  }
 }
