...
long double *_LXp_sqrtx(long double *, int, long double *);
                   ...
                   _Dconst _Denorm = {{1, 0, 0, 0}};
                   _Dconst _Eps = {
 {0, 0, 0, (0x3fe - (48 + 4) - 1) << 4}};
                   _Dconst _Hugeval = {{0, 0, 0, ((unsigned short)((1 << (15 - 4)) - 1)) << 4}};
                   _Dconst _Inf = {{0, 0, 0, ((unsigned short)((1 << (15 - 4)) - 1)) << 4}};
                   _Dconst _Nan = {{0, 0, 0, (((unsigned short)((1 << (15 - 4)) - 1)) << 4) | (1 << (4 - 1))}
                      };
                   _Dconst _Snan = {{1, 0, 0, ((unsigned short)((1 << (15 - 4)) - 1)) << 4}};
                   _Dconst _Rteps = {
 {0, 0, 0, (0x3fe - (48 + 4) / 2) << 4}};

                   double _Xbig = ((48 + 4) + 1) * 347L / 1000;
                   double _Zero = 0.0;
