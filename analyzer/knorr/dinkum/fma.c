...
extern double _Xp_getw(double *, int);
extern double *_Xp_setw(double *, int, double);
extern double *_Xp_mulh(double *, int, double);
extern double *_Xp_addx(double *, int, double *, int);
...
double (fma)(double x, double y, double z)
 ...
 if ((errx = _Dunscale(&expx, &xp)) == 2)
  ...
  if (errx != 0 && erry != 0
   && (errz != 1 || ((((_Dval *)(char *)&(x))->_Sh[3] & ((unsigned short)0x8000)) ^ (((_Dval *)(char *)&(y))->_Sh[3] & ((unsigned short)0x8000))) == (((_Dval *)(char *)&(z))->_Sh[3] & ((unsigned short)0x8000))))
   return (x * y + z);
  else
   {
   _Feraise(0x01);
  ...
  expz -= expw;
  if (((((_Dval *)(char *)&(x))->_Sh[3] & ((unsigned short)0x8000)) ^ (((_Dval *)(char *)&(y))->_Sh[3] & ((unsigned short)0x8000)) ^ (((_Dval *)(char *)&(z))->_Sh[3] & ((unsigned short)0x8000))) == 0
   || expz < -2 || 2 < expz)
   return (x * y + z);
  else
   {
