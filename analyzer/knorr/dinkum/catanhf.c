...
_Fcomplex (catanhf)(_Fcomplex x)
 ...
 if (errx == 2)
  ...
  if (errx == 1 || errx == 0)
   {
   u = (((_Fval *)(char *)&(re))->_Sh[1] & ((unsigned short)0x8000)) ? -_FZero : 0.0F;
   v = im;
   }
  else
   {
  ...
  v = (((_Fval *)(char *)&(im))->_Sh[1] & ((unsigned short)0x8000)) ? -piby2 : piby2;
  }
 else
  {
  int neg;
  float magim = (((_Fval *)(char *)&(im))->_Sh[1] & ((unsigned short)0x8000)) ? -im : im;
