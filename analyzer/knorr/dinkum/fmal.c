...
extern long double _LXp_getw(long double *, int);
extern long double *_LXp_setw(long double *, int, long double);
extern long double *_LXp_mulh(long double *, int, long double);
extern long double *_LXp_addx(long double *, int, long double *, int);
...
long double (fmal)(long double x, long double y, long double z)
 ...
 if ((errx = _LDunscale(&expx, &xp)) == 2)
  ...
  if (errx != 0 && erry != 0
   && (errz != 1 || ((((_Lval *)(char *)&(x))->_Sh[3] & ((unsigned short)0x8000)) ^ (((_Lval *)(char *)&(y))->_Sh[3] & ((unsigned short)0x8000))) == (((_Lval *)(char *)&(z))->_Sh[3] & ((unsigned short)0x8000))))
   return (x * y + z);
  else
   {
   _Feraise(0x01);
  ...
  expz -= expw;
  if (((((_Lval *)(char *)&(x))->_Sh[3] & ((unsigned short)0x8000)) ^ (((_Lval *)(char *)&(y))->_Sh[3] & ((unsigned short)0x8000)) ^ (((_Lval *)(char *)&(z))->_Sh[3] & ((unsigned short)0x8000))) == 0
   || expz < -2 || 2 < expz)
   return (x * y + z);
  else
   {
