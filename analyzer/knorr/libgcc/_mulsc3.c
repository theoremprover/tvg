...
extern void *compile_type_assert[sizeof(__builtin_huge_valf ()) == sizeof(SFtype) ? 1 : -1];
SCtype
__mulsc3 (SFtype a, SFtype b, SFtype c, SFtype d)
{
  SFtype ac, bd, ad, bc, x, y;
  SCtype res;
      ...
      if (__builtin_expect (!__builtin_expect ((a) != (a), 0) & !__builtin_expect (!__builtin_expect (((a) - (a)) != ((a) - (a)), 0), 1), 0) || __builtin_expect (!__builtin_expect ((b) != (b), 0) & !__builtin_expect (!__builtin_expect (((b) - (b)) != ((b) - (b)), 0), 1), 0))
 {
   ...
   if (__builtin_expect ((c) != (c), 0)) c = __builtin_copysignf (0, c);
   if (__builtin_expect ((d) != (d), 0)) d = __builtin_copysignf (0, d);
          recalc = 1;
 }
     if (__builtin_expect (!__builtin_expect ((c) != (c), 0) & !__builtin_expect (!__builtin_expect (((c) - (c)) != ((c) - (c)), 0), 1), 0) || __builtin_expect (!__builtin_expect ((d) != (d), 0) & !__builtin_expect (!__builtin_expect (((d) - (d)) != ((d) - (d)), 0), 1), 0))
 {
   ...
   if (__builtin_expect ((a) != (a), 0)) a = __builtin_copysignf (0, a);
   if (__builtin_expect ((b) != (b), 0)) b = __builtin_copysignf (0, b);
   recalc = 1;
 }
     if (!recalc
