...
extern void *compile_type_assert[sizeof(__builtin_huge_vall ()) == sizeof(DFtype) ? 1 : -1];
DCtype
  ...
  if (__builtin_expect ((x) != (x), 0) && __builtin_expect ((y) != (y), 0))
    {
      ...
      _Bool recalc = 0;
      if (__builtin_expect (!__builtin_expect ((a) != (a), 0) & !__builtin_expect (!__builtin_expect (((a) - (a)) != ((a) - (a)), 0), 1), 0) || __builtin_expect (!__builtin_expect ((b) != (b), 0) & !__builtin_expect (!__builtin_expect (((b) - (b)) != ((b) - (b)), 0), 1), 0))
 {


   a = __builtin_copysignl (__builtin_expect (!__builtin_expect ((a) != (a), 0) & !__builtin_expect (!__builtin_expect (((a) - (a)) != ((a) - (a)), 0), 1), 0) ? 1 : 0, a);
   b = __builtin_copysignl (__builtin_expect (!__builtin_expect ((b) != (b), 0) & !__builtin_expect (!__builtin_expect (((b) - (b)) != ((b) - (b)), 0), 1), 0) ? 1 : 0, b);
   if (__builtin_expect ((c) != (c), 0)) c = __builtin_copysignl (0, c);
   if (__builtin_expect ((d) != (d), 0)) d = __builtin_copysignl (0, d);
          recalc = 1;
 }
     if (__builtin_expect (!__builtin_expect ((c) != (c), 0) & !__builtin_expect (!__builtin_expect (((c) - (c)) != ((c) - (c)), 0), 1), 0) || __builtin_expect (!__builtin_expect ((d) != (d), 0) & !__builtin_expect (!__builtin_expect (((d) - (d)) != ((d) - (d)), 0), 1), 0))
 {


   c = __builtin_copysignl (__builtin_expect (!__builtin_expect ((c) != (c), 0) & !__builtin_expect (!__builtin_expect (((c) - (c)) != ((c) - (c)), 0), 1), 0) ? 1 : 0, c);
   d = __builtin_copysignl (__builtin_expect (!__builtin_expect ((d) != (d), 0) & !__builtin_expect (!__builtin_expect (((d) - (d)) != ((d) - (d)), 0), 1), 0) ? 1 : 0, d);
   if (__builtin_expect ((a) != (a), 0)) a = __builtin_copysignl (0, a);
   if (__builtin_expect ((b) != (b), 0)) b = __builtin_copysignl (0, b);
   recalc = 1;
 }
     if (!recalc
   && (__builtin_expect (!__builtin_expect ((ac) != (ac), 0) & !__builtin_expect (!__builtin_expect (((ac) - (ac)) != ((ac) - (ac)), 0), 1), 0) || __builtin_expect (!__builtin_expect ((bd) != (bd), 0) & !__builtin_expect (!__builtin_expect (((bd) - (bd)) != ((bd) - (bd)), 0), 1), 0)
       || __builtin_expect (!__builtin_expect ((ad) != (ad), 0) & !__builtin_expect (!__builtin_expect (((ad) - (ad)) != ((ad) - (ad)), 0), 1), 0) || __builtin_expect (!__builtin_expect ((bc) != (bc), 0) & !__builtin_expect (!__builtin_expect (((bc) - (bc)) != ((bc) - (bc)), 0), 1), 0)))
 {
