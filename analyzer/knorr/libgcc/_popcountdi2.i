...
__popcountdi2 (UDItype x)
{
  ...
  USItype x1 = uu.s.low, x2 = uu.s.high;
  x1 = x1 - ((x1 >> 1) & (((USItype) (((USItype) 0x55 << (8)) | 0x55) << (2 * (8))) | (((USItype) 0x55 << (8)) | 0x55)));
  x2 = x2 - ((x2 >> 1) & (((USItype) (((USItype) 0x55 << (8)) | 0x55) << (2 * (8))) | (((USItype) 0x55 << (8)) | 0x55)));
  x1 = (x1 & (((USItype) (((USItype) 0x33 << (8)) | 0x33) << (2 * (8))) | (((USItype) 0x33 << (8)) | 0x33))) + ((x1 >> 2) & (((USItype) (((USItype) 0x33 << (8)) | 0x33) << (2 * (8))) | (((USItype) 0x33 << (8)) | 0x33)));
  x2 = (x2 & (((USItype) (((USItype) 0x33 << (8)) | 0x33) << (2 * (8))) | (((USItype) 0x33 << (8)) | 0x33))) + ((x2 >> 2) & (((USItype) (((USItype) 0x33 << (8)) | 0x33) << (2 * (8))) | (((USItype) 0x33 << (8)) | 0x33)));
  x1 = (x1 + (x1 >> 4)) & (((USItype) (((USItype) 0x0F << (8)) | 0x0F) << (2 * (8))) | (((USItype) 0x0F << (8)) | 0x0F));
  x2 = (x2 + (x2 >> 4)) & (((USItype) (((USItype) 0x0F << (8)) | 0x0F) << (2 * (8))) | (((USItype) 0x0F << (8)) | 0x0F));
  x1 += x2;
  return (x1 * (((USItype) (((USItype) 0x01 << (8)) | 0x01) << (2 * (8))) | (((USItype) 0x01 << (8)) | 0x01))) >> ((4 * (8)) - (8));
}
