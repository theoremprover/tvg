...
DCtype
__divdc3 (DFtype a, DFtype b, DFtype c, DFtype d)
{
  DFtype denom, ratio, x, y;
  DCtype res;
 ...
 {
   x = __builtin_copysignl (__builtin_huge_vall (), c) * a;
   y = __builtin_copysignl (__builtin_huge_vall (), c) * b;
 }
