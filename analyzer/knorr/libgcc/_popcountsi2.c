...
__popcountsi2 (USItype x)
{
  ...
  x = x - ((x >> 1) & (((USItype) (((USItype) 0x55 << (8)) | 0x55) << (2 * (8))) | (((USItype) 0x55 << (8)) | 0x55)));
  x = (x & (((USItype) (((USItype) 0x33 << (8)) | 0x33) << (2 * (8))) | (((USItype) 0x33 << (8)) | 0x33))) + ((x >> 2) & (((USItype) (((USItype) 0x33 << (8)) | 0x33) << (2 * (8))) | (((USItype) 0x33 << (8)) | 0x33)));
  x = (x + (x >> 4)) & (((USItype) (((USItype) 0x0F << (8)) | 0x0F) << (2 * (8))) | (((USItype) 0x0F << (8)) | 0x0F));
  return (x * (((USItype) (((USItype) 0x01 << (8)) | 0x01) << (2 * (8))) | (((USItype) 0x01 << (8)) | 0x01))) >> ((4 * (8)) - (8));
}
