/*
Analyzing the merged AST...
|   |   ### memberty' = unsigned short [8]
|   |   ### memberident = _Word
|   |   ### initializer = { 0, (unsigned short) ((1 << 15 - 7) - 1) << 7 | 1 << 7 - 1 }
*/
...
int __attribute__((fardata)) _Errno;
 ...
 if ((errh & 1) == 0) //Else branch 2 "if((errh & 1) == 0)" at line 66, col 7, len 14
  ;
 else if ((except & 0x01) != 0) //Then branch 1 "if((0x1 & 0x1) != 0)" at line 68, col 12, len 19
  ( _Errno) = 0x0021;
...
float (sqrtf)(float x)
 ...
 case 1: //Then branch 3 "case 1" at line 232, col 2, len 91
  if (!(((_Fval *)(char *)&x)->_Sh[1] & ((unsigned short)0x8000))) //Else branch 2 "if(!(((_Fval *) (char *) &x)->_Sh[1] & (unsigned short) 0x8000))" at line 233, col 7, len 59
   return (x);
 default:
  if ((((_Fval *)(char *)&x)->_Sh[1] & ((unsigned short)0x8000))) //Then branch 1 "if(((_Fval *) (char *) &x)->_Sh[1] & (unsigned short) 0x8000)" at line 236, col 9, len 55
   {
   _Feraise(0x01);
   return (_FNan._Float);
   }
