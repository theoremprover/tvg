...
extern FLO_type __adddf3 (FLO_type, FLO_type);
extern FLO_type __subdf3 (FLO_type, FLO_type);



extern FLO_type __muldf3 (FLO_type, FLO_type);



extern FLO_type __divdf3 (FLO_type, FLO_type);


extern int __fpcmp_parts_d (fp_number_type *, fp_number_type *);


extern CMPtype __cmpdf2 (FLO_type, FLO_type);





extern CMPtype __eqdf2 (FLO_type, FLO_type);



extern CMPtype __nedf2 (FLO_type, FLO_type);



extern CMPtype __gtdf2 (FLO_type, FLO_type);



extern CMPtype __gedf2 (FLO_type, FLO_type);



extern CMPtype __ltdf2 (FLO_type, FLO_type);



extern CMPtype __ledf2 (FLO_type, FLO_type);



extern CMPtype __unorddf2 (FLO_type, FLO_type);





extern FLO_type __floatsidf (SItype);



extern SItype __fixdfsi (FLO_type);
# 492 "fp-bit.h"
extern FLO_type __floatunsidf (USItype);



extern FLO_type __negdf2 (FLO_type);
# 515 "fp-bit.h"
...
extern SFtype __truncdfsf2 (DFtype);
# 47 "dp-bit.c" 2
# 131 "dp-bit.c"
...
CMPtype
__unorddf2 (FLO_type arg_a, FLO_type arg_b)
{
  fp_number_type a;
  fp_number_type b;
  FLO_union_type au, bu;
...
__floatunsidf (USItype arg_a)
{
  ...
  if (!arg_a)
  ...
  else
    {
      ...
      shift = clzusi (arg_a) - ((4 * 8) - 1 - 52 - 8L);
      if (shift < 0)
 {
