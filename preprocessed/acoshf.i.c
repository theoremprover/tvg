# 1 "/arm-libs/library-src/dinkum/source/./acoshf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./acoshf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./acoshf.c" 2
...
float (acoshf)(float x)
 ...
 default:
  if (x < 1.0F)
   ...
   return (log1pf(z + sqrtf(z * x + z)));
   }
  else
   return (logf(x) + ln2);
  }
 }
# 4 "/arm-libs/library-src/dinkum/source/./acoshf.c" 2
