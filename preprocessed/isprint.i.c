# 1 "/arm-libs/library-src/dinkum/source/./isprint.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./isprint.c" 2
...
int isblank(int);
# 3 "/arm-libs/library-src/dinkum/source/./isprint.c" 2


int (isprint)(int c)
 {
 return (_Ctype[(int)(c)] & (0x20 | 0x10 | 0x08 | 0x04 | 0x02 | 0x200));
 }
