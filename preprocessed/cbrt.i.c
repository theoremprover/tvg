# 1 "/arm-libs/library-src/dinkum/source/./cbrt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cbrt.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cbrt.c" 2
...
double (cbrt)(double x)
 ...
 default:
  ...
  y = ((((0.24379 * x + 0.95807) * x + 0.07892)) / ((x + 0.27962)));

  y = 0.5 * (y + ((1.5 * x) / ((y * y + ((0.5 * x) / (y))))));
...
# 4 "/arm-libs/library-src/dinkum/source/./cbrt.c" 2
