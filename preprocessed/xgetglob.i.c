# 1 "/arm-libs/library-src/dinkum/source/./xgetglob.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xgetglob.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xgetglob.c" 2

typedef void **global_t;

void _Deletegloballocale(void *);

static global_t global_locale = 0; static _Once_t _Tls_once_global_locale = 0; static void _Tls_dtor_global_locale(void) { _Deletegloballocale(&(global_locale)); } static void _Tls_reg_global_locale(void) { _Atexit(_Tls_dtor_global_locale); } static int _Tls_setupx_global_locale(void) { if (*(&_Tls_once_global_locale) == 0) (_Tls_reg_global_locale)(), *(&_Tls_once_global_locale) = 2; return (1); } static int (*_Tls_setup_global_locale)(void) = _Tls_setupx_global_locale;

void *_Getgloballocale()
 {
 return (*((_Tls_setup_global_locale && _Tls_setup_global_locale()), (&(global_locale))));
 }

void _Setgloballocale(void *ptr)
 {
 *((_Tls_setup_global_locale && _Tls_setup_global_locale()), (&(global_locale))) = (void **)ptr;
 }
