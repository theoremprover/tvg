# 1 "/arm-libs/library-src/dinkum/source/./ccosl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ccosl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./ccosl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxccos.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxccos.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxccos.h" 2


_Lcomplex (ccosl)(_Lcomplex x)
 {
 return (ccoshl(_LCbuild(-cimagl(x), creall(x))));
 }
# 4 "/arm-libs/library-src/dinkum/source/./ccosl.c" 2
