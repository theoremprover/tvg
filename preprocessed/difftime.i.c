# 1 "/arm-libs/library-src/dinkum/source/./difftime.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./difftime.c" 2
...
time_t _Tzoff(void);
# 3 "/arm-libs/library-src/dinkum/source/./difftime.c" 2


double (difftime)(time_t t1, time_t t0)
 {
 t0 -= ((70 * 365LU + 17) * 86400), t1 -= ((70 * 365LU + 17) * 86400);
