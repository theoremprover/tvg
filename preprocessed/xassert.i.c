# 1 "/arm-libs/library-src/dinkum/source/./xassert.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xassert.c" 2

# 1 "/toolchain/arm/include/assert.h" 1 3
...
# 4 "/toolchain/arm/include/assert.h" 2 3
# 3 "/arm-libs/library-src/dinkum/source/./xassert.c" 2
...
int raise(int);
# 4 "/arm-libs/library-src/dinkum/source/./xassert.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xassert.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./xassert.c" 2
# 33 "/arm-libs/library-src/dinkum/source/./xassert.c"
void _Assert(const char *mesg, const char *fun)
 {
 if (fun != 0)
  {
  fputs("In function ", (& _Stderr));
  fputs(fun, (& _Stderr));
  fputs(" -- ", (& _Stderr));
  }
 fputs(mesg, (& _Stderr));
