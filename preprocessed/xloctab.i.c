# 1 "/arm-libs/library-src/dinkum/source/./xloctab.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xloctab.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xloctab.c" 2
# 1 "/toolchain/arm/include/xlocale.h" 1 3
...
int isblank(int);
# 5 "/toolchain/arm/include/xlocale.h" 2 3
# 1 "/toolchain/arm/include/limits.h" 1 3
# 6 "/toolchain/arm/include/xlocale.h" 2 3
...
# 7 "/toolchain/arm/include/xlocale.h" 2 3
...
# 8 "/toolchain/arm/include/xlocale.h" 2 3
...
# 9 "/toolchain/arm/include/xlocale.h" 2 3
...
# 10 "/toolchain/arm/include/xlocale.h" 2 3
...
# 11 "/toolchain/arm/include/xlocale.h" 2 3
...
# 12 "/toolchain/arm/include/xlocale.h" 2 3
...
# 13 "/toolchain/arm/include/xlocale.h" 2 3
# 23 "/toolchain/arm/include/xlocale.h" 3
enum _Lcode
 {
...
# 4 "/arm-libs/library-src/dinkum/source/./xloctab.c" 2
...
const _Locitem _Loctab[] = {
 {"LOCALE", __builtin_offsetof(_Linfo, _Name), L_NAME},
 {"NOTE", 0, L_NOTE},
 {"SET", 0, L_SETVAL},

 {"collate", __builtin_offsetof(_Linfo, _Costate._Tab), L_STATE},
 {"wcollate", __builtin_offsetof(_Linfo, _WCostate._Tab), L_STATE},

 {"ctype", __builtin_offsetof(_Linfo, _Ctype), L_TABLE},
 {"tolower", __builtin_offsetof(_Linfo, _Tolotab), L_TABLE},
 {"toupper", __builtin_offsetof(_Linfo, _Touptab), L_TABLE},
 {"mb_cur_max", __builtin_offsetof(_Linfo, _Mbcurmax), L_VALUE},
 {"mbtowc", __builtin_offsetof(_Linfo, _Mbstate._Tab), L_STATE},
 {"wctomb", __builtin_offsetof(_Linfo, _Wcstate._Tab), L_STATE},
 {"wctrans", __builtin_offsetof(_Linfo, _Wctrans), L_WCTYPE},
 {"wctype", __builtin_offsetof(_Linfo, _Wctype), L_WCTYPE},

 {"currency_symbol", __builtin_offsetof(_Linfo, _Lc.currency_symbol), L_STRING},
 {"int_curr_symbol", __builtin_offsetof(_Linfo, _Lc.int_curr_symbol), L_STRING},
 {"mon_decimal_point", __builtin_offsetof(_Linfo, _Lc.mon_decimal_point), L_STRING},
 {"mon_grouping", __builtin_offsetof(_Linfo, _Lc.mon_grouping), L_GSTRING},
 {"mon_thousands_sep", __builtin_offsetof(_Linfo, _Lc.mon_thousands_sep), L_STRING},
 {"negative_sign", __builtin_offsetof(_Linfo, _Lc.negative_sign), L_STRING},
 {"positive_sign", __builtin_offsetof(_Linfo, _Lc.positive_sign), L_STRING},
 {"frac_digits", __builtin_offsetof(_Linfo, _Lc.frac_digits), L_VALUE},
 {"n_cs_precedes", __builtin_offsetof(_Linfo, _Lc.n_cs_precedes), L_VALUE},
 {"n_sep_by_space", __builtin_offsetof(_Linfo, _Lc.n_sep_by_space), L_VALUE},
 {"n_sign_posn", __builtin_offsetof(_Linfo, _Lc.n_sign_posn), L_VALUE},
 {"p_cs_precedes", __builtin_offsetof(_Linfo, _Lc.p_cs_precedes), L_VALUE},
 {"p_sep_by_space", __builtin_offsetof(_Linfo, _Lc.p_sep_by_space), L_VALUE},
 {"p_sign_posn", __builtin_offsetof(_Linfo, _Lc.p_sign_posn), L_VALUE},
 {"int_frac_digits", __builtin_offsetof(_Linfo, _Lc.int_frac_digits), L_VALUE},

 {"int_n_cs_precedes", __builtin_offsetof(_Linfo, _Lc.int_n_cs_precedes), L_VALUE},
 {"int_n_sep_by_space", __builtin_offsetof(_Linfo, _Lc.int_n_sep_by_space), L_VALUE},
 {"int_n_sign_posn", __builtin_offsetof(_Linfo, _Lc.int_n_sign_posn), L_VALUE},
 {"int_p_cs_precedes", __builtin_offsetof(_Linfo, _Lc.int_p_cs_precedes), L_VALUE},
 {"int_p_sep_by_space", __builtin_offsetof(_Linfo, _Lc.int_p_sep_by_space), L_VALUE},
 {"int_p_sign_posn", __builtin_offsetof(_Linfo, _Lc.int_p_sign_posn), L_VALUE},



 {"decimal_point", __builtin_offsetof(_Linfo, _Lc.decimal_point), L_STRING},
 {"grouping", __builtin_offsetof(_Linfo, _Lc.grouping), L_GSTRING},
 {"thousands_sep", __builtin_offsetof(_Linfo, _Lc.thousands_sep), L_STRING},
 {"frac_grouping", __builtin_offsetof(_Linfo, _Lc._Frac_grouping), L_GSTRING},
 {"frac_sep", __builtin_offsetof(_Linfo, _Lc._Frac_sep), L_STRING},
 {"false", __builtin_offsetof(_Linfo, _Lc._False), L_STRING},
 {"true", __builtin_offsetof(_Linfo, _Lc._True), L_STRING},

 {"am_pm", __builtin_offsetof(_Linfo, _Times._Am_pm), L_STRING},
 {"days", __builtin_offsetof(_Linfo, _Times._Days), L_STRING},
  {"abday", __builtin_offsetof(_Linfo, _Times._Abday), L_STRING},
  {"day", __builtin_offsetof(_Linfo, _Times._Day), L_STRING},
 {"months", __builtin_offsetof(_Linfo, _Times._Months), L_STRING},
  {"abmon", __builtin_offsetof(_Linfo, _Times._Abmon), L_STRING},
  {"mon", __builtin_offsetof(_Linfo, _Times._Mon), L_STRING},
 {"time_formats", __builtin_offsetof(_Linfo, _Times._Formats), L_STRING},
  {"d_t_fmt", __builtin_offsetof(_Linfo, _Times._D_t_fmt), L_STRING},
  {"d_fmt", __builtin_offsetof(_Linfo, _Times._D_fmt), L_STRING},
  {"t_fmt", __builtin_offsetof(_Linfo, _Times._T_fmt), L_STRING},
  {"t_fmt_ampm", __builtin_offsetof(_Linfo, _Times._T_fmt_ampm), L_STRING},
 {"era_time_formats", __builtin_offsetof(_Linfo, _Times._Era_Formats), L_STRING},
  {"era_d_t_fmt", __builtin_offsetof(_Linfo, _Times._Era_D_t_fmt), L_STRING},
  {"era_d_fmt", __builtin_offsetof(_Linfo, _Times._Era_D_fmt), L_STRING},
  {"era_t_fmt", __builtin_offsetof(_Linfo, _Times._Era_T_fmt), L_STRING},
  {"era_t_fmt_ampm", __builtin_offsetof(_Linfo, _Times._Era_T_fmt_ampm), L_STRING},
 {"era", __builtin_offsetof(_Linfo, _Times._Era), L_STRING},
 {"alt_digits", __builtin_offsetof(_Linfo, _Times._Alt_digits), L_STRING},
 {"dst_rules", __builtin_offsetof(_Linfo, _Times._Isdst), L_STRING},
 {"time_zone", __builtin_offsetof(_Linfo, _Times._Tzone), L_STRING},

 {"no", __builtin_offsetof(_Linfo, _Lc._No), L_STRING},
 {"yes", __builtin_offsetof(_Linfo, _Lc._Yes), L_STRING},
 {0}};
