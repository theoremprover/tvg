# 1 "/arm-libs/library-src/dinkum/source/./xwctob.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xwctob.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xwctob.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xwctob.c" 2
...
struct tm;
struct _Dnk_filet;
# 89 "/toolchain/arm/include/wchar.h" 3
...
# 5 "/arm-libs/library-src/dinkum/source/./xwctob.c" 2
...
int (_Wctob)(wint_t wc)
 ...
 if (wc == (( wint_t)(-1)))
  ...
  return (_Wctomb(buf, wc, &mbst) != 1 ? (-1)
   : (unsigned char)buf[0]);
  }
 }
