# 1 "/arm-libs/library-src/dinkum/source/./conj.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./conj.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./conj.c" 2
...
_Dcomplex (conj)(_Dcomplex x)
 ...
 ans[0] = creal(x);
 ans[1] = cimag(x);
 ((*_Pmsw(&(ans[1]))) ^= ((unsigned short)0x8000));
 return (*(_Dcomplex *)&ans[0]);
 }
# 4 "/arm-libs/library-src/dinkum/source/./conj.c" 2
