# 1 "/arm-libs/library-src/dinkum/source/./strtoimax.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./strtoimax.c" 2
...
uintmax_t wcstoumax(const _Wchart *,
 _Wchart **, int);
# 3 "/arm-libs/library-src/dinkum/source/./strtoimax.c" 2
...
# 70 "/toolchain/arm/include/stdlib.h" 3
...
# 4 "/arm-libs/library-src/dinkum/source/./strtoimax.c" 2


intmax_t (strtoimax)(const char * s, char ** endptr,
 int base)
 {
