# 1 "/arm-libs/library-src/dinkum/source/./xlcaddcc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlcaddcc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlcaddcc.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxcaddcc.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxcaddcc.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxxcaddcc.h" 2


_Lcomplex (_LCaddcc)(_Lcomplex x, _Lcomplex y)
 {
 return (_LCbuild(creall(x) + creall(y),
  cimagl(x) + cimagl(y)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xlcaddcc.c" 2
