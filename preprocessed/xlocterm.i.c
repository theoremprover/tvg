# 1 "/arm-libs/library-src/dinkum/source/./xlocterm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlocterm.c" 2
...
int isblank(int);
# 3 "/arm-libs/library-src/dinkum/source/./xlocterm.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xlocterm.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xlocterm.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./xlocterm.c" 2
...
static const unsigned short dolvals[] = {
 ...
 0x200, 0x400, 0x80, 0x20, 0x01, 0x10, 0x40, 0x08, 0x04, 0x02, 0x100,
 0xff, 0x8000, 0x4000, 0x2000, 0x1000};
static const char uppers[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";

static unsigned long vars[sizeof (uppers) - 1]; static int (*_Tls_setup_vars)(void) = 0;

int _Locvar(char ch, unsigned long val)
 {
 const char *s = strchr(uppers, ch);
 unsigned long *pvars = ((_Tls_setup_vars && _Tls_setup_vars()), (&(vars[0])));
...
int _Locterm(const char **ps, unsigned long *ans)
 ...
 for (mi = 0; *s == '+' || *s == '-'; s = _Skip(s))
  mi = *s == '-' ? !mi : mi;
 if ((_Ctype[(int)((unsigned char)s[0])] & 0x20))
  *ans = _Stoul(s, (char **)&s, 0);
