# 1 "/arm-libs/library-src/dinkum/source/./lrintl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./lrintl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./lrintl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxlrint.h" 1

# 1 "/toolchain/arm/include/limits.h" 1 3
# 3 "/arm-libs/library-src/dinkum/source/./xxlrint.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxlrint.h" 2
...
long (lrintl)(long double x)
 ...
 default:
  ...
  if ((long double)(-0x7fffffffL - 1) <= y && y <= (long double)0x7fffffffL)
   return ((long)y);
...
# 4 "/arm-libs/library-src/dinkum/source/./lrintl.c" 2
