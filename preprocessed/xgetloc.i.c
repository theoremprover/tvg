# 1 "/arm-libs/library-src/dinkum/source/./xgetloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xgetloc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xgetloc.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xgetloc.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xgetloc.c" 2


static _Once_t freeallreg_o = 0;
...
_Linfo *_Getloc(const char *nmcat, const char *lname)
 ...
 if (p == 0)
  {
  p = _Findloc(ns, nl);
  if (*(&freeallreg_o) == 0) (freeallreg)(), *(&freeallreg_o) = 2;
  }
 return (p);
 }
