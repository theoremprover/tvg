# 1 "/arm-libs/library-src/dinkum/source/./ceilf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ceilf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./ceilf.c" 2
...
float (ceilf)(float x)
 ...
 return (_FDint(&y, 0) < 0 && 0.0F < x ? y + 1.0F : y);
 }
# 4 "/arm-libs/library-src/dinkum/source/./ceilf.c" 2
