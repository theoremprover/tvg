# 1 "/arm-libs/library-src/dinkum/source/./xsetloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xsetloc.c" 2
...
int isblank(int);
# 3 "/arm-libs/library-src/dinkum/source/./xsetloc.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xsetloc.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xsetloc.c" 2
...
_Linfo *_Setloc(size_t catidx, _Linfo *p)
 ...
 switch (catidx)
  {
 case 1:
  *((_Tls_setup__Costate && _Tls_setup__Costate()), (&(_Costate))) = p->_Costate;
  *((_Tls_setup__WCostate && _Tls_setup__WCostate()), (&(_WCostate))) = p->_WCostate;
  break;

 case 2:
  *((_Tls_setup__Ctype && _Tls_setup__Ctype()), (&(_Ctype))) = p->_Ctype;
  *((_Tls_setup__Tolotab && _Tls_setup__Tolotab()), (&(_Tolotab))) = p->_Tolotab;
  *((_Tls_setup__Touptab && _Tls_setup__Touptab()), (&(_Touptab))) = p->_Touptab;
  *((_Tls_setup__Mbcurmax && _Tls_setup__Mbcurmax()), (&(_Mbcurmax))) = p->_Mbcurmax <= 8
   ? p->_Mbcurmax : 8;
  *((_Tls_setup__Mbstate && _Tls_setup__Mbstate()), (&(_Mbstate))) = p->_Mbstate;
  *((_Tls_setup__Wcstate && _Tls_setup__Wcstate()), (&(_Wcstate))) = p->_Wcstate;
  *((_Tls_setup__Wctrans && _Tls_setup__Wctrans()), (&(_Wctrans))) = p->_Wctrans;
  *((_Tls_setup__Wctype && _Tls_setup__Wctype()), (&(_Wctype))) = p->_Wctype;
  break;

 case 3:
   {
  struct lconv *plconv = ((_Tls_setup__Locale && _Tls_setup__Locale()), (&(_Locale)));
 ...
 case 5:
  *((_Tls_setup__Times && _Tls_setup__Times()), (&(_Times))) = p->_Times;
  break;
 case 6:
   {
  struct lconv *plconv = ((_Tls_setup__Locale && _Tls_setup__Locale()), (&(_Locale)));
