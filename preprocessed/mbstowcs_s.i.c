# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/mbstowcs_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/mbstowcs_s.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/mbstowcs_s.c" 2
# 1 "/toolchain/arm/include/limits.h" 1 3
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/mbstowcs_s.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./c_ext1/mbstowcs_s.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./c_ext1/mbstowcs_s.c" 2
...
errno_t (mbstowcs_s)(size_t *psize,
 ...
 if (psize == 0 || s == 0
  ...
  if (wcs != 0 && 0 < maxsize && maxsize <= ((_Sizet)(-1) >> 1))
   wcs[0] = L'\0';
  return (_Fail_s("mbstowcs_s: bad argument", sizeof ("mbstowcs_s: bad argument")));
  }
 ...
 for (nw = 0; 0 < n; ++nw)
   ...
   *psize = (size_t)(-1);
   wcs[0] = L'\0';
   return (_Fail_s("mbstowcs_s: buffer overflow", sizeof ("mbstowcs_s: buffer overflow")));
   }
  s += i;
  n -= i;
  }
