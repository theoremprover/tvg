# 1 "/arm-libs/library-src/dinkum/source/./creal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./creal.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./creal.c" 2
...
double (creal)(_Dcomplex x)
 {
 return (((double *)&x)[0]);
 }
# 4 "/arm-libs/library-src/dinkum/source/./creal.c" 2
