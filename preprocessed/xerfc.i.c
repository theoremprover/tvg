# 1 "/arm-libs/library-src/dinkum/source/./xerfc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xerfc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xerfc.c" 2
...
const double _Erf_one = 5.84;

static const double s[] = {
 0.61792832735846070258e-9,
 0.11684287172270874217e-1,
 0.95637893500953094717e-1,
 0.38676415143622898851,
 0.91231706220035757904,
 1.25253625614956703876,
 0.83571382001120956678,
 };

static const double c[] = {
 0.20709916302643547030e-1,
 0.16951239053544544290,
 0.69589694980162046232,
 1.70158409934440707405,
 2.55410155085533580188,
 2.19550662597046521735,
 0.83571864525686785467,
 };
# 131 "/arm-libs/library-src/dinkum/source/./xxxerfc.h"
const double _Erf_small = 1.523;

double (_Erfc)(double x)
 {
 double z = -x * x;

 _Exp(&z, ((_Poly(x, s, sizeof (s) / sizeof (s[0]) - 1)) / (_Poly(x, c, sizeof (c) / sizeof (c[0]) - 1))), 0);
 return (z);
 }
# 4 "/arm-libs/library-src/dinkum/source/./xerfc.c" 2
