# 1 "/arm-libs/library-src/dinkum/source/./xfpcomp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfpcomp.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfpcomp.c" 2
...
int _Fpcomp(double x, double y)
 {
 if (_Dtest(&x) == 2 || _Dtest(&y) == 2)
  return (0);
 else if (x < y)
  return (1);
 else if (y < x)
...
# 4 "/arm-libs/library-src/dinkum/source/./xfpcomp.c" 2
