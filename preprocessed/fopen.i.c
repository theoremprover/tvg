# 1 "/arm-libs/library-src/dinkum/source/./fopen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fopen.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fopen.c" 2
...
FILE *(fopen)(const char * filename,
 ...
 {
 FILE *str;
# 31 "/arm-libs/library-src/dinkum/source/./fopen.c"
 (void)0;
 str = _Foprep(filename, mods, _Fofind(), (-1), 0);
 (void)0;
 return (str);
 }
