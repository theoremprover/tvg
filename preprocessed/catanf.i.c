# 1 "/arm-libs/library-src/dinkum/source/./catanf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./catanf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./catanf.c" 2
...
_Fcomplex (catanf)(_Fcomplex x)
 {
 x = catanhf(_FCbuild(-cimagf(x), crealf(x)));

 return (_FCbuild(cimagf(x), -crealf(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./catanf.c" 2
