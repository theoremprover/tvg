# 1 "/arm-libs/library-src/dinkum/source/./xbtowc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xbtowc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xbtowc.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xbtowc.c" 2
...
wint_t _Btowc(int c)
 ...
 if (c == (-1))
  ...
  ch = (char)c;
  return ((wint_t)(_Mbtowc(&wc, &ch, 1, &mbst) < 0 ? (( wint_t)(-1)) : wc));
  }
 }
