# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vfwscanf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vfwscanf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/vfwscanf_s.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/vfwscanf_s.c" 2
...
int (vfwscanf_s)(FILE * str, const wchar_t * fmt,
 va_list ap)
 {
 int ans;

 if (str == 0 || fmt == 0)
  return (_Fail_s("vfwscanf_s: bad argument", sizeof ("vfwscanf_s: bad argument")), (-1));

 (void)0;
 ans = _WScanf(&scin, str, fmt, ap, 1);
 (void)0;
 return (ans);
 }
