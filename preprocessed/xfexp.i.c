# 1 "/arm-libs/library-src/dinkum/source/./xfexp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfexp.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfexp.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xfexp.c" 2

# 1 "/arm-libs/library-src/dinkum/source/./xxxexp.h" 1
# 11 "/arm-libs/library-src/dinkum/source/./xxxexp.h"
...
# 6 "/arm-libs/library-src/dinkum/source/./xfexp.c" 2
