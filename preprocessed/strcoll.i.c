# 1 "/arm-libs/library-src/dinkum/source/./strcoll.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./strcoll.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./strcoll.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./strcoll.c" 2
...
int (strcoll)(const char *s1, const char *s2)
 {
 return (_Strcollx(s1, s2, ((_Tls_setup__Costate && _Tls_setup__Costate()), (&(_Costate)))));
 }
