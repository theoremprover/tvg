# 1 "/arm-libs/library-src/dinkum/source/./clog10l.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./clog10l.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./clog10l.c" 2
...
_Lcomplex (clog10l)(_Lcomplex x)
 {
 return (((clogl(x)) * (0.43429448190325182765112891891660507L)));

 }
# 4 "/arm-libs/library-src/dinkum/source/./clog10l.c" 2
