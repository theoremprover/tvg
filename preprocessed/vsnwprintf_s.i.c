# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vsnwprintf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vsnwprintf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/vsnwprintf_s.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/vsnwprintf_s.c" 2


typedef struct _Vsnwpstuff
 {
 wchar_t *s;
 size_t size;
 } _Vsnwpstuff;
...
int (vsnwprintf_s)(wchar_t * s, rsize_t size,
 const wchar_t * fmt, va_list ap)
 {
 int ans;
 _Vsnwpstuff x;

 if (s == 0 || size == 0 || ((_Sizet)(-1) >> 1) < size || fmt == 0)
  return (_Fail_s("vsnwprintf_s: bad argument", sizeof ("vsnwprintf_s: bad argument")), (-1));
