# 1 "/arm-libs/library-src/dinkum/source/./xfwprep.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfwprep.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfwprep.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xfwprep.c" 2
...
int _Fwprep(FILE *str)
 {
# 26 "/arm-libs/library-src/dinkum/source/./xfwprep.c"
 if (str->_Next < str->_Wend)
  return (0);
 else if ((str->_Mode & (0x2 | 0x1000 | 0x8000)) != 0x2)
  {
  str->_Mode |= str->_Mode & 0x8000
   ? 0x200 : 0x200 | 0x4000;
  return (-1);
  }
 else if ((str->_Mode & (0x2000 | 0x4000)) != (0x2000 | 0x4000))
  ;
