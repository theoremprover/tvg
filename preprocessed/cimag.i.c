# 1 "/arm-libs/library-src/dinkum/source/./cimag.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cimag.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cimag.c" 2
...
double (cimag)(_Dcomplex x)
 {
 return (((double *)&x)[1]);
 }
# 4 "/arm-libs/library-src/dinkum/source/./cimag.c" 2
