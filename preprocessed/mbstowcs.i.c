# 1 "/arm-libs/library-src/dinkum/source/./mbstowcs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./mbstowcs.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./mbstowcs.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./mbstowcs.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./mbstowcs.c" 2
...
size_t (mbstowcs)(wchar_t * wcs, const char * s,
 ...
 for (nw = 0; nw < n || s == 0; ++nw)
  {
  i = _Mbtowc(&wc, s, 0x7fffffff, &mbst);
  if (i < 0)
   return ((size_t)-1);
  if (wcs != 0)
   wcs[nw] = wc;
