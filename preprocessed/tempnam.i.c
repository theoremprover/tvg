# 1 "/arm-libs/library-src/dinkum/source/./tempnam.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./tempnam.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./tempnam.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./tempnam.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./tempnam.c" 2
...
char *(tempnam)(const char *dir, const char *prefix)
 ...
 const char *dirname = dir != 0 ? dir : "/tmp";
 size_t dirlen = strlen(dirname);
 char *pnew = malloc(dirlen + 1 + prelen + 6 + 1);
