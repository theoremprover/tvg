# 1 "/arm-libs/library-src/dinkum/source/./strftime.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./strftime.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./strftime.c" 2
...
time_t _Tzoff(void);
# 4 "/arm-libs/library-src/dinkum/source/./strftime.c" 2


size_t (strftime)(char * s, size_t n,
 const char * fmt, const struct tm * t)
 {
 return (_CStrftime(s, n, fmt, t, ((_Tls_setup__Times && _Tls_setup__Times()), (&(_Times)))));
 }
