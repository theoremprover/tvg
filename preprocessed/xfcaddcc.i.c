# 1 "/arm-libs/library-src/dinkum/source/./xfcaddcc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfcaddcc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfcaddcc.c" 2
...
_Fcomplex (_FCaddcc)(_Fcomplex x, _Fcomplex y)
 {
 return (_FCbuild(crealf(x) + crealf(y),
  cimagf(x) + cimagf(y)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xfcaddcc.c" 2
