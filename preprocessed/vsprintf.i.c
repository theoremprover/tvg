# 1 "/arm-libs/library-src/dinkum/source/./vsprintf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./vsprintf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./vsprintf.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./vsprintf.c" 2
...
int (vsprintf)(char * s, const char * fmt,
 va_list ap)
 {
 int ans = _Printf(&prout, s, fmt, ap, 0);
