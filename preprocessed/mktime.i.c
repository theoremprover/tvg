# 1 "/arm-libs/library-src/dinkum/source/./mktime.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./mktime.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./mktime.c" 2
...
time_t _Tzoff(void);
# 4 "/arm-libs/library-src/dinkum/source/./mktime.c" 2
...
time_t (mktime)(struct tm *t)
 ...
 if (mon < 0)
  mon += 12, --ymon;
 if ((ymon < 0 && t->tm_year < (-0x7fffffff - 1) - ymon)
  || (0 < ymon && 0x7fffffff - ymon < t->tm_year))
  return ((time_t)(-1));
 year = t->tm_year + ymon;
 ...
 if (dsecs < 0.0)
  return ((time_t)(-1));
 secs = (time_t)(dsecs - (double)((70 * 365LU + 17) * 86400));
