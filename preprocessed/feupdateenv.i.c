# 1 "/arm-libs/library-src/dinkum/source/./feupdateenv.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./feupdateenv.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./feupdateenv.c" 2


int (feupdateenv)(const fenv_t *penv)
 {
 int except = fetestexcept((0x02 | 0x10 | 0x01 | 0x04 | 0x08));
