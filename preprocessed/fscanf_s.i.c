# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/fscanf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/fscanf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/fscanf_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/fscanf_s.c" 2
...
int (fscanf_s)(FILE * str, const char * fmt, ...)
 {
 int ans;
 va_list ap;

 if (str == 0 || fmt == 0)
  return (_Fail_s("fscanf_s: bad argument", sizeof ("fscanf_s: bad argument")), (-1));
