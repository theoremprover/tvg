# 1 "/arm-libs/library-src/dinkum/source/./cacosl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cacosl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cacosl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcacos.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcacos.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxcacos.h" 2
...
# 21 "/arm-libs/library-src/dinkum/source/./xxcacos.h"
...
_Lcomplex (cacosl)(_Lcomplex x)
 ...
 if (errx == 2)
  ...
  {
  const _Lcomplex w = csqrtl(_LCbuild(1.0L + re, -im));
  const _Lcomplex z = csqrtl(_LCbuild(1.0L - re, -im));
...
# 4 "/arm-libs/library-src/dinkum/source/./cacosl.c" 2
