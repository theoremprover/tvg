# 1 "/arm-libs/library-src/dinkum/source/./xlcaddcr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlcaddcr.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlcaddcr.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxcaddcr.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxcaddcr.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxxcaddcr.h" 2


_Lcomplex (_LCaddcr)(_Lcomplex x, long double y)
 {
 return (_LCbuild(creall(x) + y, cimagl(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xlcaddcr.c" 2
