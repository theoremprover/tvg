# 1 "/arm-libs/library-src/dinkum/source/./feclearexcept.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./feclearexcept.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./feclearexcept.c" 2
# 21 "/arm-libs/library-src/dinkum/source/./feclearexcept.c"
int (feclearexcept)(int except)
 {
 if ((except &= (0x02 | 0x10 | 0x01 | 0x04 | 0x08)) != 0)
  {
# 36 "/arm-libs/library-src/dinkum/source/./feclearexcept.c"
  fenv_t env;
