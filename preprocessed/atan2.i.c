# 1 "/arm-libs/library-src/dinkum/source/./atan2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./atan2.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./atan2.c" 2
...
static double _Atan2_divide(double y, double x)
 {
 double ans = ((y) / (x));
...
double (atan2)(double y, double x)
 ...
 if (errx <= 0 && erry <= 0)
  ...
  {
  z = errx == erry ? 1.0 : 0.0;
  hex = ((*_Pmsw(&(y))) & ((unsigned short)0x8000)) ? 0x8 : 0x0;
  if (((*_Pmsw(&(x))) & ((unsigned short)0x8000)))
   hex ^= 0x6;
  if (erry == 1)
   hex ^= 0x2;
...
# 4 "/arm-libs/library-src/dinkum/source/./atan2.c" 2
