# 1 "/arm-libs/library-src/dinkum/source/./asinl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./asinl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./asinl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxasin.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxasin.h" 2
# 25 "/arm-libs/library-src/dinkum/source/./xxasin.h"
...
# 65 "/arm-libs/library-src/dinkum/source/./xxasin.h"
  else if (x <= rthalf)
   return (_LAtan(((x) / (sqrtl((1.0L - x) * (1.0L + x)))), hex));


  else if (x <= 1.0L)
   return (_LAtan(((sqrtl(1.0L - x) * sqrtl(1.0L + x)) / (x)), hex ^ 0x2));
...
# 4 "/arm-libs/library-src/dinkum/source/./asinl.c" 2
