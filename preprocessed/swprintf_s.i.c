# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/swprintf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/swprintf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/swprintf_s.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/swprintf_s.c" 2
...
int (swprintf_s)(wchar_t * s, rsize_t size,
 const wchar_t * fmt, ...)
 {
 int ans;
 _Swstuff x;
 ...
 if (s == 0 || size == 0 || ((_Sizet)(-1) >> 1) < size)
  return (_Fail_s("swprintf_s: bad argument", sizeof ("swprintf_s: bad argument")), 0);
 else if (fmt == 0)
  {
  *s = '\0';
  return (_Fail_s("swprintf_s: bad format argument", sizeof ("swprintf_s: bad format argument")), 0);
  }
 ...
 if (x.fail)
  return (_Fail_s("swprintf_s: buffer overflow", sizeof ("swprintf_s: buffer overflow")), 0);
 else if (ans < (-1))
  {
  *s = L'\0';
  return (0);
