# 1 "/arm-libs/library-src/dinkum/source/./ungetc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ungetc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./ungetc.c" 2
...
int (ungetc)(int c, FILE *str)
 ...
 if (c == (-1)
  ...
  || (str->_Mode & (0x1 | 0x2000 | 0x8000))
   != 0x1)
  c = (-1);
 else
  {
  str->_Mode =
   (unsigned short)((str->_Mode & ~0x100) | (0x1000 | 0x4000));
  if (str->_Rsave == 0)
