# 1 "/arm-libs/library-src/dinkum/source/./xcaddcr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xcaddcr.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xcaddcr.c" 2
...
_Dcomplex (_Caddcr)(_Dcomplex x, double y)
 {
 return (_Cbuild(creal(x) + y, cimag(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xcaddcr.c" 2
