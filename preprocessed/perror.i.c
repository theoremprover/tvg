# 1 "/arm-libs/library-src/dinkum/source/./perror.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./perror.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./perror.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./perror.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./perror.c" 2
...
void (perror)(const char *s)
 ...
 fputs(_Strerror(( _Errno), 0), (& _Stderr));
 fputc('\n', (& _Stderr));
 }
