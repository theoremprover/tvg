# 1 "/arm-libs/library-src/dinkum/source/./clearerr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./clearerr.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./clearerr.c" 2


void (clearerr)(FILE *str)
 {
 (void)0;
 if (str->_Mode & (0x1 | 0x2))
  str->_Mode &= ~(0x100 | 0x200);
 (void)0;
 }
