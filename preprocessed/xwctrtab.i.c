# 1 "/arm-libs/library-src/dinkum/source/./xwctrtab.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xwctrtab.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xwctrtab.c" 2



static const wchar_t tr_range_tab[] = {
 L'A', L'Z', L'a' - L'A',
 L'a', L'z', (wchar_t)(L'A' - L'a')};

static const _Wctab wctrans_tab[] = {
 {(const char *)tr_range_tab, 0},
 {"tolower", 0},
 {"toupper", 3},
 {(const char *)0, 6}};
 _PWctab _Wctrans = &wctrans_tab[0]; int (*_Tls_setup__Wctrans)(void) = 0;

const _Wctab *_Getpwctrtab()
 {
 return (*((_Tls_setup__Wctrans && _Tls_setup__Wctrans()), (&(_Wctrans))));
 }
