# 1 "/arm-libs/library-src/dinkum/source/./xfenv0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfenv0.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfenv0.c" 2
# 21 "/arm-libs/library-src/dinkum/source/./xfenv0.c"
const fenv_t _Fenv0 = {
 0xff00 | (0x00 << 22)};
