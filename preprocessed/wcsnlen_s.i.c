# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/wcsnlen_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/wcsnlen_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/wcsnlen_s.c" 2
...
size_t (wcsnlen_s)(const wchar_t *s, size_t maxsize)
 ...
 if (s == 0)
  ...
  {
  for (sc = s; 0 < maxsize && *sc != L'\0'; --maxsize, ++sc)
   ;
  return (sc - s);
  }
 }
