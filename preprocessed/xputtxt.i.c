# 1 "/arm-libs/library-src/dinkum/source/./xputtxt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xputtxt.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xputtxt.c" 2
# 33 "/arm-libs/library-src/dinkum/source/./xputtxt.c"
...
int _Puttxt(_Pft *px, const char *ac)
 ...
 if (!(px->flags & 0x04))
  { if (0 < (width)) { int i, j = (width); for (; 0 < j; j -= i) { i = ((sizeof (spaces) - 1)) < j ? ((sizeof (spaces) - 1)) : j; { if (0 < (i)) { if (((px)->arg = (*(px)->pfn)((px)->arg, &spaces[0], i)) != 0) (px)->nchar += (i); else return ((-1)); } } } } }
 { if (0 < (px->n0)) { if (((px)->arg = (*(px)->pfn)((px)->arg, ac, px->n0)) != 0) (px)->nchar += (px->n0); else return ((-1)); } }
 { if (0 < (px->nz0)) { int i, j = (px->nz0); for (; 0 < j; j -= i) { i = ((sizeof (spaces) - 1)) < j ? ((sizeof (spaces) - 1)) : j; { if (0 < (i)) { if (((px)->arg = (*(px)->pfn)((px)->arg, &zeroes[0], i)) != 0) (px)->nchar += (i); else return ((-1)); } } } } }
 { if (0 < (px->n1)) { if (((px)->arg = (*(px)->pfn)((px)->arg, px->s, px->n1)) != 0) (px)->nchar += (px->n1); else return ((-1)); } }
 { if (0 < (px->nz1)) { int i, j = (px->nz1); for (; 0 < j; j -= i) { i = ((sizeof (spaces) - 1)) < j ? ((sizeof (spaces) - 1)) : j; { if (0 < (i)) { if (((px)->arg = (*(px)->pfn)((px)->arg, &zeroes[0], i)) != 0) (px)->nchar += (i); else return ((-1)); } } } } }
 { if (0 < (px->n2)) { if (((px)->arg = (*(px)->pfn)((px)->arg, px->s + px->n1, px->n2)) != 0) (px)->nchar += (px->n2); else return ((-1)); } }
 { if (0 < (px->nz2)) { int i, j = (px->nz2); for (; 0 < j; j -= i) { i = ((sizeof (spaces) - 1)) < j ? ((sizeof (spaces) - 1)) : j; { if (0 < (i)) { if (((px)->arg = (*(px)->pfn)((px)->arg, &zeroes[0], i)) != 0) (px)->nchar += (i); else return ((-1)); } } } } }
 if (px->flags & 0x04)
  { if (0 < (width)) { int i, j = (width); for (; 0 < j; j -= i) { i = ((sizeof (spaces) - 1)) < j ? ((sizeof (spaces) - 1)) : j; { if (0 < (i)) { if (((px)->arg = (*(px)->pfn)((px)->arg, &spaces[0], i)) != 0) (px)->nchar += (i); else return ((-1)); } } } } }
 return (0);
 }
