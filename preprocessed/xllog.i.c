# 1 "/arm-libs/library-src/dinkum/source/./xllog.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xllog.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xllog.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xllog.c" 2

# 1 "/arm-libs/library-src/dinkum/source/./xxxlog.h" 1
# 20 "/arm-libs/library-src/dinkum/source/./xxxlog.h"
static const long double p[] = {
 0.14821919759901168116L,
 0.15310988435285788981L,
 0.18183706393900951476L,
 0.22222195289721309521L,
 0.28571428781619503202L,
 0.39999999999190497071L,
 0.66666666666667803987L,
 };
# 69 "/arm-libs/library-src/dinkum/source/./xxxlog.h"
...
static const long double logx2hi = (long double)(2525222.0 / 8388608.0);
static const long double logx2lo = 7.5085978265526238894724493026768190e-8L;

static const long double logxehi = (long double)(3643126.0 / 8388608.0);
static const long double logxelo = 1.9699272335463628918916605082294398e-8L;
static const long double logxe = 0.43429448190325182765112891891660507L;

static const long double log2ehi = (long double)(12102203.0 / 8388608.0);
static const long double log2elo = 1.9259629911266174681001892137426646e-8L;
static const long double log2e = 1.4426950408889634073599246810018922L;

static const long double rthalf = 0.70710678118654752440084436210484905L;

long double _LLog(long double x, int baseflag)
 {
 short xexp;

 switch (_LDunscale(&xexp, &x))
  {
 case 2:
  return (x);
 ...
 case 1:
  if (!((*_LPmsw(&(x))) & ((unsigned short)0x8000)))
   return (x);
...
# 6 "/arm-libs/library-src/dinkum/source/./xllog.c" 2
