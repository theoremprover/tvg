# 1 "/arm-libs/library-src/dinkum/source/./llrintf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./llrintf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./llrintf.c" 2
...
long long (llrintf)(float x)
 ...
 default:
  ...
  if ((float)(-0x7fffffffffffffffLL - 1) <= y && y <=(float)0x7fffffffffffffffLL)
   return ((long long)y);
...
# 4 "/arm-libs/library-src/dinkum/source/./llrintf.c" 2
