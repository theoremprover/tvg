# 1 "/arm-libs/library-src/dinkum/source/./carg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./carg.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./carg.c" 2
...
double (carg)(_Dcomplex x)
 {
 return (atan2(cimag(x), creal(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./carg.c" 2
