# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/snwprintf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/snwprintf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/snwprintf_s.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/snwprintf_s.c" 2


typedef struct _Snwpstuff
 {
 wchar_t *s;
 size_t size;
 } _Snwpstuff;
...
int (snwprintf_s)(wchar_t * s, rsize_t size,
 const wchar_t * fmt, ...)
 {
 int ans;
 _Snwpstuff x;
 ...
 if (s == 0 || size == 0 || ((_Sizet)(-1) >> 1) < size || fmt == 0)
  return (_Fail_s("snwprintf_s: bad argument", sizeof ("snwprintf_s: bad argument")), (-1));
