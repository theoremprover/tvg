# 1 "/arm-libs/library-src/dinkum/source/./lroundl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./lroundl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./lroundl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxlround.h" 1

# 1 "/toolchain/arm/include/limits.h" 1 3
# 3 "/arm-libs/library-src/dinkum/source/./xxlround.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxlround.h" 2
...
long (lroundl)(long double x)
 ...
 default:
  x = roundl(x);
  if ((long double)(-0x7fffffffL - 1) <= x && x <= (long double)0x7fffffffL)
   return ((long)x);
...
# 4 "/arm-libs/library-src/dinkum/source/./lroundl.c" 2
