# 1 "/arm-libs/library-src/dinkum/source/./csin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./csin.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./csin.c" 2
...
_Dcomplex (csin)(_Dcomplex x)
 {
 x = csinh(_Cbuild(-cimag(x), creal(x)));

 return (_Cbuild(cimag(x), -creal(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./csin.c" 2
