# 1 "/arm-libs/library-src/dinkum/source/./xstod.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xstod.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xstod.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xstod.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xstod.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcctype.h" 1
# 6 "/arm-libs/library-src/dinkum/source/./xstod.c" 2
...
# 7 "/arm-libs/library-src/dinkum/source/./xstod.c" 2


double _Stodx(const char *s, char **endptr, long pten,
 int *perr)
...
# 12 "/arm-libs/library-src/dinkum/source/./xstod.c" 2

double _Stod(const char *s, char **endptr, long pten)
 {
