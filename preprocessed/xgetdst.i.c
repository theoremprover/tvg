# 1 "/arm-libs/library-src/dinkum/source/./xgetdst.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xgetdst.c" 2
...
int isblank(int);
# 3 "/arm-libs/library-src/dinkum/source/./xgetdst.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xgetdst.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xgetdst.c" 2
...
time_t _Tzoff(void);
# 6 "/arm-libs/library-src/dinkum/source/./xgetdst.c" 2
