# 1 "/arm-libs/library-src/dinkum/source/./fegetexceptflag.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fegetexceptflag.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fegetexceptflag.c" 2
# 22 "/arm-libs/library-src/dinkum/source/./fegetexceptflag.c"
int (fegetexceptflag)(fexcept_t *pflag, int except)
 {
 if ((except &= (0x02 | 0x10 | 0x01 | 0x04 | 0x08)) != 0)
  {
# 36 "/arm-libs/library-src/dinkum/source/./fegetexceptflag.c"
  fegetenv(pflag);
  *pflag >>= 0;
# 46 "/arm-libs/library-src/dinkum/source/./fegetexceptflag.c"
  }
