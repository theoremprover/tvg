# 1 "/arm-libs/library-src/dinkum/source/./csinhf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./csinhf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./csinhf.c" 2
...
_Fcomplex (csinhf)(_Fcomplex x)
 ...
 if (errx == 2)
  if (erry == 0)
   return (_FCbuild(_FNan._Float, im));
  else
  ...
  if (erry == 0)
   ...
   return (_FCbuild(re * cosf(im),
    _FInf._Float * sinf(im)));
 else
  return (_FCbuild(_FSinh(re, cosf(im)),
   _FCosh(re, sinf(im))));
 }
# 4 "/arm-libs/library-src/dinkum/source/./csinhf.c" 2
