# 1 "/arm-libs/library-src/dinkum/source/./wctype.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./wctype.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./wctype.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./wctype.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./wctype.c" 2
...
wctype_t (wctype)(const char *name)
 {
 wctype_t n;
 _PWctab pwctype = *((_Tls_setup__Wctype && _Tls_setup__Wctype()), (&(_Wctype)));
