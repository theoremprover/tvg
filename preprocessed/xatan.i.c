# 1 "/arm-libs/library-src/dinkum/source/./xatan.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xatan.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xatan.c" 2
...
static const double c[] = {
 0.00506666138256980774,
 0.18786627197308930065,
 1.05290797687252613439,
 1.84896092990243571481,
 };
static const double s[] = {
 0.06383198950003615800,
 0.63658766690479336192,
 1.51562759656910323406,
 };
# 95 "/arm-libs/library-src/dinkum/source/./xxxatan.h"
static const double a[8] = {
 0.0,
 0.52359877559829887307710723054658382,
 1.57079632679489661923132169163975145,
 1.04719755119659774615421446109316763,
 1.57079632679489661923132169163975145,
 2.09439510239319549230842892218633526,
 3.14159265358979323846264338327950287,
 2.61799387799149436538553615273291908,
 };

static const double rt3 = 1.7320508075688772935274463415058725;
static const double fold = 0.26794919243112270647255365849412763;
static const double piby4 = 0.78539816339744830961566084581987572;

double _Atan(double x, int idx)
 {
 int idx7;
...
# 126 "/arm-libs/library-src/dinkum/source/./xxxatan.h"
  ...
  if (x < -_Rteps._Double || _Rteps._Double < x)
   {
   const double z = x * x;
    const double eps = z * (((c[0] * z + c[1]) * z + c[2]) * z + c[3]);
    const double denom = (1.0 / (1.0 + eps));
...
# 4 "/arm-libs/library-src/dinkum/source/./xatan.c" 2
