# 1 "/arm-libs/library-src/dinkum/source/./conjl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./conjl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./conjl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxconj.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxconj.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxconj.h" 2


_Lcomplex (conjl)(_Lcomplex x)
 {
 long double ans[2];

 ans[0] = creall(x);
 ans[1] = cimagl(x);
 ((*_LPmsw(&(ans[1]))) ^= ((unsigned short)0x8000));
 return (*(_Lcomplex *)&ans[0]);
 }
# 4 "/arm-libs/library-src/dinkum/source/./conjl.c" 2
