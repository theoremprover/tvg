# 1 "/arm-libs/library-src/dinkum/source/./xlcsubcc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlcsubcc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlcsubcc.c" 2
...
_Lcomplex (_LCsubcc)(_Lcomplex x, _Lcomplex y)
 {
 return (_LCbuild(creall(x) - creall(y),
  cimagl(x) - cimagl(y)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xlcsubcc.c" 2
