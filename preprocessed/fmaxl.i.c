# 1 "/arm-libs/library-src/dinkum/source/./fmaxl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fmaxl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fmaxl.c" 2
...
long double (fmaxl)(long double x, long double y)
 ...
 if (_LDtest(&x) == 2)
  ...
  return (x);
 else if (x < y || (x == y && ((*_LPmsw(&(x))) & ((unsigned short)0x8000))))
  return (y);
 else
  return (x);
 }
# 4 "/arm-libs/library-src/dinkum/source/./fmaxl.c" 2
