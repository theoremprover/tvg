# 1 "/arm-libs/library-src/dinkum/source/./xwstoul.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xwstoul.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xwstoul.c" 2
# 1 "/toolchain/arm/include/errno.h" 1 3
# 490 "/toolchain/arm/include/errno.h" 3
extern int _Errno;
# 4 "/arm-libs/library-src/dinkum/source/./xwstoul.c" 2
# 1 "/toolchain/arm/include/limits.h" 1 3
# 5 "/arm-libs/library-src/dinkum/source/./xwstoul.c" 2
# 1 "/toolchain/arm/include/stddef.h" 1 3
# 41 "/toolchain/arm/include/stddef.h" 3
typedef _Ptrdifft ptrdiff_t;
# 6 "/arm-libs/library-src/dinkum/source/./xwstoul.c" 2
...
# 7 "/arm-libs/library-src/dinkum/source/./xwstoul.c" 2
# 18 "/arm-libs/library-src/dinkum/source/./xwstoul.c"
...
# 34 "/arm-libs/library-src/dinkum/source/./xwstoul.c"
...
unsigned long _WStoul(const wchar_t *s, wchar_t **endptr,
 ...
 for (s1 = sc; *sc == L'0'; ++sc)
  ;
 x = 0;
 for (s2 = sc, y = 0; (sd = wmemchr(&digits[0], _Towctrans(*sc, 1), base))
  != 0; ++sc)
  {
  y = x;
  dig = (int)(sd - digits);
