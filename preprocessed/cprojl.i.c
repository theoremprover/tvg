# 1 "/arm-libs/library-src/dinkum/source/./cprojl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cprojl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cprojl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcproj.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcproj.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxcproj.h" 2


_Lcomplex (cprojl)(_Lcomplex x)
 {
 long double re = creall(x);
 long double im = cimagl(x);
 const short err_re = _LDtest(&re);
 const short err_im = _LDtest(&im);

 return (err_re != 1 && err_im != 1 ? x
  : _LCbuild(_LInf._Long_double, ((*_LPmsw(&(im))) & ((unsigned short)0x8000)) ? -_LZero : 0.0L));
 }
# 4 "/arm-libs/library-src/dinkum/source/./cprojl.c" 2
