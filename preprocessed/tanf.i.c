# 1 "/arm-libs/library-src/dinkum/source/./tanf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./tanf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./tanf.c" 2
...
float (_FTan)(float x, int quads);

float (tanf)(float x)
 {
 return (_FTan(x, 0));
 }
# 4 "/arm-libs/library-src/dinkum/source/./tanf.c" 2
