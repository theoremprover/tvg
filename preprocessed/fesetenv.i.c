# 1 "/arm-libs/library-src/dinkum/source/./fesetenv.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fesetenv.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fesetenv.c" 2
...
# 52 "/arm-libs/library-src/dinkum/source/./fesetenv.c"
int (fesetenv)(const fenv_t *penv)
 {
# 150 "/arm-libs/library-src/dinkum/source/./fesetenv.c"
      __asm__("vmsr fpscr, %0" : : "r" (*penv));
# 174 "/arm-libs/library-src/dinkum/source/./fesetenv.c"
 return (0);
 }
