# 1 "/arm-libs/library-src/dinkum/source/./creall.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./creall.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./creall.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcreal.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcreal.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxcreal.h" 2


long double (creall)(_Lcomplex x)
 {
 return (((long double *)&x)[0]);
 }
# 4 "/arm-libs/library-src/dinkum/source/./creall.c" 2
