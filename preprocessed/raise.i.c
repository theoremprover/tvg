# 1 "/arm-libs/library-src/dinkum/source/./raise.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./raise.c" 2

# 1 "/toolchain/arm/include/signal.h" 1 3
...
# 6 "/toolchain/arm/include/signal.h" 2 3
# 75 "/toolchain/arm/include/signal.h" 3
typedef int sig_atomic_t;
# 105 "/toolchain/arm/include/signal.h" 3
...
int raise(int);
# 3 "/arm-libs/library-src/dinkum/source/./raise.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./raise.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./raise.c" 2
# 25 "/arm-libs/library-src/dinkum/source/./raise.c"
int (raise)(int sig)
 {
 _Sigfun *const s = signal(sig, (_Sigfun *)(( _Sigfun *)1));

 if (s == (_Sigfun *)(( _Sigfun *)-1))
  return (-1);
 else if (s == (_Sigfun *)(( _Sigfun *)1))
  ;
 else if (s != (_Sigfun *)(( _Sigfun *)0))
  {
  signal(sig, (_Sigfun *)(( _Sigfun *)0));
  (*s)(sig);
  }
 else
  {
