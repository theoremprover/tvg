# 1 "/arm-libs/library-src/dinkum/source/./cacosf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cacosf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cacosf.c" 2
...
_Fcomplex (cacosf)(_Fcomplex x)
 ...
 if (errx == 2)
  ...
  {
  const _Fcomplex w = csqrtf(_FCbuild(1.0F + re, -im));
  const _Fcomplex z = csqrtf(_FCbuild(1.0F - re, -im));
...
# 4 "/arm-libs/library-src/dinkum/source/./cacosf.c" 2
