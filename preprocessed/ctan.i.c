# 1 "/arm-libs/library-src/dinkum/source/./ctan.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ctan.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./ctan.c" 2
...
_Dcomplex (ctan)(_Dcomplex x)
 {
 x = ctanh(_Cbuild(-cimag(x), creal(x)));

 return (_Cbuild(cimag(x), -creal(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./ctan.c" 2
