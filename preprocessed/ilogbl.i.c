# 1 "/arm-libs/library-src/dinkum/source/./ilogbl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ilogbl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./ilogbl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxilogb.h" 1


# 1 "/toolchain/arm/include/limits.h" 1 3
# 4 "/arm-libs/library-src/dinkum/source/./xxilogb.h" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xxilogb.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./ilogbl.c" 2
