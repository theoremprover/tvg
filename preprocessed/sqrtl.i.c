# 1 "/arm-libs/library-src/dinkum/source/./sqrtl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./sqrtl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./sqrtl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxsqrt.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxsqrt.h" 2
...
long double (sqrtl)(long double x)
 ...
 default:
  ...
  y = 0.5L * (y + ((x) / (y)));
# 44 "/arm-libs/library-src/dinkum/source/./xxsqrt.h"
  _LDscale(&y, xexp / 2);
  return (y);
  }
 }
# 4 "/arm-libs/library-src/dinkum/source/./sqrtl.c" 2
