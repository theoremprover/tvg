# 1 "/arm-libs/library-src/dinkum/source/./csinl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./csinl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./csinl.c" 2
...
_Lcomplex (csinl)(_Lcomplex x)
 {
 x = csinhl(_LCbuild(-cimagl(x), creall(x)));

 return (_LCbuild(cimagl(x), -creall(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./csinl.c" 2
