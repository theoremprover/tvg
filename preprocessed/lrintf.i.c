# 1 "/arm-libs/library-src/dinkum/source/./lrintf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./lrintf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./lrintf.c" 2
...
long (lrintf)(float x)
 ...
 default:
  ...
  if ((float)(-0x7fffffffL - 1) <= y && y <= (float)0x7fffffffL)
   return ((long)y);
...
# 4 "/arm-libs/library-src/dinkum/source/./lrintf.c" 2
