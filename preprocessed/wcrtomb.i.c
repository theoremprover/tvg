# 1 "/arm-libs/library-src/dinkum/source/./wcrtomb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./wcrtomb.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./wcrtomb.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./wcrtomb.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./wcrtomb.c" 2

static mbstate_t mbst = {0}; static int (*_Tls_setup_mbst)(void) = 0;
size_t (wcrtomb)(char * s, wchar_t wchar,
 mbstate_t * pst)
 {
 char buf[8];
