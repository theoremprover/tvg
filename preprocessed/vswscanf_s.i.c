# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vswscanf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vswscanf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/vswscanf_s.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/vswscanf_s.c" 2
...
int (vswscanf_s)(const wchar_t * buf,
 const wchar_t * fmt, va_list ap)
 {
 if (buf == 0 || fmt == 0)
  return (_Fail_s("vswscanf_s: bad argument", sizeof ("vswscanf_s: bad argument")), (-1));

 return (_WScanf(&scin, (void **)&buf, fmt, ap, 1));
 }
