# 1 "/arm-libs/library-src/dinkum/source/./xfrprep.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfrprep.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfrprep.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xfrprep.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xfrprep.c" 2
...
int _Frprep(FILE *str)
 ...
 if (str->_Next < str->_Rend)
  ...
  return (0);
 else if ((str->_Mode & (0x1 | 0x2000 | 0x8000)) != 0x1)
  {
  str->_Mode |= str->_Mode & 0x8000
   ? 0x200 : 0x200 | 0x4000;
  return (-1);
  }
 ...
 if (n < 0)
  {
  str->_Mode |= 0x200 | 0x4000;
  return (-1);
  }
 else if (n == 0)
  {
  str->_Mode =
   (unsigned short)((str->_Mode & ~0x1000) | 0x100 | 0x4000);
  return (0);
  }
 else
  {
  str->_Mode |= 0x1000 | 0x4000;
  str->_Rend += n;
  return (1);
  }
  }
