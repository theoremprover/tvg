# 1 "/arm-libs/library-src/dinkum/source/./fmodf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fmodf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fmodf.c" 2
...
float (fmodf)(float x, float y)
 ...
 if (0 <= errx || 0 <= erry)
  ...
  if (x < 0.0F)
   ...
   neg = 0;
  for (t = y, _FDunscale(&ychar, &t), n = 0; ; )
   {
   short xchar;
...
# 4 "/arm-libs/library-src/dinkum/source/./fmodf.c" 2
