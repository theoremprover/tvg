# 1 "/arm-libs/library-src/dinkum/source/./xlerfc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlerfc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlerfc.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxerfc.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxerfc.h" 2
# 30 "/arm-libs/library-src/dinkum/source/./xxxerfc.h"
const long double _LErf_one = 5.84L;

static const long double s[] = {
 0.61792832735846070258e-9L,
 0.11684287172270874217e-1L,
 0.95637893500953094717e-1L,
 0.38676415143622898851L,
 0.91231706220035757904L,
 1.25253625614956703876L,
 0.83571382001120956678L,
 };

static const long double c[] = {
 0.20709916302643547030e-1L,
 0.16951239053544544290L,
 0.69589694980162046232L,
 1.70158409934440707405L,
 2.55410155085533580188L,
 2.19550662597046521735L,
 0.83571864525686785467L,
 };
# 131 "/arm-libs/library-src/dinkum/source/./xxxerfc.h"
const long double _LErf_small = 1.523L;

long double (_LErfc)(long double x)
 {
 long double z = -x * x;

 _LExp(&z, ((_LPoly(x, s, sizeof (s) / sizeof (s[0]) - 1)) / (_LPoly(x, c, sizeof (c) / sizeof (c[0]) - 1))), 0);
 return (z);
 }
# 4 "/arm-libs/library-src/dinkum/source/./xlerfc.c" 2
