# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/ctime_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/ctime_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/ctime_s.c" 2
...
time_t _Tzoff(void);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/ctime_s.c" 2
...
errno_t (ctime_s)(char *s, rsize_t maxsize,
 ...
 return (asctime_s(s, maxsize, localtime_s(tod, &tmbuf)));
 }
