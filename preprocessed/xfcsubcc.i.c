# 1 "/arm-libs/library-src/dinkum/source/./xfcsubcc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfcsubcc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfcsubcc.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxcsubcc.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxcsubcc.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxxcsubcc.h" 2


_Fcomplex (_FCsubcc)(_Fcomplex x, _Fcomplex y)
 {
 return (_FCbuild(crealf(x) - crealf(y),
  cimagf(x) - cimagf(y)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xfcsubcc.c" 2
