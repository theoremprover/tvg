# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/scanf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/scanf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/scanf_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/scanf_s.c" 2
...
int (scanf_s)(const char * fmt, ...)
 ...
 if (fmt == 0)
  return (_Fail_s("scanf_s: bad argument", sizeof ("scanf_s: bad argument")), (-1));
