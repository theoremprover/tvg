# 1 "/arm-libs/library-src/dinkum/source/./tanl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./tanl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./tanl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxtan.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxtan.h" 2


long double (_LTan)(long double x, int quads);

long double (tanl)(long double x)
 {
 return (_LTan(x, 0));
 }
# 4 "/arm-libs/library-src/dinkum/source/./tanl.c" 2
