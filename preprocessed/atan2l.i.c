# 1 "/arm-libs/library-src/dinkum/source/./atan2l.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./atan2l.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./atan2l.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxatan2.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxatan2.h" 2


static long double _LAtan2_divide(long double y, long double x)
 {
 long double ans = ((y) / (x));
...
long double (atan2l)(long double y, long double x)
 ...
 if (errx <= 0 && erry <= 0)
  ...
  if (x < y)
   z = _LAtan2_divide(x, y), hex ^= 0x2;
  else if (errx < 0)
   z = _LAtan2_divide(y, x);
  else
   z = 0.0L;
  }
 else if (erry == 2)
  ...
  {
  z = errx == erry ? 1.0L : 0.0L;
  hex = ((*_LPmsw(&(y))) & ((unsigned short)0x8000)) ? 0x8 : 0x0;
  if (((*_LPmsw(&(x))) & ((unsigned short)0x8000)))
   hex ^= 0x6;
  if (erry == 1)
   hex ^= 0x2;
...
# 4 "/arm-libs/library-src/dinkum/source/./atan2l.c" 2
