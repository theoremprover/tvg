# 1 "/arm-libs/library-src/dinkum/source/./xtan.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xtan.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xtan.c" 2
...
static const double c[] = {
 -0.00020844956382258822,
 0.02334489464693293380,
 -0.46161689768996201755,
 };
static const double s[] = {
 -0.00000748373924372997,
 0.00280592875035233052,
 -0.12828356435663158978,
 };
# 79 "/arm-libs/library-src/dinkum/source/./xxxtan.h"
static double _Tan_approx(double x, unsigned int invert)
 {
 const double z = x * x;
 const double xd = 1.0 + z * ((c[0] * z + c[1]) * z + c[2]);
...
double (_Tan)(double x, int retcode)
 {
 switch (_Dtest(&x))
  {
 case 2:
 ...
 default:
   {
  unsigned int invert = _Quad(&x, retcode) & 0x1;
...
# 4 "/arm-libs/library-src/dinkum/source/./xtan.c" 2
