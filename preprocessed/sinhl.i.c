# 1 "/arm-libs/library-src/dinkum/source/./sinhl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./sinhl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./sinhl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxsinh.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxsinh.h" 2


long double (sinhl)(long double x)
 {
 return (_LSinh(x, 1.0L));
 }
# 4 "/arm-libs/library-src/dinkum/source/./sinhl.c" 2
