# 1 "/arm-libs/library-src/dinkum/source/./xlfpcomp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlfpcomp.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlfpcomp.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxfpcomp.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxfpcomp.h" 2


int _LFpcomp(long double x, long double y)
 {
 if (_LDtest(&x) == 2 || _LDtest(&y) == 2)
  return (0);
 else if (x < y)
  return (1);
 else if (y < x)
...
# 4 "/arm-libs/library-src/dinkum/source/./xlfpcomp.c" 2
