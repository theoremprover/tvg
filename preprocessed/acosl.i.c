# 1 "/arm-libs/library-src/dinkum/source/./acosl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./acosl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./acosl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxacos.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxacos.h" 2
# 19 "/arm-libs/library-src/dinkum/source/./xxacos.h"
...
# 58 "/arm-libs/library-src/dinkum/source/./xxacos.h"
  else if (x <= 1.0L)
   return (_LAtan(((sqrtl((1.0L - x) * (1.0L + x))) / (x)), hex ^ 0x2));
...
# 4 "/arm-libs/library-src/dinkum/source/./acosl.c" 2
