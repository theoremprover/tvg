# 1 "/arm-libs/library-src/dinkum/source/./llround.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./llround.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./llround.c" 2
...
long long (llround)(double x)
 ...
 default:
  x = round(x);
  if ((double)(-0x7fffffffffffffffLL - 1) <= x && x <= (double)0x7fffffffffffffffLL)
   return ((long long)x);
...
# 4 "/arm-libs/library-src/dinkum/source/./llround.c" 2
