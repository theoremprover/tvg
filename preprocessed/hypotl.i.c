# 1 "/arm-libs/library-src/dinkum/source/./hypotl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./hypotl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./hypotl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxhypot.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxhypot.h" 2


long double (hypotl)(long double x, long double y)
 {
 int zexp;
 long double z = _LHypot(x, y, &zexp);

 if (zexp != 0)
  switch (_LDscale(&z, zexp))
   {
  case 0:
   _Feraise(0x08);
   break;
...
# 4 "/arm-libs/library-src/dinkum/source/./hypotl.c" 2
