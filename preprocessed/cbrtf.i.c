# 1 "/arm-libs/library-src/dinkum/source/./cbrtf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cbrtf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cbrtf.c" 2
...
float (cbrtf)(float x)
 ...
 default:
  ...
  y = ((((0.24379F * x + 0.95807F) * x + 0.07892F)) / ((x + 0.27962F)));

  y = 0.5F * (y + ((1.5F * x) / ((y * y + ((0.5F * x) / (y))))));
...
# 4 "/arm-libs/library-src/dinkum/source/./cbrtf.c" 2
