# 1 "/arm-libs/library-src/dinkum/source/./cargf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cargf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cargf.c" 2
...
float (cargf)(_Fcomplex x)
 {
 return (atan2f(cimagf(x), crealf(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./cargf.c" 2
