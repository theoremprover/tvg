# 1 "/arm-libs/library-src/dinkum/source/./xstoxflt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xstoxflt.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xstoxflt.c" 2
...
int isblank(int);
# 4 "/arm-libs/library-src/dinkum/source/./xstoxflt.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xstoxflt.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./xstoxflt.c" 2
...
# 7 "/arm-libs/library-src/dinkum/source/./xstoxflt.c" 2
...
int _Stoxflt(const char *s0, const char *s,
