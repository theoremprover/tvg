# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/fopen_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/fopen_s.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/fopen_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/fopen_s.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./c_ext1/fopen_s.c" 2





errno_t (fopen_s)(FILE * * pstr,
 const char * filename,
 const char * mods)
 {
 FILE *str;
 int exc_code = 'U';
# 40 "/arm-libs/library-src/dinkum/source/./c_ext1/fopen_s.c"
 if (pstr == 0)
  return (_Fail_s("fopen_s: bad FILE ** argument", sizeof ("fopen_s: bad FILE ** argument")));
 *pstr = 0;

 if (filename == 0 || mods == 0)
 ...
 (void)0;
 str = _Foprep(filename, mods, _Fofind(), (-1), exc_code);
 (void)0;
