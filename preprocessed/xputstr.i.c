# 1 "/arm-libs/library-src/dinkum/source/./xputstr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xputstr.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xputstr.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xputstr.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xputstr.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./xputstr.c" 2
...
int _Putstr(_Pft *px, const wchar_t *pwc)
 ...
 char ac[64 < 8 ? 8 : 64];
 char buf[8], *pac;
 int m = px->prec < 0 ? 0x7fffffff : px->prec;
 int n, stat;
 size_t acsize = px->width + _Getmbcurmax();
 _Mbstatet mbst = {0};

 if (px->flags & 0x04 || acsize <= sizeof (ac))
