# 1 "/arm-libs/library-src/dinkum/source/./localtim.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./localtim.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./localtim.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./localtim.c" 2
...
time_t _Tzoff(void);
# 5 "/arm-libs/library-src/dinkum/source/./localtim.c" 2
...
static old_t oldzone = 0; static int (*_Tls_setup_oldzone)(void) = 0;
static long tzoff = 0; static int (*_Tls_setup_tzoff)(void) = 0;

time_t _Tzoff(void)
 {
 old_t *poldzone = ((_Tls_setup_oldzone && _Tls_setup_oldzone()), (&(oldzone)));
 _Tinfo *ptimes = ((_Tls_setup__Times && _Tls_setup__Times()), (&(_Times)));
 long *ptzoff = ((_Tls_setup_tzoff && _Tls_setup_tzoff()), (&(tzoff)));
  ...
  *ptzoff = strtol(p, (char **)&pe, 10);
  if (pe - p != n
   || *ptzoff <= -(100 * 13) || (100 * 13) <= *ptzoff)
   *ptzoff = 0;
  *ptzoff -= (*ptzoff / 100) * 40;
  *ptzoff = -*ptzoff;
