# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/wmemmove_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/wmemmove_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/wmemmove_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/wmemmove_s.c" 2
...
errno_t (wmemmove_s)(wchar_t *s1, rsize_t maxsize,
 ...
 if (s1 == 0 || ((_Sizet)(-1) >> 1) < maxsize)
  return (_Fail_s("wmemmove_s: bad destination argument", sizeof ("wmemmove_s: bad destination argument")));
 else if (s2 == 0 || ((_Sizet)(-1) >> 1) < n || maxsize < n)
  {
  wmemset(s1, L'\0', maxsize);
  return (_Fail_s("wmemmove_s: bad argument", sizeof ("wmemmove_s: bad argument")));
  }
