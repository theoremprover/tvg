# 1 "/arm-libs/library-src/dinkum/source/./cabsf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cabsf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cabsf.c" 2
...
float (cabsf)(_Fcomplex x)
 {
 return (hypotf(crealf(x), cimagf(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./cabsf.c" 2
