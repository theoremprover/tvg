# 1 "/arm-libs/library-src/dinkum/source/./csinf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./csinf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./csinf.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcsin.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcsin.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxcsin.h" 2


_Fcomplex (csinf)(_Fcomplex x)
 {
 x = csinhf(_FCbuild(-cimagf(x), crealf(x)));

 return (_FCbuild(cimagf(x), -crealf(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./csinf.c" 2
