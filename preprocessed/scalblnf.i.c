# 1 "/arm-libs/library-src/dinkum/source/./scalblnf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./scalblnf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./scalblnf.c" 2
...
float (scalblnf)(float x, long xexp)
 {
 if (xexp != 0 && _FDtest(&x) < 0)
...
# 4 "/arm-libs/library-src/dinkum/source/./scalblnf.c" 2
