# 1 "/arm-libs/library-src/dinkum/source/./xwcsxfrm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xwcsxfrm.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xwcsxfrm.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xwcsxfrm.c" 2
...
size_t _CWcsxfrm(wchar_t *, const wchar_t **, size_t,
 mbstate_t *, _Statab *);
# 5 "/arm-libs/library-src/dinkum/source/./xwcsxfrm.c" 2
...
size_t _CWcsxfrm(wchar_t *sout, const wchar_t **psin,
  ...
  *psin = sin;
  ...
  int leave = 0;
  int limit = 0;
  unsigned short wc = (unsigned short)(ps->_Wchar ? ps->_Wchar : *sin);
  ...
  for (; ; )
   ...
   if (16 <= state
    ...
    || (code = stab[wc & 0xff]) == 0)
    break;
   state = (unsigned char)((code & 0x0f00) >> 8);
   if (code & 0x8000)
    wc = (wchar_t)((wc & ~4294967295U) | (code & 0x00ff));
   if (code & 0x1000)
    wc = (wchar_t)(wc << 8
