# 1 "/arm-libs/library-src/dinkum/source/./fegettrapenable.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fegettrapenable.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fegettrapenable.c" 2
# 21 "/arm-libs/library-src/dinkum/source/./fegettrapenable.c"
fexcept_t (fegettrapenable)(void)
 {
# 32 "/arm-libs/library-src/dinkum/source/./fegettrapenable.c"
 fenv_t env;

 fegetenv(&env);
 return ((env >> 8) & (0x02 | 0x10 | 0x01 | 0x04 | 0x08));
# 61 "/arm-libs/library-src/dinkum/source/./fegettrapenable.c"
 }
