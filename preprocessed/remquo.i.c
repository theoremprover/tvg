# 1 "/arm-libs/library-src/dinkum/source/./remquo.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./remquo.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./remquo.c" 2
...
static void __Remquo_subtract(double *px, double *py)
 {
 short xexp, yexp;
...
double (remquo)(double x, double y, int *pquo)
 ...
 if (0 <= errx || 0 <= erry)
  ...
  for (t = y, _Dunscale(&ychar, &t), n = 0, intpart = 0; ; )
   {
   short xchar;
...
# 4 "/arm-libs/library-src/dinkum/source/./remquo.c" 2
