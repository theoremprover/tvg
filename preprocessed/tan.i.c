# 1 "/arm-libs/library-src/dinkum/source/./tan.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./tan.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./tan.c" 2
...
double (_Tan)(double x, int quads);

double (tan)(double x)
 {
 return (_Tan(x, 0));
 }
# 4 "/arm-libs/library-src/dinkum/source/./tan.c" 2
