# 1 "/arm-libs/library-src/dinkum/source/./ldexpl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ldexpl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./ldexpl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxldexp.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxldexp.h" 2


long double (ldexpl)(long double x, int xexp)
 {
 if (xexp != 0 && _LDtest(&x) < 0)
  switch (_LDscalex(&x, xexp, 1))
   {
  case 0:
   _Feraise(0x08);
   break;
...
# 4 "/arm-libs/library-src/dinkum/source/./ldexpl.c" 2
