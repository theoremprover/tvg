# 1 "/arm-libs/library-src/dinkum/source/./ccoshf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ccoshf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./ccoshf.c" 2
...
_Fcomplex (ccoshf)(_Fcomplex x)
 ...
 if (errx == 2)
  ...
  if (errx == 0)
   return (_FCbuild(_FNan._Float, re));
  else if (errx == 1)
   return (_FCbuild(_FInf._Float,
    _FNan._Float));
  else
  ...
  if (erry == 0)
   ...
   return (_FCbuild(_FInf._Float * cosf(im),
    _FInf._Float * sinf(im)));
 else
  return (_FCbuild(_FCosh(re, cosf(im)),
   _FSinh(re, sinf(im))));
 }
# 4 "/arm-libs/library-src/dinkum/source/./ccoshf.c" 2
