# 1 "/arm-libs/library-src/dinkum/source/./fwprintf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fwprintf.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 3 "/arm-libs/library-src/dinkum/source/./fwprintf.c" 2
...
int (fwprintf)(FILE * str, const wchar_t * fmt, ...)
 {
 int ans;
 va_list ap;
