# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/swscanf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/swscanf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/swscanf_s.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/swscanf_s.c" 2
...
int (swscanf_s)(const wchar_t * buf,
 const wchar_t * fmt, ...)
 {
 int ans;
 va_list ap;
 ...
 if (buf == 0 || fmt == 0)
  return (_Fail_s("swscanf_s: bad argument", sizeof ("swscanf_s: bad argument")), (-1));

 __builtin_va_start(ap, fmt);
 ans = _WScanf(&scin, (void **)&buf, fmt, ap, 1);
 __builtin_va_end(ap);
 return (ans);
 }
