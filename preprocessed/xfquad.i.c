# 1 "/arm-libs/library-src/dinkum/source/./xfquad.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfquad.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfquad.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xfquad.c" 2
...
# 4668 "/arm-libs/library-src/dinkum/source/./xxxquad.hx"
static const float c[] = {
 ...
 (float)(1220.0F * 8 / (((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) * 4096.0L)),
 (float)(3174.0F * 8 / (((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) * (4096.0L * 4096.0L))),
 (float)(651.0F * 8 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 };

static const float piby2[(sizeof c / sizeof c[0])] = {
 (float)(3216.0F / (4096.0L * 4) * 8),
 (float)(4058.0F / (4096.0L * 4) * 8 / 4096.0L),
 (float)(2594.0F / (4096.0L * 4) * 8 / (4096.0L * 4096.0L)),
 (float)(360.0F / (4096.0L * 4) * 8 / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(3107.0F / (4096.0L * 4) * 8 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 (float)(1220.0F / (4096.0L * 4) * 8 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / 4096.0L),
 (float)(3174.0F / (4096.0L * 4) * 8 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(651.0F / (4096.0L * 4) * 8 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 };
...
static const float b[][(sizeof c / sizeof c[0])] = {
 ...
 (float)(496.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(3725.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(3745.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(3562.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(2978.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(167.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },

 {
 (float)(-3662.0F * 1 / 4096.0L),
 (float)(1243.0F * 1 / (4096.0L * 4096.0L)),
 (float)(927.0F * 1 / (4096.0L * 4096.0L) / 4096.0L),
 (float)(1892.0F * 1 / (4096.0L * 4096.0L) / (4096.0L * 4096.0L)),
 (float)(123.0F * 1 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / 4096.0L),
 (float)(1647.0F * 1 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(638.0F * 1 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(2274.0F * 1 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(801.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(3166.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(4057.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(1997.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(1327.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(3841.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },

 {
 (float)(2127.0F / 4 / 4096.0L),
 (float)(2612.0F / 4 / (4096.0L * 4096.0L)),
 (float)(489.0F / 4 / (4096.0L * 4096.0L) / 4096.0L),
 (float)(641.0F / 4 / (4096.0L * 4096.0L) / (4096.0L * 4096.0L)),
 (float)(399.0F / 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / 4096.0L),
 (float)(3952.0F / 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(2166.0F / 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(1975.0F / 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(3761.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(1748.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(1036.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(1779.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(3856.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(3443.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },

 {
 (float)(3955.0F / 4 / 4096.0L),
 (float)(796.0F / 4 / (4096.0L * 4096.0L)),
 (float)(3139.0F / 4 / (4096.0L * 4096.0L) / 4096.0L),
 (float)(2818.0F / 4 / (4096.0L * 4096.0L) / (4096.0L * 4096.0L)),
 (float)(1688.0F / 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / 4096.0L),
 (float)(2883.0F / 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(1965.0F / 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(1013.0F / 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(2480.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(1457.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(2271.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },

 {
 (float)(-2315.0F / 2 / 4096.0L),
 (float)(2738.0F / 2 / (4096.0L * 4096.0L)),
 (float)(886.0F / 2 / (4096.0L * 4096.0L) / 4096.0L),
 (float)(3682.0F / 2 / (4096.0L * 4096.0L) / (4096.0L * 4096.0L)),
 (float)(1812.0F / 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / 4096.0L),
 (float)(1525.0F / 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(610.0F / 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(3242.0F / 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(279.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(1517.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(624.0F * 4 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(3690.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(710.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(1996.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(3437.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(2963.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(3340.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 ...
 (float)(2639.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / (4096.0L * 4096.0L)),
 (float)(1538.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * 4096.0L)),
 (float)(3703.0F * 2 / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L)) / ((4096.0L * 4096.0L) * (4096.0L * 4096.0L))),
 },
 };
...
static const float inv_fracbits = 1.0F / (float)4096.0L;

static float _FQuad_multiply(float x, float y)
 {
 float ans = x * y;
...
unsigned int _FQuad(float *px, int retcode)
 {
 float x = *px;
 float g;
  ...
  *px = x;
  ...
  if (g != 0.0F)
   {
   float xpx[2], xpy[(sizeof c / sizeof c[0])];

   memcpy(xpy, piby2, (sizeof c / sizeof c[0]) * sizeof (float));
   _FXp_mulh(xpy, (sizeof c / sizeof c[0]), -g);
   _FXp_setw(xpx, 2, x);
   _FXp_addx(xpy, (sizeof c / sizeof c[0]), xpx, 2);
   x = _FXp_getw(xpy, (sizeof c / sizeof c[0]));
   }
  *px = x;
  }
 else
  {
  float xpx[2], xpy[(sizeof c / sizeof c[0])], xpz[(sizeof c / sizeof c[0])];
  short xexp;
  ...
  if (xexp < 24 + 5 + (1 << 3))
   _FXp_setw(xpz, (sizeof c / sizeof c[0]), x);
  else
   {
   xexp = (xexp - (24 + 1)) >> 3;
   _FDscale(&x, -(xexp << 3));
   ...
   memcpy(xpz, &b[xexp - 1][0], (sizeof c / sizeof c[0]) * sizeof (float));
   _FXp_mulh(xpz, (sizeof c / sizeof c[0]), xpx[0]);
   if (xpx[1] != 0.0F)
    {
    memcpy(xpy, &b[xexp - 1][0], (sizeof c / sizeof c[0]) * sizeof (float));
    _FXp_mulh(xpy, (sizeof c / sizeof c[0]), xpx[1]);
    _FXp_addx(xpz, (sizeof c / sizeof c[0]), xpy, (sizeof c / sizeof c[0]));
    }
   }
  ...
  for (; xpz[0] < -huge_rad || huge_rad < xpz[0]; )
   ...
   _FXp_setw(xpx, 2, -g * inv_fracbits);
   memcpy(xpy, c, (sizeof c / sizeof c[0]) * sizeof (float));
   _FXp_mulh(xpy, (sizeof c / sizeof c[0]), xpx[0]);

   if (xpx[1] != 0.0F)
    {
    float xpw[(sizeof c / sizeof c[0])];

    memcpy(xpw, c, (sizeof c / sizeof c[0]) * sizeof (float));
    _FXp_mulh(xpw, (sizeof c / sizeof c[0]), xpx[1]);
    _FXp_addx(xpy, (sizeof c / sizeof c[0]), xpw, (sizeof c / sizeof c[0]));
    }
   _FXp_addx(xpz, (sizeof c / sizeof c[0]), xpy, (sizeof c / sizeof c[0]));
   }
  ...
  if (g != 0.0F)
   ...
   memcpy(xpw, c, (sizeof c / sizeof c[0]) * sizeof (float));
   _FXp_mulh(xpw, (sizeof c / sizeof c[0]), -g * 0.25F * inv_fracbits);
   _FXp_addx(xpz, (sizeof c / sizeof c[0]), xpw, (sizeof c / sizeof c[0]));
   }

  *px = _FXp_getw(xpz, (sizeof c / sizeof c[0]));
  }

 if (g < -(float)0x7fffffffL
  || (float)0x7fffffffL < g)
...
unsigned int _FQuadph(float *px, float phase)
 ...
 if (ph0 < -(float)(0x7fffffffL / 2)
  || (float)(0x7fffffffL / 2) < ph0)
...
# 6 "/arm-libs/library-src/dinkum/source/./xfquad.c" 2
