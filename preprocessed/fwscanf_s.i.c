# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/fwscanf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/fwscanf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/fwscanf_s.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/fwscanf_s.c" 2
...
int (fwscanf_s)(FILE * str,
 ...
 if (str == 0 || fmt == 0)
  return (_Fail_s("fwscanf_s: bad argument", sizeof ("fwscanf_s: bad argument")), (-1));
