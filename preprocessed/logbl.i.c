# 1 "/arm-libs/library-src/dinkum/source/./logbl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./logbl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./logbl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxlogb.h" 1
...
# 4 "/arm-libs/library-src/dinkum/source/./xxlogb.h" 2
...
long double (logbl)(long double x)
 ...
 case 1:
  return (_LInf._Long_double);
 default:
  return ((long double)--xexp);
  }
 }
# 4 "/arm-libs/library-src/dinkum/source/./logbl.c" 2
