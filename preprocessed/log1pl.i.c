# 1 "/arm-libs/library-src/dinkum/source/./log1pl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./log1pl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./log1pl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxlog1p.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxlog1p.h" 2
...
long double (log1pl)(long double x)
 ...
 default:
  if (x < -1.0L)
   ...
   {
   long double y = 1.0L + x;

   return (logl(y) - (((y - 1.0L) - x) * (1.0L / (y))));
   }
  }
 }
# 4 "/arm-libs/library-src/dinkum/source/./log1pl.c" 2
