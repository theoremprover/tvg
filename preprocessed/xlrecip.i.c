# 1 "/arm-libs/library-src/dinkum/source/./xlrecip.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlrecip.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlrecip.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxrecip.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxrecip.h" 2



long double _LDivide(long double y, long double x)
 {
 return (y / x);
 }

long double _LRecip(long double x)
 {
 return (1.0L / x);
 }
# 4 "/arm-libs/library-src/dinkum/source/./xlrecip.c" 2
