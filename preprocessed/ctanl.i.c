# 1 "/arm-libs/library-src/dinkum/source/./ctanl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ctanl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./ctanl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxctan.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxctan.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxctan.h" 2


_Lcomplex (ctanl)(_Lcomplex x)
 {
 x = ctanhl(_LCbuild(-cimagl(x), creall(x)));

 return (_LCbuild(cimagl(x), -creall(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./ctanl.c" 2
