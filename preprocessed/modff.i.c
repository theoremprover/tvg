# 1 "/arm-libs/library-src/dinkum/source/./modff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./modff.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./modff.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxmodf.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxmodf.h" 2


float (modff)(float x, float *pint)
 {
 *pint = x;
 switch (_FDint(pint, 0))
  {
 case 2:
  return (x);
 ...
 case 1:
 case 0:
  return (((*_FPmsw(&(x))) & ((unsigned short)0x8000)) ? -_FZero : 0.0F);
...
# 4 "/arm-libs/library-src/dinkum/source/./modff.c" 2
