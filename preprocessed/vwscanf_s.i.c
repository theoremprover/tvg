# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vwscanf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vwscanf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/vwscanf_s.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/vwscanf_s.c" 2
...
int (vwscanf_s)(const wchar_t * fmt, va_list ap)
 {
 int ans;

 if (fmt == 0)
  return (_Fail_s("vwscanf_s: bad argument", sizeof ("vwscanf_s: bad argument")), (-1));

 (void)0;
 ans = _WScanf(&scin, (& _Stdin), fmt, ap, 1);
 (void)0;
 return (ans);
 }
