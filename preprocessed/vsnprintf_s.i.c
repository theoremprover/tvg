# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vsnprintf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vsnprintf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/vsnprintf_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/vsnprintf_s.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./c_ext1/vsnprintf_s.c" 2
...
int (vsnprintf_s)(char * s, rsize_t size,
 ...
 if (s == 0 || size == 0 || ((_Sizet)(-1) >> 1) < size || fmt == 0)
  return (_Fail_s("vsnprintf_s: bad argument", sizeof ("vsnprintf_s: bad argument")), (-1));
