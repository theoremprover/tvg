# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/strerrorlen_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/strerrorlen_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/strerrorlen_s.c" 2
...
size_t (strerrorlen_s)(errno_t errcode)
 {
 return (strlen(_Strerror(errcode, 0)));
 }
