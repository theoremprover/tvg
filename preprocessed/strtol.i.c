# 1 "/arm-libs/library-src/dinkum/source/./strtol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./strtol.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./strtol.c" 2
...
int isblank(int);
# 4 "/arm-libs/library-src/dinkum/source/./strtol.c" 2
# 1 "/toolchain/arm/include/errno.h" 1 3
# 490 "/toolchain/arm/include/errno.h" 3
extern int _Errno;
# 507 "/toolchain/arm/include/errno.h" 3
typedef int errno_t;
# 5 "/arm-libs/library-src/dinkum/source/./strtol.c" 2
# 1 "/toolchain/arm/include/limits.h" 1 3
# 6 "/arm-libs/library-src/dinkum/source/./strtol.c" 2
...
# 7 "/arm-libs/library-src/dinkum/source/./strtol.c" 2
...
# 8 "/arm-libs/library-src/dinkum/source/./strtol.c" 2
