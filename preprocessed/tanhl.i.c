# 1 "/arm-libs/library-src/dinkum/source/./tanhl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./tanhl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./tanhl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxtanh.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxtanh.h" 2
# 25 "/arm-libs/library-src/dinkum/source/./xxtanh.h"
static const long double halfpln2 = 19.76L;




static const long double c[] = {
 0.01750072318694301863L,
 0.44846583775713999745L,
 };
static const long double s[] = {
 -0.00000638332552609522L,
 0.00134544393444808061L,
 0.11513250442380779058L,
 };
# 82 "/arm-libs/library-src/dinkum/source/./xxtanh.h"
static const long double ln2by2 = 0.34657359027997265470861606072908827L;
static const long double ln2 = 0.69314718055994530941723212145817657L;




static long double _LTanh_approx(long double x)
 {
 const long double z = x * x;
 const long double ch = 1.0L + z * (c[0] * z + c[1]);
...
long double (tanhl)(long double x)
 ...
 default:
  ...
  if (x < _LRteps._Long_double)
   ;
# 134 "/arm-libs/library-src/dinkum/source/./xxtanh.h"
  else if (x < ln2by2)
   x = _LTanh_approx(x);
  else if (x < ln2)
   {
   const long double z = _LTanh_approx(x * 0.5L);
...
# 4 "/arm-libs/library-src/dinkum/source/./tanhl.c" 2
