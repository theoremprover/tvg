# 1 "/arm-libs/library-src/dinkum/source/./fputs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fputs.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fputs.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./fputs.c" 2
...
int (fputs)(const char * s, FILE * str)
 ...
 if ((str->_Mode & 0x800) != 0 && fflush(str))
  {
  (void)0;
  return ((-1));
  }
