# 1 "/arm-libs/library-src/dinkum/source/./strncasecmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./strncasecmp.c" 2
...
int isblank(int);
# 3 "/arm-libs/library-src/dinkum/source/./strncasecmp.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./strncasecmp.c" 2
...
int (strncasecmp)(const char *s1_arg, const char *s2_arg, size_t n)
 ...
 for (; 0 < n; ++s1, ++s2, --n)
  if (_Tolotab[(int)(*s1)] != _Tolotab[(int)(*s2)])
   return ((unsigned char)_Tolotab[(int)(*s1)]
    < (unsigned char)_Tolotab[(int)(*s2)] ? -1 : +1);
  else if (*s1 == '\0')
   return (0);
 return (0);
 }
