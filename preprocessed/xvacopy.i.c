# 1 "/arm-libs/library-src/dinkum/source/./xvacopy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xvacopy.c" 2
...
# 4 "/toolchain/arm/include/stdarg.h" 2 3
# 3 "/arm-libs/library-src/dinkum/source/./xvacopy.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xvacopy.c" 2


void _Vacopy(va_list *pap, va_list ap)
 {

  __builtin_va_copy(*pap, ap);
# 19 "/arm-libs/library-src/dinkum/source/./xvacopy.c"
 }
