# 1 "/arm-libs/library-src/dinkum/source/./xlvalues.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlvalues.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlvalues.c" 2
# 18 "/arm-libs/library-src/dinkum/source/./xlvalues.c"
const _Dconst _LDenorm = {{1, 0, 0, 0}};
const _Dconst _LEps = {
 {0, 0, 0, (0x3fe - (48 + 4) - 1) << 4}};
const _Dconst _LInf = {{0, 0, 0, ((unsigned short)((1 << (15 - 4)) - 1)) << 4}};
const _Dconst _LNan = {{0, 0, 0, (((unsigned short)((1 << (15 - 4)) - 1)) << 4) | (1 << (4 - 1))}};

const _Dconst _LSnan = {{1, 0, 0, ((unsigned short)((1 << (15 - 4)) - 1)) << 4}};
const _Dconst _LRteps = {
 {0, 0, 0, (0x3fe - (48 + 4) / 2) << 4}};
# 73 "/arm-libs/library-src/dinkum/source/./xlvalues.c"
const long double _LZero = 0.0L;
