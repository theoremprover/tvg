# 1 "/arm-libs/library-src/dinkum/source/./xfdsign.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfdsign.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfdsign.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxdsign.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxdsign.h" 2


int _FDsign(float x)
 {
 return (((*_FPmsw(&(x))) & ((unsigned short)0x8000)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xfdsign.c" 2
