# 1 "/arm-libs/library-src/dinkum/source/./coshf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./coshf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./coshf.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcosh.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcosh.h" 2


float (coshf)(float x)
 {
 return (_FCosh(x, 1.0F));
 }
# 4 "/arm-libs/library-src/dinkum/source/./coshf.c" 2
