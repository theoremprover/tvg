# 1 "/arm-libs/library-src/dinkum/source/./xwstof.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xwstof.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xwstof.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xwstof.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxwctype.h" 1
# 5 "/arm-libs/library-src/dinkum/source/./xwstof.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./xwstof.c" 2


float _WStofx(const wchar_t *s, wchar_t **endptr, long pten,
 int *perr)
...
# 22 "/arm-libs/library-src/dinkum/source/./xxstod.h"
 ...
 if ((code &= ~8) == 1)
  {
  const int nlo = _WStoflt(s0, s, endptr, lo, 1);
  float xpx[4], xpf[4];
  int i;
  ...
  {
  const int nlo = _WStoxflt(s0, s, endptr, lo, 1);
  float xpx[4], xpf[4];
  int i;
...
# 11 "/arm-libs/library-src/dinkum/source/./xwstof.c" 2

float _WStof(const wchar_t *s, wchar_t **endptr, long pten)
 {
