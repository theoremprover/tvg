# 1 "/arm-libs/library-src/dinkum/source/./fesetround.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fesetround.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fesetround.c" 2
# 192 "/arm-libs/library-src/dinkum/source/./fesetround.c"
int (fesetround)(int round)
 {
 fexcept_t control;

 if ((int)(round & 0x03u) != round)
  return (1);
 else
  {
  fegetenv(&control);
  control = control & ~(0x03u << 22)
   | (round << 22);
  fesetenv(&control);
  return (0);
  }
