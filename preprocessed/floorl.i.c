# 1 "/arm-libs/library-src/dinkum/source/./floorl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./floorl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./floorl.c" 2
...
long double (floorl)(long double x)
 ...
 return (_LDint(&y, 0) < 0 && x < 0.0L ? y - 1.0L : y);
 }
# 4 "/arm-libs/library-src/dinkum/source/./floorl.c" 2
