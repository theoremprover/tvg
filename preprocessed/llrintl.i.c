# 1 "/arm-libs/library-src/dinkum/source/./llrintl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./llrintl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./llrintl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxllrint.h" 1

# 1 "/toolchain/arm/include/limits.h" 1 3
# 3 "/arm-libs/library-src/dinkum/source/./xxllrint.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxllrint.h" 2
...
long long (llrintl)(long double x)
 ...
 default:
  ...
  if ((long double)(-0x7fffffffffffffffLL - 1) <= y && y <=(long double)0x7fffffffffffffffLL)
   return ((long long)y);
...
# 4 "/arm-libs/library-src/dinkum/source/./llrintl.c" 2
