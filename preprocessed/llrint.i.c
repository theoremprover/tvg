# 1 "/arm-libs/library-src/dinkum/source/./llrint.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./llrint.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./llrint.c" 2
...
long long (llrint)(double x)
 ...
 default:
  ...
  if ((double)(-0x7fffffffffffffffLL - 1) <= y && y <=(double)0x7fffffffffffffffLL)
   return ((long long)y);
...
# 4 "/arm-libs/library-src/dinkum/source/./llrint.c" 2
