# 1 "/arm-libs/library-src/dinkum/source/./tanh.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./tanh.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./tanh.c" 2
...
static const double halfpln2 = 19.76;




static const double c[] = {
 0.01750072318694301863,
 0.44846583775713999745,
 };
static const double s[] = {
 -0.00000638332552609522,
 0.00134544393444808061,
 0.11513250442380779058,
 };
# 82 "/arm-libs/library-src/dinkum/source/./xxtanh.h"
static const double ln2by2 = 0.34657359027997265470861606072908827;
static const double ln2 = 0.69314718055994530941723212145817657;




static double _Tanh_approx(double x)
 {
 const double z = x * x;
 const double ch = 1.0 + z * (c[0] * z + c[1]);
...
# 134 "/arm-libs/library-src/dinkum/source/./xxtanh.h"
   ...
   {
   const double z = _Tanh_approx(x * 0.5);
...
# 4 "/arm-libs/library-src/dinkum/source/./tanh.c" 2
