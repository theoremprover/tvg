# 1 "/arm-libs/library-src/dinkum/source/./log1pf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./log1pf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./log1pf.c" 2
...
float (log1pf)(float x)
 ...
 default:
  if (x < -1.0F)
   ...
   return (logf(y) - (((y - 1.0F) - x) * (1.0F / (y))));
   }
  }
 }
# 4 "/arm-libs/library-src/dinkum/source/./log1pf.c" 2
