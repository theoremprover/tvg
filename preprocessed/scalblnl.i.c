# 1 "/arm-libs/library-src/dinkum/source/./scalblnl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./scalblnl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./scalblnl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxscalbln.h" 1
...
# 4 "/arm-libs/library-src/dinkum/source/./xxscalbln.h" 2
...
long double (scalblnl)(long double x, long xexp)
 {
 if (xexp != 0 && _LDtest(&x) < 0)
...
# 4 "/arm-libs/library-src/dinkum/source/./scalblnl.c" 2
