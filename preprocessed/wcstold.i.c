# 1 "/arm-libs/library-src/dinkum/source/./wcstold.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./wcstold.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./wcstold.c" 2


long double (wcstold)(const wchar_t * s,
 wchar_t ** endptr)
 {
