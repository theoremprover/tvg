# 1 "/arm-libs/library-src/dinkum/source/./fgetwc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fgetwc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fgetwc.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./fgetwc.c" 2
...
wint_t (fgetwc)(FILE *str)
 ...
 for (; ; )
  ...
  case 0:
   if (wc == L'\0')
    nc = (int)(strlen((const char *)pbuf) + 1);
