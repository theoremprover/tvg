# 1 "/arm-libs/library-src/dinkum/source/./errno.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./errno.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./errno.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./errno.c" 2
...
# 9 "/arm-libs/library-src/dinkum/source/./errno.c" 2
...
# 10 "/arm-libs/library-src/dinkum/source/./errno.c" 2


 int _Errno = 0; int (*_Tls_setup__Errno)(void) = 0;

int *(_Geterrno)(void)
 {
 return (((_Tls_setup__Errno && _Tls_setup__Errno()), (&(_Errno))));
 }
