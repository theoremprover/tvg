# 1 "/arm-libs/library-src/dinkum/source/./xfcbuild.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfcbuild.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfcbuild.c" 2
...
_Fcomplex (_FCbuild)(float re, float im)
 {
 float ans[2];
...
# 4 "/arm-libs/library-src/dinkum/source/./xfcbuild.c" 2
