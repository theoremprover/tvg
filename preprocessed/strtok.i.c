# 1 "/arm-libs/library-src/dinkum/source/./strtok.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./strtok.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./strtok.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./strtok.c" 2


typedef char *pchar_t;

static pchar_t ssave = ""; static int (*_Tls_setup_ssave)(void) = 0;

char *(strtok)(char * s1, const char * s2)
 {
 char *sbegin, *send;
 pchar_t *pssave = ((_Tls_setup_ssave && _Tls_setup_ssave()), (&(ssave)));
