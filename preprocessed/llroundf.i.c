# 1 "/arm-libs/library-src/dinkum/source/./llroundf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./llroundf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./llroundf.c" 2
...
long long (llroundf)(float x)
 ...
 default:
  x = roundf(x);
  if ((float)(-0x7fffffffffffffffLL - 1) <= x && x <= (float)0x7fffffffffffffffLL)
   return ((long long)x);
...
# 4 "/arm-libs/library-src/dinkum/source/./llroundf.c" 2
