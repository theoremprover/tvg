# 1 "/arm-libs/library-src/dinkum/source/./scalbnl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./scalbnl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./scalbnl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxscalbn.h" 1
...
# 4 "/arm-libs/library-src/dinkum/source/./xxscalbn.h" 2
...
long double (scalbnl)(long double x, int xexp)
 {
...
# 4 "/arm-libs/library-src/dinkum/source/./scalbnl.c" 2
