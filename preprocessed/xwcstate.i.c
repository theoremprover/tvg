# 1 "/arm-libs/library-src/dinkum/source/./xwcstate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xwcstate.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xwcstate.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xwcstate.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xwcstate.c" 2


 _Statab _Wcstate = {{0}}; int (*_Tls_setup__Wcstate)(void) = 0;

_Statab *_Getpwcstate()
 {
 return (((_Tls_setup__Wcstate && _Tls_setup__Wcstate()), (&(_Wcstate))));
 }
