# 1 "/arm-libs/library-src/dinkum/source/./exp2l.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./exp2l.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./exp2l.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxexp2.h" 1

# 1 "/toolchain/arm/include/limits.h" 1 3
# 3 "/arm-libs/library-src/dinkum/source/./xxexp2.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxexp2.h" 2


static const long double ln2 = 0.69314718055994530941723212145817658L;
...
long double (exp2l)(long double x)
 ...
 case 1:
  return (((*_LPmsw(&(x))) & ((unsigned short)0x8000)) ? 0.0L : x);

 case 0:
  return (1.0L);

 default:
  if (x <= (long double)(-0x7fffffffL - 1))
   return (0.0L);
  else if ((long double)0x7fffffffL <= x)
...
# 4 "/arm-libs/library-src/dinkum/source/./exp2l.c" 2
