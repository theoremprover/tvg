# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vsscanf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vsscanf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/vsscanf_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/vsscanf_s.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./c_ext1/vsscanf_s.c" 2
...
int (vsscanf_s)(const char * buf, const char * fmt,
 va_list ap)
 {
 if (buf == 0 || fmt == 0)
  return (_Fail_s("vsscanf_s: bad argument", sizeof ("vsscanf_s: bad argument")), (-1));

 return (_Scanf(&scin, (void **)&buf, fmt, ap, 1));
 }
