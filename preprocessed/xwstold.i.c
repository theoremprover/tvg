# 1 "/arm-libs/library-src/dinkum/source/./xwstold.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xwstold.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xwstold.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xwstold.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxwctype.h" 1
# 5 "/arm-libs/library-src/dinkum/source/./xwstold.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./xwstold.c" 2


long double _WStoldx(const wchar_t *s, wchar_t **endptr, long pten,
 int *perr)
...
# 11 "/arm-libs/library-src/dinkum/source/./xwstold.c" 2

long double _WStold(const wchar_t *s, wchar_t **endptr, long pten)
 {
