# 1 "/arm-libs/library-src/dinkum/source/./xlcosh.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlcosh.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlcosh.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxcosh.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxcosh.h" 2


static const long double xbig = (long double)(0.347 * (53 + 1));

long double _LCosh(long double x, long double y)
 {
 ...
 if (0 <= errx || 0 <= erry)
  ...
  if (errx == 2)
   ...
   if (erry != 0)
    return (y < 0.0L ? -_LInf._Long_double
     : _LInf._Long_double);
   else
    {
    _Feraise(0x01);
...
# 4 "/arm-libs/library-src/dinkum/source/./xlcosh.c" 2
