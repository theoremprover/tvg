# 1 "/arm-libs/library-src/dinkum/source/./xmakewct.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xmakewct.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xmakewct.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xmakewct.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xmakewct.c" 2
...
int _Makewct(_Linfo *p, const _Locitem *q, const char *s)
 ...
 char *s1;
 int nameonly;
 int wasnew = ((*(_Wctab * *)((char *)p + q->_Offset)) != (*(_Wctab * *)((char *)&_Clocale + q->_Offset)));
 _Wctab *po = (*(_Wctab * *)((char *)p + q->_Offset));
 _Wctab *ps, *pt;
  ...
  *s1 = ' ';
  ...
  memmove(px + ps->_Off + n, px + ps->_Off,
   (pt->_Off - ps->_Off) * sizeof (wchar_t));
  memcpy(px + ps->_Off, vals, n * sizeof (wchar_t));
  for (; ps <= pt; ++ps)
   ps->_Off += n;
  }
 return (1);
