# 1 "/arm-libs/library-src/dinkum/source/./mbtowc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./mbtowc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./mbtowc.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./mbtowc.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./mbtowc.c" 2

static mbstate_t mbst = {0}; static int (*_Tls_setup_mbst)(void) = 0;
int (mbtowc)(wchar_t * pwc, const char * s, size_t n)
 {
 int i = _Mbtowc(pwc, s,
  n <= _Getmbcurmax() ? n : _Getmbcurmax(), ((_Tls_setup_mbst && _Tls_setup_mbst()), (&(mbst))));
