# 1 "/arm-libs/library-src/dinkum/source/./xldtest.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xldtest.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xldtest.c" 2



short _LDtest(long double *px)
 {
 return (_Dtest((double *)px));
 }
# 47 "/arm-libs/library-src/dinkum/source/./xldtest.c"
unsigned short *_LPlsw(long double *px)
 {
 return (&((_Lval *)(char *)px)->_Sh[0]);
 }

unsigned short *_LPmsw(long double *px)
 {
 return (&((_Lval *)(char *)px)->_Sh[3]);
 }
