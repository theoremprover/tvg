# 1 "/arm-libs/library-src/dinkum/source/./rand_r.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./rand_r.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./rand_r.c" 2


int (rand_r)(unsigned int *pseed)
 {
 *pseed = *pseed * 1103515245 + 12345;
 return ((unsigned int)(*pseed >> 16) & 0x3fffffff);
 }
