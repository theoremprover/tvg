# 1 "/arm-libs/library-src/dinkum/source/./srand.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./srand.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./srand.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./srand.c" 2


extern int (*_Tls_setup__Randinit)(void); extern char _Randinit;
extern int (*_Tls_setup__Randseed)(void); extern unsigned long _Randseed;

void (srand)(unsigned int seed)
 {
 *((_Tls_setup__Randinit && _Tls_setup__Randinit()), (&(_Randinit))) = 0;
 *((_Tls_setup__Randseed && _Tls_setup__Randseed()), (&(_Randseed))) = seed;
 }
