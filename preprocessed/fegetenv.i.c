# 1 "/arm-libs/library-src/dinkum/source/./fegetenv.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fegetenv.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fegetenv.c" 2
# 24 "/arm-libs/library-src/dinkum/source/./fegetenv.c"
int (fegetenv)(fenv_t *penv)
 {
# 133 "/arm-libs/library-src/dinkum/source/./fegetenv.c"
      __asm__("vmrs %0, fpscr" : "=r" (*penv));
# 157 "/arm-libs/library-src/dinkum/source/./fegetenv.c"
 return (0);
 }
