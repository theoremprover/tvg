# 1 "/arm-libs/library-src/dinkum/source/./cabsl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cabsl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cabsl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcabs.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcabs.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxcabs.h" 2


long double hypotl(long double, long double);

long double (cabsl)(_Lcomplex x)
 {
 return (hypotl(creall(x), cimagl(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./cabsl.c" 2
