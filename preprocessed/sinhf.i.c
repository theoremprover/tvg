# 1 "/arm-libs/library-src/dinkum/source/./sinhf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./sinhf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./sinhf.c" 2
...
float (sinhf)(float x)
 {
 return (_FSinh(x, 1.0F));
 }
# 4 "/arm-libs/library-src/dinkum/source/./sinhf.c" 2
