# 1 "/arm-libs/library-src/dinkum/source/./xcdivcr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xcdivcr.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xcdivcr.c" 2
...
_Dcomplex (_Cdivcr)(_Dcomplex x, double y)
 {
 return (_Cbuild(creal(x) / y, cimag(x) / y));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xcdivcr.c" 2
