# 1 "/arm-libs/library-src/dinkum/source/./xwstoll.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xwstoll.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./xwstoll.c" 2
# 1 "/toolchain/arm/include/limits.h" 1 3
# 4 "/arm-libs/library-src/dinkum/source/./xwstoll.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xwstoll.c" 2
...
# 247 "/toolchain/arm/include/wchar.h" 3
...
# 6 "/arm-libs/library-src/dinkum/source/./xwstoll.c" 2
...
_Longlong (_WStoll)(const wchar_t * s, wchar_t **endptr, int base)
 ...
 else if ((sign == L'+' && 0x7fffffffffffffffLL < x)
  || (sign == L'-' && 0 - (_ULonglong)(-0x7fffffffffffffffLL - 1) < x))
  {
  ( _Errno) = 0x0022;
  return (sign == L'-' ? (-0x7fffffffffffffffLL - 1) : 0x7fffffffffffffffLL);
  }
 else
