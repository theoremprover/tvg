# 1 "/arm-libs/library-src/dinkum/source/./xlcbuild.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlcbuild.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlcbuild.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxcbuild.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxcbuild.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxxcbuild.h" 2


_Lcomplex (_LCbuild)(long double re, long double im)
 {
 long double ans[2];
...
# 4 "/arm-libs/library-src/dinkum/source/./xlcbuild.c" 2
