# 1 "/arm-libs/library-src/dinkum/source/./fclose.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fclose.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./fclose.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./fclose.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./fclose.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./fclose.c" 2
...
# 7 "/arm-libs/library-src/dinkum/source/./fclose.c" 2


static _Once_t closeallreg_o = 0;
...
void _Closreg(void)
 {
 if (*(&closeallreg_o) == 0) (closeallreg)(), *(&closeallreg_o) = 2;
 }
