# 1 "/arm-libs/library-src/dinkum/source/./mbrlen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./mbrlen.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./mbrlen.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./mbrlen.c" 2

static mbstate_t mbst = {0}; static int (*_Tls_setup_mbst)(void) = 0;
size_t (mbrlen)(const char * s, size_t n,
 mbstate_t * pst)
 {
 return (_Mbtowc(0, s, n, pst ? pst : ((_Tls_setup_mbst && _Tls_setup_mbst()), (&(mbst)))));
 }
