# 1 "/arm-libs/library-src/dinkum/source/./xfloat.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfloat.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfloat.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xfloat.c" 2
...
# 70 "/arm-libs/library-src/dinkum/source/./xfloat.c"
const _Dvals _Flt = {
 (int)(((17 + 7) - 1) * 0.30103),
 (int)(17 + 7),
 (int)((((1U << (15 - 7)) - 1) - 0x7e - 1) * 0.30103),
 (int)(((1U << (15 - 7)) - 1) - 0x7e - 1),
 (int)(-0x7e * 0.30103),
 (int)(1 - 0x7e),
 {0, (0x7e - (17 + 7) + 2) << 7, 0, 0, 0, 0},
 {0xffff, (((1U << (15 - 7)) - 1) << 7) - 1, 0, 0, 0, 0},
 {0, 1 << 7, 0, 0, 0, 0},
 };
...
const _Dvals _Dbl = {
 (int)(((49 + 4) - 1) * 0.30103),
 (int)(49 + 4),
 (int)((((1U << (15 - 4)) - 1) - 0x3fe - 1) * 0.30103),
 (int)(((1U << (15 - 4)) - 1) - 0x3fe - 1),
 (int)(-0x3fe * 0.30103),
 (int)(1 - 0x3fe),
 {0, 0, 0, (0x3fe - (49 + 4) + 2) << 4, 0, 0},
 {0xffff, 0xffff, 0xffff, (((1U << (15 - 4)) - 1) << 4) - 1, 0, 0},
 {0, 0, 0, 1 << 4, 0, 0},
 };
