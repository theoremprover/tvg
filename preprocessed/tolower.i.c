# 1 "/arm-libs/library-src/dinkum/source/./tolower.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./tolower.c" 2
...
int isblank(int);
# 3 "/arm-libs/library-src/dinkum/source/./tolower.c" 2


int (tolower)(int c)
 {
 return (_Tolotab[(int)(c)]);
 }
