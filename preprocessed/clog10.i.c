# 1 "/arm-libs/library-src/dinkum/source/./clog10.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./clog10.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./clog10.c" 2
...
_Dcomplex (clog10)(_Dcomplex x)
 {
 return (((clog(x)) * (0.43429448190325182765112891891660507)));

 }
# 4 "/arm-libs/library-src/dinkum/source/./clog10.c" 2
