# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/xfail_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/xfail_s.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/xfail_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/xfail_s.c" 2
...
int putc(int, FILE *);
int putchar(int);
# 343 "/toolchain/arm/include/stdio.h" 3
...
# 5 "/arm-libs/library-src/dinkum/source/./c_ext1/xfail_s.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./c_ext1/xfail_s.c" 2
...
# 7 "/arm-libs/library-src/dinkum/source/./c_ext1/xfail_s.c" 2


static constraint_handler_t sec_hand = 0;

constraint_handler_t set_constraint_handler_s(
 constraint_handler_t new_hand)
 {
 constraint_handler_t temp_hand;
...
errno_t (_Fail_s)(const char *s, size_t maxsize)
 {
 if (s == 0 || s[strnlen_s(s, maxsize)] != '\0')
  s = "constraint handler: bad message";
