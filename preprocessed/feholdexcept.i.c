# 1 "/arm-libs/library-src/dinkum/source/./feholdexcept.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./feholdexcept.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./feholdexcept.c" 2
# 25 "/arm-libs/library-src/dinkum/source/./feholdexcept.c"
int (feholdexcept)(fenv_t *penv)
 {
 fenv_t env;

 fegetenv(&env);
# 40 "/arm-libs/library-src/dinkum/source/./feholdexcept.c"
 *penv = env;
 ...
 *penv &= ~(((0x02 | 0x10 | 0x01 | 0x04 | 0x08) << 0)
  | ((0x02 | 0x10 | 0x01 | 0x04 | 0x08) << 8));


 fesetenv(&env);
# 84 "/arm-libs/library-src/dinkum/source/./feholdexcept.c"
 return (0);
 }
