# 1 "/arm-libs/library-src/dinkum/source/./lroundf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./lroundf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./lroundf.c" 2
...
long (lroundf)(float x)
 ...
 default:
  x = roundf(x);
  if ((float)(-0x7fffffffL - 1) <= x && x <= (float)0x7fffffffL)
   return ((long)x);
...
# 4 "/arm-libs/library-src/dinkum/source/./lroundf.c" 2
