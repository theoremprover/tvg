# 1 "/arm-libs/library-src/dinkum/source/./freopen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./freopen.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./freopen.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./freopen.c" 2
...
FILE *(freopen)(const char * filename,
 ...
 {
 unsigned short mode;
# 27 "/arm-libs/library-src/dinkum/source/./freopen.c"
 (void)0;
 ...
 (void)0;
 str = _Foprep(filename, mods, str, (-1), 0);
 (void)0;
