# 1 "/arm-libs/library-src/dinkum/source/./tmpnam.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./tmpnam.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./tmpnam.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./tmpnam.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./tmpnam.c" 2
# 21 "/arm-libs/library-src/dinkum/source/./tmpnam.c"
char *(tmpnam)(char *s)
 {
 char *p;
 int i;
...
# 61 "/arm-libs/library-src/dinkum/source/./tmpnam.c"
 (void)0;
 if (s == 0)
  s = buf;
 ++seed;
