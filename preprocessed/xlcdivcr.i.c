# 1 "/arm-libs/library-src/dinkum/source/./xlcdivcr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlcdivcr.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlcdivcr.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxcdivcr.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxcdivcr.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxxcdivcr.h" 2


_Lcomplex (_LCdivcr)(_Lcomplex x, long double y)
 {
 return (_LCbuild(creall(x) / y, cimagl(x) / y));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xlcdivcr.c" 2
