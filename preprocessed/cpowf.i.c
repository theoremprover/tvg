# 1 "/arm-libs/library-src/dinkum/source/./cpowf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cpowf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cpowf.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcpow.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcpow.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxcpow.h" 2
...
_Fcomplex (cpowf)(_Fcomplex x, _Fcomplex y)
 ...
 else if (!(crealf(x) == 0.0F)
  && !(cimagf(y) == 0.0F))
  return (cexpf(((y) * (logf(crealf(x))))));
 else
  return (_FCbuild(powf(crealf(x), crealf(y)),
   0.0F));
 }
# 4 "/arm-libs/library-src/dinkum/source/./cpowf.c" 2
