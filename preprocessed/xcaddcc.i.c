# 1 "/arm-libs/library-src/dinkum/source/./xcaddcc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xcaddcc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xcaddcc.c" 2
...
_Dcomplex (_Caddcc)(_Dcomplex x, _Dcomplex y)
 {
 return (_Cbuild(creal(x) + creal(y),
  cimag(x) + cimag(y)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xcaddcc.c" 2
