# 1 "/arm-libs/library-src/dinkum/source/./xlpoly.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xlpoly.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xlpoly.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxpoly.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxpoly.h" 2
# 27 "/arm-libs/library-src/dinkum/source/./xxxpoly.h"
long double _LPoly(long double x, const long double *tab, int n)
 {
 long double y;
...
# 4 "/arm-libs/library-src/dinkum/source/./xlpoly.c" 2
