# 1 "/arm-libs/library-src/dinkum/source/./mbrtoc32.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./mbrtoc32.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./mbrtoc32.c" 2
...
size_t c32rtomb(char *, char32_t,
 mbstate_t *);
# 4 "/arm-libs/library-src/dinkum/source/./mbrtoc32.c" 2
