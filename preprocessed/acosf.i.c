# 1 "/arm-libs/library-src/dinkum/source/./acosf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./acosf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./acosf.c" 2
...
float (acosf)(float x)
 ...
 default:
  ...
  if (x <= rthalf)
   ...
   x = (((((s[0] * eps + s[1]) * eps + s[2]) * eps + s[3]) * eps + s[4]) * eps + s[5]) * sqrtf(eps);
...
# 4 "/arm-libs/library-src/dinkum/source/./acosf.c" 2
