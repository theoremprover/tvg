# 1 "/arm-libs/library-src/dinkum/source/./lround.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./lround.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./lround.c" 2
...
long (lround)(double x)
 ...
 default:
  x = round(x);
  if ((double)(-0x7fffffffL - 1) <= x && x <= (double)0x7fffffffL)
   return ((long)x);
...
# 4 "/arm-libs/library-src/dinkum/source/./lround.c" 2
