# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdisf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdisf.c" 2
# 23 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdisf.c"
...
# 24 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdisf.c" 2
...
__floatdisf(di_int a)
{
    ...
    if (sd > 24)
    {
# 45 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdisf.c"
        switch (sd)
        {
        case 24 + 1:
            a <<= 1;
...
__attribute__((__pcs__("aapcs"))) float __aeabi_l2f(di_int a) {
