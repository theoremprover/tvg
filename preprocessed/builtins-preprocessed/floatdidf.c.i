# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdidf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdidf.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdidf.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdidf.c" 2
# 30 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdidf.c"
                double
...
# 109 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatdidf.c"
__attribute__((__pcs__("aapcs"))) double __aeabi_l2d(di_int a) {
