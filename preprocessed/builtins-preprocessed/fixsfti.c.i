# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixsfti.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixsfti.c" 2
# 11 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixsfti.c"
...
# 12 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixsfti.c" 2
