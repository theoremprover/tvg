# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/muldf3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/muldf3.c" 2
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/muldf3.c"
...
static __inline fp_t __mulXf3__(fp_t a, fp_t b) {
    ...
    const rep_t productSign = (toRep(a) ^ toRep(b)) & (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1)));
    ...
    if (aExponent-1U >= ((1 << ((sizeof(rep_t)*8) - 52 - 1)) - 1)-1U || bExponent-1U >= ((1 << ((sizeof(rep_t)*8) - 52 - 1)) - 1)-1U) {
        ...
        if (aAbs == (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U))) {
            ...
            else return fromRep(((((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U)) | ((1ULL << 52) >> 1)));
        }

        if (bAbs == (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U))) {
    ...
    if (productHi & (1ULL << 52)) productExponent++;
    else wideLeftShift(&productHi, &productLo, 1);


    if (productExponent >= ((1 << ((sizeof(rep_t)*8) - 52 - 1)) - 1)) return fromRep((((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U)) | productSign);
    ...
    if (productExponent <= 0) {
        ...
        const unsigned int shift = 1ULL - (unsigned int)productExponent;
    ...
    if (productLo > (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1)))) productHi++;
    if (productLo == (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1)))) productHi += productHi & 1;
    return fromRep(productHi);
}
# 17 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/muldf3.c" 2
...
__attribute__((__pcs__("aapcs"))) fp_t __aeabi_dmul(fp_t a, fp_t b) {
  return __muldf3(a, b);
}
