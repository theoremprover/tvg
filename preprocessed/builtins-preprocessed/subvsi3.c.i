# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subvsi3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subvsi3.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subvsi3.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subvsi3.c" 2
...
__subvsi3(si_int a, si_int b)
{
    ...
    {
        if (s > a)
            compilerrt_abort_impl("/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subvsi3.c", 28, __func__);
    }
    else
    {
        if (s <= a)
            compilerrt_abort_impl("/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subvsi3.c", 33, __func__);
    }
    return s;
}
