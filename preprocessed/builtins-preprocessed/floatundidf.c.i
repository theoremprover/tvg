# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatundidf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatundidf.c" 2
# 23 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatundidf.c"
...
# 24 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatundidf.c" 2
...
# 108 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatundidf.c"
__attribute__((__pcs__("aapcs"))) double __aeabi_ul2d(du_int a) {
