# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/arm/aeabi_div0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/arm/aeabi_div0.c" 2
# 29 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/arm/aeabi_div0.c"
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/arm/../int_lib.h" 1
# 71 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/arm/../int_lib.h"
...
# 72 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/arm/../int_lib.h" 2
...
# 74 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/arm/../int_lib.h" 2
...
# 30 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/arm/aeabi_div0.c" 2


extern unsigned char declaration;


__attribute__((__pcs__("aapcs"))) int __attribute__((weak)) __attribute__((visibility("hidden")))
__aeabi_idiv0(int return_value) {
  return return_value;
}

__attribute__((__pcs__("aapcs"))) long long __attribute__((weak)) __attribute__((visibility("hidden")))
