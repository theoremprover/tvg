# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatsidf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatsidf.c" 2
# 17 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatsidf.c"
...
# 18 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatsidf.c" 2
...
__floatsidf(int a) {
    ...
    rep_t sign = 0;
    if (a < 0) {
        sign = (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1)));
        a = -a;
    }
    ...
    result = (rep_t)(unsigned int)a << shift ^ (1ULL << 52);
...
__attribute__((__pcs__("aapcs"))) fp_t __aeabi_i2d(int a) {
