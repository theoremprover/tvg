# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/adddf3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/adddf3.c" 2
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/adddf3.c"
...
static __inline fp_t __addXf3__(fp_t a, fp_t b) {
    rep_t aRep = toRep(a);
    rep_t bRep = toRep(b);
    const rep_t aAbs = aRep & ((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U);
    const rep_t bAbs = bRep & ((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U);


    if (aAbs - 1ULL >= (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U)) - 1ULL ||
        bAbs - 1ULL >= (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U)) - 1ULL) {
        ...
        if (aAbs == (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U))) {
            ...
            if ((toRep(a) ^ toRep(b)) == (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1)))) return fromRep(((((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U)) | ((1ULL << 52) >> 1)));

            else return a;
        }


        if (bAbs == (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U))) return b;
    ...
    rep_t aSignificand = aRep & ((1ULL << 52) - 1U);
    rep_t bSignificand = bRep & ((1ULL << 52) - 1U);
    ...
    const rep_t resultSign = aRep & (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1)));
    const _Bool subtraction = (aRep ^ bRep) & (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1)));





    aSignificand = (aSignificand | (1ULL << 52)) << 3;
    bSignificand = (bSignificand | (1ULL << 52)) << 3;
    ...
    if (subtraction) {
        ...
        if (aSignificand < (1ULL << 52) << 3) {
            const int shift = rep_clz(aSignificand) - rep_clz((1ULL << 52) << 3);
            aSignificand <<= shift;
            aExponent -= shift;
        }
    }
    ...
    if (aExponent >= ((1 << ((sizeof(rep_t)*8) - 52 - 1)) - 1)) return fromRep((((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U)) | resultSign);
    ...
    rep_t result = aSignificand >> 3 & ((1ULL << 52) - 1U);
