# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/absvsi2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/absvsi2.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/absvsi2.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/absvsi2.c" 2
...
__absvsi2(si_int a)
{
    ...
    if (a == (1 << (N-1)))
        compilerrt_abort_impl("/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/absvsi2.c", 26, __func__);
