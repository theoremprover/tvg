# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negsf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negsf2.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negsf2.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negsf2.c" 2
...
__attribute__((__pcs__("aapcs"))) fp_t __aeabi_fneg(fp_t a) {
  return __negsf2(a);
}
