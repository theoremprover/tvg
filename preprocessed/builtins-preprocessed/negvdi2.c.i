# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negvdi2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negvdi2.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negvdi2.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negvdi2.c" 2
...
__negvdi2(di_int a)
{
    ...
    if (a == MIN)
        compilerrt_abort_impl("/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negvdi2.c", 26, __func__);
    return -a;
}
