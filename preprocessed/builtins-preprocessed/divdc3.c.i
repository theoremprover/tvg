# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divdc3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divdc3.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divdc3.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divdc3.c" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/int_math.h" 1
# 17 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divdc3.c" 2
...
{
    int __ilogbw = 0;
    double __logbw = __builtin_logb((__builtin_fmax((__builtin_fabs((__c))), (__builtin_fabs((__d))))));
    if (__builtin_isfinite((__logbw)))
    {
        __ilogbw = (int)__logbw;
        __c = __builtin_scalbn((__c), (-__ilogbw));
        __d = __builtin_scalbn((__d), (-__ilogbw));
    }
    double __denom = __c * __c + __d * __d;
    Dcomplex z;
    __real__(z) = __builtin_scalbn(((__a * __c + __b * __d) / __denom), (-__ilogbw));
    __imag__(z) = __builtin_scalbn(((__b * __c - __a * __d) / __denom), (-__ilogbw));
    if (__builtin_isnan((__real__(z))) && __builtin_isnan((__imag__(z))))
    {
        if ((__denom == 0.0) && (!__builtin_isnan((__a)) || !__builtin_isnan((__b))))
        {
            __real__(z) = __builtin_copysign((__builtin_huge_valf()), (__c)) * __a;
            __imag__(z) = __builtin_copysign((__builtin_huge_valf()), (__c)) * __b;
        }
