# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsc3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsc3.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsc3.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsc3.c" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/int_math.h" 1
# 17 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsc3.c" 2
...
{
    int __ilogbw = 0;
    float __logbw = __builtin_logbf((__builtin_fmaxf((__builtin_fabsf((__c))), (__builtin_fabsf((__d))))));
    if (__builtin_isfinite((__logbw)))
    {
        __ilogbw = (int)__logbw;
        __c = __builtin_scalbnf((__c), (-__ilogbw));
        __d = __builtin_scalbnf((__d), (-__ilogbw));
    }
    float __denom = __c * __c + __d * __d;
    Fcomplex z;
    __real__(z) = __builtin_scalbnf(((__a * __c + __b * __d) / __denom), (-__ilogbw));
    __imag__(z) = __builtin_scalbnf(((__b * __c - __a * __d) / __denom), (-__ilogbw));
