# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunssfdi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunssfdi.c" 2
# 12 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunssfdi.c"
...
# 13 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunssfdi.c" 2
...
# 47 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunssfdi.c"
__attribute__((__pcs__("aapcs"))) du_int __aeabi_f2ulz(fp_t a) {
