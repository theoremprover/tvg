# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negdf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negdf2.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negdf2.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/negdf2.c" 2

                fp_t
__negdf2(fp_t a) {
    return fromRep(toRep(a) ^ (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))));
}



__attribute__((__pcs__("aapcs"))) fp_t __aeabi_dneg(fp_t a) {
  return __negdf2(a);
}
