# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/truncsfhf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/truncsfhf2.c" 2
# 12 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/truncsfhf2.c"
...
# 13 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/truncsfhf2.c" 2
...
__attribute__((__pcs__("aapcs"))) uint16_t __aeabi_f2h(float a) {
  return __truncsfhf2(a);
}
