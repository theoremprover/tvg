# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsf3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsf3.c" 2
# 20 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsf3.c"
...
# 21 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsf3.c" 2
...
# 91 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsf3.c"
    uint32_t correction;
    ...
    reciprocal -= 2;
# 119 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsf3.c"
    rep_t quotient = (uint64_t)reciprocal*(aSignificand << 1) >> 32;
# 134 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/divsf3.c"
    rep_t residual;
    if (quotient < ((1U << 23) << 1)) {
...
__attribute__((__pcs__("aapcs"))) fp_t __aeabi_fdiv(fp_t a, fp_t b) {
  return __divsf3(a, b);
}
