# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatunsisf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatunsisf.c" 2
# 17 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatunsisf.c"
...
# 18 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/floatunsisf.c" 2
...
__attribute__((__pcs__("aapcs"))) fp_t __aeabi_ui2f(unsigned int a) {
