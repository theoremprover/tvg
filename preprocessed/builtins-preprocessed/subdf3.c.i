# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subdf3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subdf3.c" 2
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subdf3.c"
...
# 17 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subdf3.c" 2


                fp_t
__subdf3(fp_t a, fp_t b) {
    return __adddf3(a, fromRep(toRep(b) ^ (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1)))));
}



__attribute__((__pcs__("aapcs"))) fp_t __aeabi_dsub(fp_t a, fp_t b) {
  return __subdf3(a, b);
}
