# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/truncdfsf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/truncdfsf2.c" 2
# 12 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/truncdfsf2.c"
...
# 48 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fp_trunc.h"
typedef float dst_t;
...
# 13 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/truncdfsf2.c" 2
...
__attribute__((__pcs__("aapcs"))) float __aeabi_d2f(double a) {
