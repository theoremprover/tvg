# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/comparedf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/comparedf2.c" 2
# 41 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/comparedf2.c"
...
# 42 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/comparedf2.c" 2
...
__ledf2(fp_t a, fp_t b) {
    ...
    const rep_t aAbs = aInt & ((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U);
    const rep_t bAbs = bInt & ((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U);


    if (aAbs > (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U)) || bAbs > (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U))) return LE_UNORDERED;
...
void __cmpdf2() __attribute__((__alias__("__ledf2")));
...
__gedf2(fp_t a, fp_t b) {
    ...
    if (aAbs > (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U)) || bAbs > (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U))) return GE_UNORDERED;
...
__unorddf2(fp_t a, fp_t b) {
    ...
    return aAbs > (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U)) || bAbs > (((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U) ^ ((1ULL << 52) - 1U));
}
...
__attribute__((__pcs__("aapcs"))) int __aeabi_dcmpun(fp_t a, fp_t b) {
