# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfsi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfsi.c" 2
# 12 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfsi.c"
...
# 13 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfsi.c" 2
typedef si_int fixint_t;
typedef su_int fixuint_t;

# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fp_fixint_impl.inc" 1
# 17 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fp_fixint_impl.inc"
static __inline fixint_t __fixint(fp_t a) {
    ...
    const fixint_t sign = aRep & (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) ? -1 : 1;
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfsi.c" 2
...
__attribute__((__pcs__("aapcs"))) si_int __aeabi_d2iz(fp_t a) {
  return __fixdfsi(a);
}
