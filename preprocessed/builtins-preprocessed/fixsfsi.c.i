# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixsfsi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixsfsi.c" 2
# 12 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixsfsi.c"
...
# 13 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixsfsi.c" 2
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixsfsi.c" 2
...
__attribute__((__pcs__("aapcs"))) si_int __aeabi_f2iz(fp_t a) {
  return __fixsfsi(a);
}
