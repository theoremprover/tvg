# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/ashrdi3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/ashrdi3.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/ashrdi3.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/ashrdi3.c" 2
...
__attribute__((__pcs__("aapcs"))) di_int __aeabi_lasr(di_int a, si_int b) __attribute__((__alias__("__ashrdi3")));
