# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/mulvdi3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/mulvdi3.c" 2
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/mulvdi3.c"
...
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/mulvdi3.c" 2
...
__mulvdi3(di_int a, di_int b)
{
    ...
    if (a == MIN)
    {
        if (b == 0 || b == 1)
            return a * b;
        compilerrt_abort_impl("/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/mulvdi3.c", 31, __func__);
    }
    if (b == MIN)
    {
        if (a == 0 || a == 1)
            return a * b;
        compilerrt_abort_impl("/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/mulvdi3.c", 37, __func__);
    }
    di_int sa = a >> (N - 1);
    ...
    {
        if (abs_a > MAX / abs_b)
            compilerrt_abort_impl("/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/mulvdi3.c", 48, __func__);
    }
    else
    {
        if (abs_a > MIN / -abs_b)
            compilerrt_abort_impl("/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/mulvdi3.c", 53, __func__);
    }
    return a * b;
}
