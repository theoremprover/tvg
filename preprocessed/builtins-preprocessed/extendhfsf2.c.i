# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/extendhfsf2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/extendhfsf2.c" 2
# 13 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/extendhfsf2.c"
...
# 43 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fp_extend.h"
...
# 14 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/extendhfsf2.c" 2
...
__attribute__((__pcs__("aapcs"))) float __aeabi_h2f(uint16_t a) {
  return __extendhfsf2(a);
}
