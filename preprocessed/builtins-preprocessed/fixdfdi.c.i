# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfdi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfdi.c" 2
# 12 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfdi.c"
...
# 13 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfdi.c" 2
...
# 49 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixdfdi.c"
__attribute__((__pcs__("aapcs"))) di_int __aeabi_d2lz(fp_t a) {
  return __fixdfdi(a);
}
