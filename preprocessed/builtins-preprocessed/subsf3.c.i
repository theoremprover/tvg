# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subsf3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subsf3.c" 2
# 16 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subsf3.c"
...
# 17 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/subsf3.c" 2
...
__attribute__((__pcs__("aapcs"))) fp_t __aeabi_fsub(fp_t a, fp_t b) {
  return __subsf3(a, b);
}
