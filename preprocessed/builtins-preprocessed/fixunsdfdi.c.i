# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfdi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfdi.c" 2
# 12 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfdi.c"
...
# 13 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfdi.c" 2
...
# 46 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfdi.c"
__attribute__((__pcs__("aapcs"))) du_int __aeabi_d2ulz(fp_t a) {
