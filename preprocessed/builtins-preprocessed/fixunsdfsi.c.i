# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfsi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 369 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfsi.c" 2
# 12 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfsi.c"
...
# 13 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfsi.c" 2
typedef su_int fixuint_t;

# 1 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fp_fixuint_impl.inc" 1
# 17 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fp_fixuint_impl.inc"
static __inline fixuint_t __fixuint(fp_t a) {

    const rep_t aRep = toRep(a);
    const rep_t aAbs = aRep & ((1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) - 1U);
    const int sign = aRep & (1ULL << (52 + ((sizeof(rep_t)*8) - 52 - 1))) ? -1 : 1;
    const int exponent = (aAbs >> 52) - (((1 << ((sizeof(rep_t)*8) - 52 - 1)) - 1) >> 1);
    const rep_t significand = (aAbs & ((1ULL << 52) - 1U)) | (1ULL << 52);
...
# 15 "/arm-libs/library-src/llvm-project/compiler-rt/lib/builtins/fixunsdfsi.c" 2
...
__attribute__((__pcs__("aapcs"))) su_int __aeabi_d2uiz(fp_t a) {
