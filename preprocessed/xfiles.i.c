# 1 "/arm-libs/library-src/dinkum/source/./xfiles.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfiles.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfiles.c" 2



static unsigned char ebuf[80] = {0};
# 34 "/arm-libs/library-src/dinkum/source/./xfiles.c"
FILE _Stdin = {
 0x1, 0, 0,
...
FILE *_Files[20] = {&_Stdin, &_Stdout, &_Stderr};
...
char _PJP_C_Copyright[] =
 "V6.40:0009 -- "
 "Copyright (c) 1992-2014 by P.J. Plauger,"
