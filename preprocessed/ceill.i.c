# 1 "/arm-libs/library-src/dinkum/source/./ceill.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ceill.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./ceill.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxceil.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxceil.h" 2
...
long double (ceill)(long double x)
 ...
 return (_LDint(&y, 0) < 0 && 0.0L < x ? y + 1.0L : y);
 }
# 4 "/arm-libs/library-src/dinkum/source/./ceill.c" 2
