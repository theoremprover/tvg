# 1 "/arm-libs/library-src/dinkum/source/./xtouptab.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xtouptab.c" 2
...
int isblank(int);
# 3 "/arm-libs/library-src/dinkum/source/./xtouptab.c" 2
# 1 "/toolchain/arm/include/limits.h" 1 3
# 4 "/arm-libs/library-src/dinkum/source/./xtouptab.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xtouptab.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./xtouptab.c" 2
...
static const short toup_tab[257] = {(-1),
 ...
 _Ctype_t _Touptab = &toup_tab[1]; int (*_Tls_setup__Touptab)(void) = 0;

_Ctype_t (_Getptoupper)(void)
 {
 return (*((_Tls_setup__Touptab && _Tls_setup__Touptab()), (&(_Touptab))));
 }
