# 1 "/arm-libs/library-src/dinkum/source/./xfcosh.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfcosh.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfcosh.c" 2
...
static const float xbig = (float)(0.347 * (24 + 1));

float _FCosh(float x, float y)
 {
...
# 4 "/arm-libs/library-src/dinkum/source/./xfcosh.c" 2
