# 1 "/arm-libs/library-src/dinkum/source/./xfgpos.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfgpos.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./xfgpos.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xfgpos.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xfgpos.c" 2


int _Nnl(FILE *str, unsigned char *p1, unsigned char *p2)
 {
# 21 "/arm-libs/library-src/dinkum/source/./xfgpos.c"
...
long _Fgpos(FILE *str, fpos_t *ptr)
 ...
 if (!(str->_Mode & (0x1|0x2)) || loff == -1)
  return ((-1));

 if (str->_Mode & 0x2000)
  loff += _Nnl(str, str->_Buf, str->_Next);
 else if (str->_Mode & 0x1000)
  loff -=
   _Nnl(str, str->_Rback,
