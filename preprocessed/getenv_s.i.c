# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/getenv_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/getenv_s.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/getenv_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/getenv_s.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./c_ext1/getenv_s.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./c_ext1/getenv_s.c" 2


errno_t (getenv_s)(size_t * needed,
 ...
 if (needed != 0)
  *needed = 0;
 if (s == 0 || maxsize == 0 || ((_Sizet)(-1) >> 1) < maxsize || name == 0)
  return (_Fail_s("getenv_s: bad argument", sizeof ("getenv_s: bad argument")));
 ...
 if (penv != 0)
  ...
  if (needed != 0)
   *needed = strlen(penv);
  return (strncpy_s(s, maxsize, penv, maxsize));
  }
 else
  {
  s[0] = '\0';
