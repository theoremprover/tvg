# 1 "/arm-libs/library-src/dinkum/source/./xfopen.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfopen.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfopen.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xfopen.c" 2
# 111 "/arm-libs/library-src/dinkum/source/./xfopen.c"
int open(const char *, int, int);


signed char _Fopen(const char *path, unsigned int smode,
 int exclusive)
 {
 unsigned int acc;
 ...
 if (smode & 0x20)
  ...
  acc |= 0x4000;
 return ((signed char)open(path, acc,
  exclusive != 0 ? 0x0180 : 0x0180));
 }
