# 1 "/arm-libs/library-src/dinkum/source/./mbsrtowc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./mbsrtowc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./mbsrtowc.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./mbsrtowc.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./mbsrtowc.c" 2

static mbstate_t mbst = {0}; static int (*_Tls_setup_mbst)(void) = 0;
size_t (mbsrtowcs)(wchar_t * wcs, const char ** ps,
 ...
 for (; 0 < n; ++nwc, s += i, ++wcs, --n)
  {
  if ((i = _Mbtowc(wcs, s, 0x7fffffff, pst)) < 0)
   {
   nwc = (size_t)-1;
   break;
   }
