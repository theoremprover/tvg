# 1 "/arm-libs/library-src/dinkum/source/./vscanf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./vscanf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./vscanf.c" 2
...
int (vscanf)(const char * fmt, va_list ap)
 ...
 (void)0;
 ans = _Scanf(&scin, (& _Stdin), fmt, ap, 0);
 (void)0;
 return (ans);
 }
