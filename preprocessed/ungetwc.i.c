# 1 "/arm-libs/library-src/dinkum/source/./ungetwc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./ungetwc.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 3 "/arm-libs/library-src/dinkum/source/./ungetwc.c" 2
...
wint_t (ungetwc)(wint_t c, FILE *str)
 ...
 if (c == (( wint_t)(-1))
  ...
  || (str->_Mode & (0x1 | 0x2000 | 0x4000))
   != 0x1)
  c = (( wint_t)(-1));
 else
  {
  str->_Mode =
   (unsigned short)((str->_Mode & ~0x100) | (0x1000 | 0x8000));
  *--str->_WRback = c;
  }
 (void)0;
 return (c);
