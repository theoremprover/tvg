# 1 "/arm-libs/library-src/dinkum/source/./hypot.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./hypot.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./hypot.c" 2
...
double (hypot)(double x, double y)
 {
 int zexp;
 double z = _Hypot(x, y, &zexp);

 if (zexp != 0)
  switch (_Dscale(&z, zexp))
   {
  case 0:
   _Feraise(0x08);
   break;
...
# 4 "/arm-libs/library-src/dinkum/source/./hypot.c" 2
