# 1 "/arm-libs/library-src/dinkum/source/./xstoul.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xstoul.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xstoul.c" 2
...
int isblank(int);
# 4 "/arm-libs/library-src/dinkum/source/./xstoul.c" 2
# 1 "/toolchain/arm/include/errno.h" 1 3
# 490 "/toolchain/arm/include/errno.h" 3
extern int _Errno;
# 5 "/arm-libs/library-src/dinkum/source/./xstoul.c" 2
# 1 "/toolchain/arm/include/limits.h" 1 3
# 6 "/arm-libs/library-src/dinkum/source/./xstoul.c" 2
# 1 "/toolchain/arm/include/stddef.h" 1 3
# 41 "/toolchain/arm/include/stddef.h" 3
typedef _Ptrdifft ptrdiff_t;
# 7 "/arm-libs/library-src/dinkum/source/./xstoul.c" 2
...
# 8 "/arm-libs/library-src/dinkum/source/./xstoul.c" 2
...
# 9 "/arm-libs/library-src/dinkum/source/./xstoul.c" 2
# 20 "/arm-libs/library-src/dinkum/source/./xstoul.c"
static const char digits[] =
 "0123456789abcdefghijklmnopqrstuvwxyz";
# 31 "/arm-libs/library-src/dinkum/source/./xstoul.c"
