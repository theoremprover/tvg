# 1 "/arm-libs/library-src/dinkum/source/./asin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./asin.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./asin.c" 2
...
# 65 "/arm-libs/library-src/dinkum/source/./xxasin.h"
   ...
   return (_Atan(((x) / (sqrt((1.0 - x) * (1.0 + x)))), hex));


  else if (x <= 1.0)
   return (_Atan(((sqrt(1.0 - x) * sqrt(1.0 + x)) / (x)), hex ^ 0x2));
...
# 4 "/arm-libs/library-src/dinkum/source/./asin.c" 2
