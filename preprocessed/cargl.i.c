# 1 "/arm-libs/library-src/dinkum/source/./cargl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cargl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cargl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcarg.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcarg.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxcarg.h" 2


long double (cargl)(_Lcomplex x)
 {
 return (atan2l(cimagl(x), creall(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./cargl.c" 2
