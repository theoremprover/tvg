# 1 "/arm-libs/library-src/dinkum/source/./atanhl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./atanhl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./atanhl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxatanh.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxatanh.h" 2
...
long double (atanhl)(long double x)
 ...
 default:
  ...
  if (1.0L < x)
   ...
   {
   _Feraise(0x02);
   return (neg ? -_LInf._Long_double : _LInf._Long_double);
   }
  else if (-_LRteps._Long_double < x && x < _LRteps._Long_double)
   {
   if (neg)
    ((*_LPmsw(&(x))) ^= ((unsigned short)0x8000));
   return (x);
   ...
   {
   y = 0.5L * log1pl(2.0L * ((x) / ((1.0L - x))));

   return (neg ? -y : y);
   }
  }
 }
# 4 "/arm-libs/library-src/dinkum/source/./atanhl.c" 2
