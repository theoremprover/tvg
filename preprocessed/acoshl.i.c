# 1 "/arm-libs/library-src/dinkum/source/./acoshl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./acoshl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./acoshl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxacosh.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxacosh.h" 2
...
long double (acoshl)(long double x)
 ...
 default:
  if (x < 1.0L)
   ...
   return (0.0L);
# 38 "/arm-libs/library-src/dinkum/source/./xxacosh.h"
  else if (x < ((2.0L) / (_LEps._Long_double)))
   {
   long double z = x - 1.0L;

   return (log1pl(z + sqrtl(z * x + z)));
   }
  else
   return (logl(x) + ln2);
  }
 }
# 4 "/arm-libs/library-src/dinkum/source/./acoshl.c" 2
