# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/snprintf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/snprintf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/snprintf_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/snprintf_s.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./c_ext1/snprintf_s.c" 2
...
int (snprintf_s)(char * s, rsize_t size,
 const char * fmt, ...)
 {
 int ans;
 _Snpstuff x;
 ...
 if (s == 0 || size == 0 || ((_Sizet)(-1) >> 1) < size || fmt == 0)
  return (_Fail_s("snprintf_s: bad argument", sizeof ("snprintf_s: bad argument")), (-1));
