# 1 "/arm-libs/library-src/dinkum/source/./strxfrm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./strxfrm.c" 2
...
# 6 "/toolchain/arm/include/xstrxfrm.h" 2 3
...
# 3 "/arm-libs/library-src/dinkum/source/./strxfrm.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./strxfrm.c" 2
...
size_t (strxfrm)(char * s1, const char * s2,
 size_t n)
 {
 return (_Strxfrmx(s1, s2, n, ((_Tls_setup__Costate && _Tls_setup__Costate()), (&(_Costate)))));
 }
