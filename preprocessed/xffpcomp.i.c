# 1 "/arm-libs/library-src/dinkum/source/./xffpcomp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xffpcomp.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xffpcomp.c" 2
...
int _FFpcomp(float x, float y)
 {
 if (_FDtest(&x) == 2 || _FDtest(&y) == 2)
  return (0);
 else if (x < y)
  return (1);
 else if (y < x)
...
# 4 "/arm-libs/library-src/dinkum/source/./xffpcomp.c" 2
