# 1 "/arm-libs/library-src/dinkum/source/./cacos.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cacos.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cacos.c" 2
...
_Dcomplex (cacos)(_Dcomplex x)
 ...
 if (errx == 2)
  ...
  {
  const _Dcomplex w = csqrt(_Cbuild(1.0 + re, -im));
  const _Dcomplex z = csqrt(_Cbuild(1.0 - re, -im));
...
# 4 "/arm-libs/library-src/dinkum/source/./cacos.c" 2
