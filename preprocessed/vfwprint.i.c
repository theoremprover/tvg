# 1 "/arm-libs/library-src/dinkum/source/./vfwprint.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./vfwprint.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 3 "/arm-libs/library-src/dinkum/source/./vfwprint.c" 2
...
int (vfwprintf)(FILE * str, const wchar_t * fmt,
 va_list ap)
 {
 int ans;

 (void)0;
 ans = _WPrintf(&prout, str, fmt, ap, 0);
 (void)0;
 return (ans);
 }
