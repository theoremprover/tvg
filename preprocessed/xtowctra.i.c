# 1 "/arm-libs/library-src/dinkum/source/./xtowctra.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xtowctra.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xtowctra.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xtowctra.c" 2
...
wint_t _Towctrans(wint_t wc, wctrans_t off)
 {
 _PWctab pwctrans = *((_Tls_setup__Wctrans && _Tls_setup__Wctrans()), (&(_Wctrans)));
 const wchar_t *p =
