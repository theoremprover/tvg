# 1 "/arm-libs/library-src/dinkum/source/./cbrtl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cbrtl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cbrtl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcbrt.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcbrt.h" 2
...
long double (cbrtl)(long double x)
 ...
 default:
  ...
  y = ((((0.24379L * x + 0.95807L) * x + 0.07892L)) / ((x + 0.27962L)));

  y = 0.5L * (y + ((1.5L * x) / ((y * y + ((0.5L * x) / (y))))));
  ...
  y = 0.5L * (y + ((1.5L * x) / ((y * y + 0.5L * ((x) / (y))))));
# 51 "/arm-libs/library-src/dinkum/source/./xxcbrt.h"
  if (fix)
...
# 4 "/arm-libs/library-src/dinkum/source/./cbrtl.c" 2
