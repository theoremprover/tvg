# 1 "/arm-libs/library-src/dinkum/source/./xldclass.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xldclass.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xldclass.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxxdclass.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxxdclass.h" 2


int _LDclass(long double x)
 {
 return (_LDtest(&x));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xldclass.c" 2
