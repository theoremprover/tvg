# 1 "/arm-libs/library-src/dinkum/source/./casinf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./casinf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./casinf.c" 2
...
_Fcomplex (casinf)(_Fcomplex x)
 {
 x = casinhf(_FCbuild(-cimagf(x), crealf(x)));

 return (_FCbuild(cimagf(x), -crealf(x)));
 }
# 4 "/arm-libs/library-src/dinkum/source/./casinf.c" 2
