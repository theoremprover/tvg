# 1 "/arm-libs/library-src/dinkum/source/./atanl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./atanl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./atanl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxatan.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxatan.h" 2


long double (atanl)(long double x)
 {
 unsigned short hex;
 static const long double piby2 = 1.5707963267948966192313216916397515L;
 ...
 case 1:
  return (((*_LPmsw(&(x))) & ((unsigned short)0x8000)) ? -piby2 : piby2);
...
# 4 "/arm-libs/library-src/dinkum/source/./atanl.c" 2
