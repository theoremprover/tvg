# 1 "/arm-libs/library-src/dinkum/source/./wcsxfrm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./wcsxfrm.c" 2
...
# 6 "/toolchain/arm/include/xstate.h" 2 3
...
size_t _CWcsxfrm(wchar_t *, const wchar_t **, size_t,
 mbstate_t *, _Statab *);
# 3 "/arm-libs/library-src/dinkum/source/./wcsxfrm.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./wcsxfrm.c" 2
...
size_t (wcsxfrm)(wchar_t * s1, const wchar_t * s2,
 size_t n)
 {
 return (_Wcsxfrmx(s1, s2, n, ((_Tls_setup__WCostate && _Tls_setup__WCostate()), (&(_WCostate)))));
 }
