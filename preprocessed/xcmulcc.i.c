# 1 "/arm-libs/library-src/dinkum/source/./xcmulcc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xcmulcc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xcmulcc.c" 2
...
_Dcomplex (_Cmulcc)(_Dcomplex x, _Dcomplex y)
 ...
 return (_Cbuild(xre * yre - xim * yim,
  xre * yim + xim * yre));
 }
# 4 "/arm-libs/library-src/dinkum/source/./xcmulcc.c" 2
