# 1 "/arm-libs/library-src/dinkum/source/./modf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./modf.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./modf.c" 2
 ...
 *pint = x;
 ...
 case 1:
 case 0:
  return (((*_Pmsw(&(x))) & ((unsigned short)0x8000)) ? -_Zero : 0.0);
...
# 4 "/arm-libs/library-src/dinkum/source/./modf.c" 2
