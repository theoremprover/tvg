# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vfprintf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/vfprintf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/vfprintf_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/vfprintf_s.c" 2
...
int (vfprintf_s)(FILE * str, const char * fmt,
 va_list ap)
 {
 int ans;

 if (str == 0 || fmt == 0)
  return (_Fail_s("vfprintf_s: bad argument", sizeof ("vfprintf_s: bad argument")), (-1));

 (void)0;
 ans = _Printf(&prout, str, fmt, ap, 1);
 (void)0;
 return (ans);
 }
