# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/wprintf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/wprintf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/wprintf_s.c" 2
...
int _WScanf(wint_t (*)(void *, wint_t, int),
 void *, const wchar_t *, va_list, int);
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/wprintf_s.c" 2
...
int (wprintf_s)(const wchar_t * fmt, ...)
 ...
 if (fmt == 0)
  return (_Fail_s("wprintf_s: bad argument", sizeof ("wprintf_s: bad argument")), (-1));
