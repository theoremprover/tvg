# 1 "/arm-libs/library-src/dinkum/source/./xcbuild.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xcbuild.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xcbuild.c" 2
...
_Dcomplex (_Cbuild)(double re, double im)
 {
 double ans[2];
...
# 4 "/arm-libs/library-src/dinkum/source/./xcbuild.c" 2
