# 1 "/arm-libs/library-src/dinkum/source/./cimagl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./cimagl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./cimagl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxcimag.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxcimag.h" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xxcimag.h" 2


long double (cimagl)(_Lcomplex x)
 {
 return (((long double *)&x)[1]);
 }
# 4 "/arm-libs/library-src/dinkum/source/./cimagl.c" 2
