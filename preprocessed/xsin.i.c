# 1 "/arm-libs/library-src/dinkum/source/./xsin.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xsin.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xsin.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xsin.c" 2
...
unsigned int _Quad(double *px, int quads);
...
# 6 "/arm-libs/library-src/dinkum/source/./xsin.c" 2
