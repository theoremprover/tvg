# 1 "/arm-libs/library-src/dinkum/source/./acos.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./acos.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./acos.c" 2
...
# 58 "/arm-libs/library-src/dinkum/source/./xxacos.h"
   ...
   return (_Atan(((sqrt((1.0 - x) * (1.0 + x))) / (x)), hex ^ 0x2));
...
# 4 "/arm-libs/library-src/dinkum/source/./acos.c" 2
