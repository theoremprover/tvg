# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/sscanf_s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./c_ext1/sscanf_s.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./c_ext1/sscanf_s.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./c_ext1/sscanf_s.c" 2
...
int (sscanf_s)(const char * buf,
 ...
 if (buf == 0 || fmt == 0)
  return (_Fail_s("sscanf_s: bad argument", sizeof ("sscanf_s: bad argument")), (-1));

 __builtin_va_start(ap, fmt);
 ans = _Scanf(&scin, (void **)&buf, fmt, ap, 1);
 __builtin_va_end(ap);
 return (ans);
 }
