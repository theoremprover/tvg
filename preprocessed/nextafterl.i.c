# 1 "/arm-libs/library-src/dinkum/source/./nextafterl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./nextafterl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./nextafterl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxnextafter.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxnextafter.h" 2


long double (nextafterl)(long double x, long double y)
 {
 return (nexttowardl(x, (long double)y));
 }
# 4 "/arm-libs/library-src/dinkum/source/./nextafterl.c" 2
