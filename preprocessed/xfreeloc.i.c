# 1 "/arm-libs/library-src/dinkum/source/./xfreeloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfreeloc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xfreeloc.c" 2
...
void _Freeloc(_Linfo *p)
 ...
 for (q = _Loctab; q->_Name; ++q)
  ...
  case L_STATE:
   ...
   int i;
   unsigned short **pt
    = &(*(unsigned short * *)((char *)p + q->_Offset));
   ...
   break;
  case L_TABLE:
   if (((*(short * *)((char *)p + q->_Offset)) != (*(short * *)((char *)&_Clocale + q->_Offset))))
    free((*(short * *)((char *)p + q->_Offset)) - 1);
   break;
  case L_GSTRING:
  case L_NAME:
  case L_STRING:
   ...
   break;
  case L_WCTYPE:
   if (((*(_Wctab * *)((char *)p + q->_Offset)) != (*(_Wctab * *)((char *)&_Clocale + q->_Offset))))
    {
    int i;
    _Wctab *po = (*(_Wctab * *)((char *)p + q->_Offset));
    _Wctab *pc = (*(_Wctab * *)((char *)&_Clocale + q->_Offset));
