# 1 "/arm-libs/library-src/dinkum/source/./xstate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xstate.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./xstate.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xstate.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xstate.c" 2
# 55 "/arm-libs/library-src/dinkum/source/./xstate.c"
 char _Mbcurmax = 4294967295U <= 0xff ? 1 : 4294967295U <= 0xffff ? 3 : 6; int (*_Tls_setup__Mbcurmax)(void) = 0;


 _Statab _Mbstate = {{0}}; int (*_Tls_setup__Mbstate)(void) = 0;

size_t _Getmbcurmax()
 {
 return (*((_Tls_setup__Mbcurmax && _Tls_setup__Mbcurmax()), (&(_Mbcurmax))));
 }

_Statab *_Getpmbstate()
 {
 return (((_Tls_setup__Mbstate && _Tls_setup__Mbstate()), (&(_Mbstate))));
 }
