# 1 "/arm-libs/library-src/dinkum/source/./fmodl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fmodl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fmodl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxfmod.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxfmod.h" 2
...
long double (fmodl)(long double x, long double y)
 ...
 if (0 <= errx || 0 <= erry)
  ...
  if (x < 0.0L)
   ...
   neg = 0;
  for (t = y, _LDunscale(&ychar, &t), n = 0; ; )
   {
   short xchar;
...
# 4 "/arm-libs/library-src/dinkum/source/./fmodl.c" 2
