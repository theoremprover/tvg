# 1 "/arm-libs/library-src/dinkum/source/./asinhl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./asinhl.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./asinhl.c" 2
# 1 "/arm-libs/library-src/dinkum/source/./xxasinh.h" 1
...
# 3 "/arm-libs/library-src/dinkum/source/./xxasinh.h" 2
...
long double (asinhl)(long double x)
 ...
 default:
  ...
  if (x < _LEps._Long_double)
   y = x;
  else if (x < ((2.0L) / (_LEps._Long_double)))
   y = log1pl(x
    + x * ((x) / ((1.0L + sqrtl(x * x + 1.0L)))));
  else
   y = logl(x) + ln2;
...
# 4 "/arm-libs/library-src/dinkum/source/./asinhl.c" 2
