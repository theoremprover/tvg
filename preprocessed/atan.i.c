# 1 "/arm-libs/library-src/dinkum/source/./atan.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./atan.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./atan.c" 2
...
double (atan)(double x)
 {
 unsigned short hex;
 static const double piby2 = 1.5707963267948966192313216916397515;
 ...
 case 1:
  return (((*_Pmsw(&(x))) & ((unsigned short)0x8000)) ? -piby2 : piby2);
...
# 4 "/arm-libs/library-src/dinkum/source/./atan.c" 2
