# 1 "/arm-libs/library-src/dinkum/source/./lrint.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./lrint.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./lrint.c" 2
...
long (lrint)(double x)
 ...
 default:
  ...
  if ((double)(-0x7fffffffL - 1) <= y && y <= (double)0x7fffffffL)
   return ((long)y);
...
# 4 "/arm-libs/library-src/dinkum/source/./lrint.c" 2
