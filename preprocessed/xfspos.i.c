# 1 "/arm-libs/library-src/dinkum/source/./xfspos.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./xfspos.c" 2
...
typedef int errno_t;
# 3 "/arm-libs/library-src/dinkum/source/./xfspos.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./xfspos.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./xfspos.c" 2
...
int _Fspos(FILE *str, const fpos_t *ptr, long loff, int way)
 {
 if (!(str->_Mode & (0x1 | 0x2)) || fflush(str))
  return ((-1));
 else if (way != 1 && way != 2 && way != 0)
  {
  ( _Errno) = 0x0016;
  return ((-1));
  }
