# 1 "/arm-libs/library-src/dinkum/source/./calloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./calloc.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./calloc.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./calloc.c" 2


void *(calloc)(size_t nelem, size_t size)
 {
 if (0 < nelem && (size_t)(-1) / nelem < size)
  return (0);
 else
  {
