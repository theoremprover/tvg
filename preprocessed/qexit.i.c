# 1 "/arm-libs/library-src/dinkum/source/./qexit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./qexit.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./qexit.c" 2
...
# 4 "/arm-libs/library-src/dinkum/source/./qexit.c" 2
...
# 5 "/arm-libs/library-src/dinkum/source/./qexit.c" 2
...
# 6 "/arm-libs/library-src/dinkum/source/./qexit.c" 2
...
static void (*_Atdata[64])(void) = {0};
static size_t _Nats = {64};
static Ppvoidfn _Atfuns = {&_Atdata[0]};
static size_t _Atcount = {64};
static size_t _Atcount0 = {0};
void _Exit(int) __attribute__((__noreturn__));

static int _Atrealloc(void)
 {
 size_t inc = _Nats / 2;
...
void (_Atqexit)(void (*func)(void))
 {
 if (_Atcount <= _Atcount0 && _Atrealloc() == 0)
  abort();
 else
  _Atfuns[_Atcount0++] = func;
 }
