# 1 "/arm-libs/library-src/dinkum/source/./fesetexceptflag.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 366 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/arm-libs/library-src/dinkum/source/./fesetexceptflag.c" 2
...
# 3 "/arm-libs/library-src/dinkum/source/./fesetexceptflag.c" 2
# 27 "/arm-libs/library-src/dinkum/source/./fesetexceptflag.c"
int (fesetexceptflag)(const fexcept_t *pflags, int except)
 {
 if ((except &= (0x02 | 0x10 | 0x01 | 0x04 | 0x08)) != 0)
  {
  fexcept_t mask = *pflags & except;
# 45 "/arm-libs/library-src/dinkum/source/./fesetexceptflag.c"
  fenv_t env;
  ...
  env |= mask << 0;
  fesetenv(&env);
# 59 "/arm-libs/library-src/dinkum/source/./fesetexceptflag.c"
  }
 return (0);
 }
