...
# 54 "dl-close.c"
                            )
 {
   ...
   ((void) sizeof ((! should_be_there) ? 1 : 0), __extension__ ({ if (! should_be_there) ; else __assert_fail ("! should_be_there", "dl-close.c", 59, __extension__ __PRETTY_FUNCTION__); }));
 }
      else
 {
...
# 65 "dl-close.c"
   ...
   idx = disp + listp->len;
  ...
  else
    {
      ...
      if (__builtin_expect ((old_map != 
# 78 "dl-close.c" 3 4
         ((void *)0)
# 78 "dl-close.c"
         ), 1))
 {
   ((void) sizeof ((old_map->l_tls_modid == idx) ? 1 : 0), __extension__ ({ if (old_map->l_tls_modid == idx) ; else __assert_fail ("old_map->l_tls_modid == idx", "dl-close.c", 80, __extension__ __PRETTY_FUNCTION__); }));


   listp->slotinfo[idx - disp].gen = _rtld_local._dl_tls_generation + 1;
   listp->slotinfo[idx - disp].map = 
# 84 "dl-close.c" 3 4
                                    ((void *)0)
# 84 "dl-close.c"
                                        ;
      ...
      if (idx != _rtld_local._dl_tls_max_dtv_idx)
 return 
# 90 "dl-close.c" 3 4
       1
# 90 "dl-close.c"
  ...
  while (idx - disp > (disp == 0 ? 1 + _rtld_local._dl_tls_static_nelem : 0))
    {
      --idx;

      if (listp->slotinfo[idx - disp].map != 
# 97 "dl-close.c" 3 4
                                            ((void *)0)
# 97 "dl-close.c"
                                                )
 {
   ...
   _rtld_local._dl_tls_max_dtv_idx = idx;
   return 
# 101 "dl-close.c" 3 4
         1
# 101 "dl-close.c"
                                            ...
                                            force)
{
 ...
 _dl_debug_printf ("\nclosing file=%s; direct_opencount=%u\n",
  ...
  struct link_namespaces *ns = &_rtld_local._dl_ns[nsid];
...
# 141 "dl-close.c"
  ...
  int idx = 0;
  for (struct link_map *l = ns->_ns_loaded; l != 
# 158 "dl-close.c" 3 4
                                                ((void *)0)
# 158 "dl-close.c"
                                                    ; l = l->l_next)
  ...
  ((void) sizeof ((idx == nloaded) ? 1 : 0), __extension__ ({ if (idx == nloaded) ; else __assert_fail ("idx == nloaded", "dl-close.c", 165, __extension__ __PRETTY_FUNCTION__); }));
 ...
 continue;
   ...
   && (l->l_flags_1 & 0x00000008) == 0


   && ({ if ((sizeof (*(&l->l_tls_dtor_count)) != 1) && (sizeof (*(&l->l_tls_dtor_count)) != 2) && (sizeof (*(&l->l_tls_dtor_count)) != 4) && (sizeof (*(&l->l_tls_dtor_count)) != 8)) __atomic_link_error ();; __atomic_load_n ((&l->l_tls_dtor_count), 2); }) == 0
   && !used[done_index])
 continue;
...
# 203 "dl-close.c"
                    )
     {
       if ((*lp)->l_idx != -1)
  {
    ((void) sizeof (((*lp)->l_idx >= 0 && (*lp)->l_idx < nloaded) ? 1 : 0), __extension__ ({ if ((*lp)->l_idx >= 0 && (*lp)->l_idx < nloaded) ; else __assert_fail ("(*lp)->l_idx >= 0 && (*lp)->l_idx < nloaded", "dl-close.c", 207, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (unsigned int j = 0; j < l->l_reldeps->act; ++j)
   {
     ...
     if (jmap->l_idx != -1)
       {
  ((void) sizeof ((jmap->l_idx >= 0 && jmap->l_idx < nloaded) ? 1 : 0), __extension__ ({ if (jmap->l_idx >= 0 && jmap->l_idx < nloaded) ; else __assert_fail ("jmap->l_idx >= 0 && jmap->l_idx < nloaded", "dl-close.c", 232, __extension__ __PRETTY_FUNCTION__); }));
  ...
  _dl_sort_maps (maps + (nsid == 0), nloaded - (nsid == 0),
   used + (nsid == 0), 
# 247 "dl-close.c" 3 4
                               1
# 247 "dl-close.c"
...
# 251 "dl-close.c" 3 4
 _Bool 
# 251 "dl-close.c"
      do_audit = _rtld_local_ro._dl_naudit > 0 && !ns->_ns_loaded->l_auditing;
  ...
  for (unsigned int i = 0; i < nloaded; ++i)
    {
      ...
      ((void) sizeof ((imap->l_ns == nsid) ? 1 : 0), __extension__ ({ if (imap->l_ns == nsid) ; else __assert_fail ("imap->l_ns == nsid", "dl-close.c", 262, __extension__ __PRETTY_FUNCTION__); }));

      if (!used[i])
 {
   ((void) sizeof ((imap->l_type == lt_loaded && (imap->l_flags_1 & 0x00000008) == 0) ? 1 : 0), __extension__ ({ if (imap->l_type == lt_loaded && (imap->l_flags_1 & 0x00000008) == 0) ; else __assert_fail ("imap->l_type == lt_loaded && (imap->l_flags_1 & DF_1_NODELETE) == 0",
                                             "dl-close.c"
# 266 "dl-close.c"
   ,
                                             267
   ...
   if (imap->l_init_called)
     {
       ...
       if (__builtin_expect (_rtld_local_ro._dl_debug_mask & (1 << 1),
        0))
  _dl_debug_printf ("\ncalling fini: %s [%lu]\n\n",
      imap->l_name, nsid);
...
# 279 "dl-close.c"
  ...
  {
    Elf64_Addr *array =
      (Elf64_Addr *) (imap->l_addr
        + imap->l_info[26]->d_un.d_ptr);
    unsigned int sz = (imap->l_info[28]->d_un.d_val
         / sizeof (Elf64_Addr));
...
# 292 "dl-close.c"
  ...
  ((fini_t) (((void *) imap->l_addr + imap->l_info[13]->d_un.d_ptr))) ()
                                         ;
     }
...
# 317 "dl-close.c"
 ...
 {
   struct r_scope_elem *new_list = 
# 329 "dl-close.c" 3 4
                                  ((void *)0)
# 329 "dl-close.c"
                                      ;

   if (imap->l_searchlist.r_list == 
# 331 "dl-close.c" 3 4
                                   ((void *)0) 
# 331 "dl-close.c"
                                        && imap->l_initfini != 
...
# 355 "dl-close.c"
                          ;
   for (size_t cnt = 0; imap->l_scope[cnt] != 
# 356 "dl-close.c" 3 4
                                             ((void *)0)
# 356 "dl-close.c"
                                                 ; ++cnt)
...
# 364 "dl-close.c"
  ...
  ((void) sizeof ((tmap->l_ns == nsid) ? 1 : 0), __extension__ ({ if (tmap->l_ns == nsid) ; else __assert_fail ("tmap->l_ns == nsid", "dl-close.c", 365, __extension__ __PRETTY_FUNCTION__); }));
  if (tmap->l_idx == -1)
    ++remain;
  else
    removed_any = 
...
# 369 "dl-close.c"
   ...
   if (removed_any)
    ...
    && remain < (sizeof (imap->l_scope_mem) / sizeof (imap->l_scope_mem[0])))
  {
...
# 520 "dl-close.c"
      ...
      && (unload_global
   || scope_mem_left
   || (_rtld_local._dl_scope_free_list != 
# 523 "dl-close.c" 3 4
                                ((void *)0)
       
# 524 "dl-close.c"
      && _rtld_local._dl_scope_free_list->count)))
    {
      _rtld_local._dl_wait_lookup_done ();


      struct dl_scope_free_list *fsl = _rtld_local._dl_scope_free_list;
      if (fsl != 
# 530 "dl-close.c" 3 4
                ((void *)0)
# 530 "dl-close.c"
 ...
 while (fsl->count > 0)
  ...
  size_t tls_free_end;
  tls_free_start = tls_free_end = 0;


  _rtld_local._dl_rtld_lock_recursive (&(_rtld_local._dl_load_write_lock).mutex);
  ...
  for (unsigned int i = first_loaded; i < nloaded; ++i)
    {
      ...
      if (!used[i])
 {
   ((void) sizeof ((imap->l_type == lt_loaded) ? 1 : 0), __extension__ ({ if (imap->l_type == lt_loaded) ; else __assert_fail ("imap->l_type == lt_loaded", "dl-close.c", 549, __extension__ __PRETTY_FUNCTION__); }));
...
# 557 "dl-close.c"
       ...
       if (_rtld_local._dl_tls_dtv_slotinfo_list != 
# 559 "dl-close.c" 3 4
                                          ((void *)0)
    
# 560 "dl-close.c"
   && ! remove_slotinfo (imap->l_tls_modid,
     _rtld_local._dl_tls_dtv_slotinfo_list, 0,
     imap->l_init_called))

  _rtld_local._dl_tls_max_dtv_idx = _rtld_local._dl_tls_static_nelem;
    ...
    && imap->l_tls_offset != -1)
  {
   ...
   tls_free_end = imap->l_tls_offset;
    ...
    else
      {
        ...
        if (tls_free_end == _rtld_local._dl_tls_static_used)
   {
     _rtld_local._dl_tls_static_used = tls_free_start;
     tls_free_end = imap->l_tls_offset;
     tls_free_start
       = tls_free_end - imap->l_tls_blocksize;
   }
        else if ((size_t) imap->l_tls_offset
          == _rtld_local._dl_tls_static_used)
   _rtld_local._dl_tls_static_used
     = imap->l_tls_offset - imap->l_tls_blocksize;
...
# 692 "dl-close.c"
     ...
     {
       ((void) sizeof ((nsid != 0) ? 1 : 0), __extension__ ({ if (nsid != 0) ; else __assert_fail ("nsid != LM_ID_BASE", "dl-close.c", 694, __extension__ __PRETTY_FUNCTION__); }));
...
# 732 "dl-close.c"
  ...
  _rtld_local._dl_rtld_unlock_recursive (&(_rtld_local._dl_load_write_lock).mutex);


  if (any_tls)
    {
      if (__builtin_expect ((++_rtld_local._dl_tls_generation == 0), 0))
 do { _dl_dprintf (2, "TLS generation counter wrapped!  Please report as described in ""<http://www.gnu.org/software/libc/bugs.html>"".\n"); _exit (127); } while (1);
...
# 776 "dl-close.c"
  ...
  if (__builtin_expect (ns->_ns_loaded == 
# 785 "dl-close.c" 3 4
                                         ((void *)0)
# 785 "dl-close.c"
                                             , 0)
      && nsid == _rtld_local._dl_nns - 1)
    do
      --_rtld_local._dl_nns;
    while (_rtld_local._dl_ns[_rtld_local._dl_nns - 1]._ns_loaded == 
# 789 "dl-close.c" 3 4
                                                  ((void *)0)
# 789 "dl-close.c"
                                                      );
...
_dl_close (void *_map)
{
  ...
  if (__builtin_expect ((map->l_flags_1 & 0x00000008), 0))
    {
