...
# 49 "../include/atomic.h" 2

# 1 "../sysdeps/x86_64/atomic-machine.h" 1
# 23 "../sysdeps/x86_64/atomic-machine.h"
...
# 24 "../sysdeps/x86_64/atomic-machine.h" 2
...
# 24 "../sysdeps/nptl/internaltypes.h"
# 1 "../include/endian.h" 1
...
# 30 "dl-deps.c" 2
# 1 "../include/scratch_buffer.h" 1
# 61 "../include/scratch_buffer.h"
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/recipe-sysroot-native/usr/lib/x86_64-poky-linux/gcc/x86_64-poky-linux/8.3.0/include/stddef.h" 1 3 4
# 62 "../include/scratch_buffer.h" 2
...
# 94 "../include/scratch_buffer.h" 3 4
_Bool 
# 94 "../include/scratch_buffer.h"
    __libc_scratch_buffer_grow (struct scratch_buffer *buffer);



static __inline __attribute__ ((__always_inline__)) 
# 98 "../include/scratch_buffer.h" 3 4
                      _Bool

# 99 "../include/scratch_buffer.h"
scratch_buffer_grow (struct scratch_buffer *buffer)
{
  return __builtin_expect ((__libc_scratch_buffer_grow (buffer)), 1);
}




# 106 "../include/scratch_buffer.h" 3 4
_Bool 
# 106 "../include/scratch_buffer.h"
    __libc_scratch_buffer_grow_preserve (struct scratch_buffer *buffer);



static __inline __attribute__ ((__always_inline__)) 
# 110 "../include/scratch_buffer.h" 3 4
                      _Bool

# 111 "../include/scratch_buffer.h"
scratch_buffer_grow_preserve (struct scratch_buffer *buffer)
{
  return __builtin_expect ((__libc_scratch_buffer_grow_preserve (buffer)), 1);
}
...
# 122 "../include/scratch_buffer.h" 3 4
_Bool 
# 122 "../include/scratch_buffer.h"
...
static __inline __attribute__ ((__always_inline__)) 
# 127 "../include/scratch_buffer.h" 3 4
                      _Bool

# 128 "../include/scratch_buffer.h"
scratch_buffer_set_array_size (struct scratch_buffer *buffer,
          size_t nelem, size_t size)
{
  return __builtin_expect ((__libc_scratch_buffer_set_array_size (buffer, nelem, size)), 1)
                          ;
}
# 31 "dl-deps.c" 2
...
{
  struct list *known = __builtin_alloca (sizeof *known * (1 + npreloads + 1));
...
# 225 "dl-deps.c"
   ...
   needed = needed_space.data;
      ...
      if (l->l_info[1] || l->l_info[(35 + 0 + 16 + ((Elf32_Word)-((Elf32_Sword) (0x7ffffffd) <<1>>1)-1))] || l->l_info[(35 + 0 + 16 + ((Elf32_Word)-((Elf32_Sword) (0x7fffffff) <<1>>1)-1))])
 {
  ...
  name = ({ const char *__str = (strtab + d->d_un.d_val); const char *__result = __str; size_t __dst_cnt = _dl_dst_count (__str); if (__dst_cnt != 0) { char *__newp; if (__libc_enable_secure) _dl_signal_error (0, __str, 
# 250 "dl-deps.c" 3 4
        ((void *)0)
# 250 "dl-deps.c"
        , "DST not allowed in SUID/SGID programs"); __newp = (char *) __builtin_alloca (({ size_t __len = (strlen (__str)); size_t __cnt = (__dst_cnt); if (__cnt > 0) { size_t dst_len; if ((l)->l_origin == 
# 250 "dl-deps.c" 3 4
        ((void *)0)
# 250 "dl-deps.c"
        ) { ((void) sizeof (((l)->l_name[0] == '\0' || (l) == &_rtld_local._dl_rtld_map) ? 1 : 0), __extension__ ({ if ((l)->l_name[0] == '\0' || (l) == &_rtld_local._dl_rtld_map) ; else __assert_fail ("(l)->l_name[0] == '\\0' || IS_RTLD (l)", "dl-deps.c", 250, __extension__ __PRETTY_FUNCTION__); })); (l)->l_origin = _dl_get_origin (); dst_len = ((l)->l_origin && (l)->l_origin != (char *) -1 ? strlen ((l)->l_origin) : 0); } else dst_len = (l)->l_origin == (char *) -1 ? 0 : strlen ((l)->l_origin); dst_len = ((((((dst_len)>(_rtld_local_ro._dl_platformlen))?(dst_len):(_rtld_local_ro._dl_platformlen)))>(strlen ("lib")))?((((dst_len)>(_rtld_local_ro._dl_platformlen))?(dst_len):(_rtld_local_ro._dl_platformlen))):(strlen ("lib"))); if (dst_len > 4) __len += __cnt * (dst_len - 4); } __len; })); __result = _dl_dst_substitute (l, __str, __newp); if (*__result == '\0') { if (0) _dl_signal_error (0, __str, 
# 250 "dl-deps.c" 3 4
        ((void *)0)
# 250 "dl-deps.c"
        , "empty dynamic string token substitution"); else { if (__builtin_expect ((_rtld_local_ro._dl_debug_mask & (1 << 0)), 0)) _dl_debug_printf ("cannot load auxiliary `%s' because of empty dynamic string token " "substitution\n", __str); continue; } } } __result; });
  ...
  if (! dep->l_reserved)
    {
      ...
      newp = __builtin_alloca (sizeof (struct list));
...
# 285 "dl-deps.c"
    ...
    needed[nneeded++] = dep;
     ...
     else if (d->d_tag == 0x7ffffffd || d->d_tag == 0x7fffffff)
       {
  struct list *newp;
...
# 293 "dl-deps.c" 3 4
        ((void *)0)
# 293 "dl-deps.c"
        ) { ((void) sizeof (((l)->l_name[0] == '\0' || (l) == &_rtld_local._dl_rtld_map) ? 1 : 0), __extension__ ({ if ((l)->l_name[0] == '\0' || (l) == &_rtld_local._dl_rtld_map) ; else __assert_fail ("(l)->l_name[0] == '\\0' || IS_RTLD (l)", "dl-deps.c", 294, __extension__ __PRETTY_FUNCTION__); })); (l)->l_origin = _dl_get_origin (); dst_len = ((l)->l_origin && (l)->l_origin != (char *) -1 ? strlen ((l)->l_origin) : 0); } else dst_len = (l)->l_origin == (char *) -1 ? 0 : strlen ((l)->l_origin); dst_len = ((((((dst_len)>(_rtld_local_ro._dl_platformlen))?(dst_len):(_rtld_local_ro._dl_platformlen)))>(strlen ("lib")))?((((dst_len)>(_rtld_local_ro._dl_platformlen))?(dst_len):(_rtld_local_ro._dl_platformlen))):(strlen ("lib"))); if (dst_len > 4) __len += __cnt * (dst_len - 4); } __len; })); __result = _dl_dst_substitute (l, __str, __newp); if (*__result == '\0') { if (d->d_tag == 0x7ffffffd) _dl_signal_error (0, __str, 
# 293 "dl-deps.c" 3 4
        ((void *)0)
# 293 "dl-deps.c"
        , "empty dynamic string token substitution"); else { if (__builtin_expect ((_rtld_local_ro._dl_debug_mask & (1 << 0)), 0)) _dl_debug_printf ("cannot load auxiliary `%s' because of empty dynamic string token " "substitution\n", __str); continue; } } } __result; })
  ...
  if (__builtin_expect (_rtld_local_ro._dl_debug_mask & (1 << 0),
          0))
    _dl_debug_printf ("load auxiliary object=%s"
        " requested by file=%s\n",
        name,
        ((l->l_name)[0] ? (l->l_name) : (_dl_argv[0] ?: "<main program>")));
...
# 464 "dl-deps.c"
 ...
 out:
  ...
  if (rtld_errno == 0 && errno_saved != 0)
    (rtld_errno = (errno_saved));

  struct link_map **old_l_initfini = 
# 473 "dl-deps.c" 3 4
                                    ((void *)0)
# 473 "dl-deps.c"
                                        ;
...
# 474 "dl-deps.c"
                             && map->l_type == lt_loaded)
    {
      ...
      ((void) sizeof ((map->l_searchlist.r_list == 
# 478 "dl-deps.c" 3 4
     ((void *)0)
# 478 "dl-deps.c"
     ) ? 1 : 0), __extension__ ({ if (map->l_searchlist.r_list == 
# 478 "dl-deps.c" 3 4
     ((void *)0)
# 478 "dl-deps.c"
     ) ; else __assert_fail ("map->l_searchlist.r_list == NULL", "dl-deps.c", 478, __extension__ __PRETTY_FUNCTION__); }));
...
# 488 "dl-deps.c"
 ...
 map->l_searchlist.r_list[nlist++] = runp->map;
  ...
  if (__builtin_expect (_rtld_local_ro._dl_debug_mask & (1 << 11), 0) != 0
      && map == _rtld_local._dl_ns[0]._ns_loaded)
    {
      ...
      for (i = 0; i < nlist; ++i)
 {
   ...
   if (l->l_info[(35 + 0 + 16 + ((Elf32_Word)-((Elf32_Sword) (0x7ffffffd) <<1>>1)-1))] || l->l_info[(35 + 0 + 16 + ((Elf32_Word)-((Elf32_Sword) (0x7fffffff) <<1>>1)-1))])
     {
...
# 529 "dl-deps.c"
   ...
   ((void) sizeof ((cnt <= nlist) ? 1 : 0), __extension__ ({ if (cnt <= nlist) ; else __assert_fail ("cnt <= nlist", "dl-deps.c", 534, __extension__ __PRETTY_FUNCTION__); }));
   for (j = 0; j < cnt; j++)
     {
       l_initfini[j]->l_reserved = 0;
       if (j && __builtin_expect (l_initfini[j]->l_info[16]
      != 
# 539 "dl-deps.c" 3 4
        ((void *)0)
# 539 "dl-deps.c"
            , 0))
  l->l_symbolic_in_local_scope = 
# 540 "dl-deps.c" 3 4
                                1
# 540 "dl-deps.c"
                                    ;
...
# 548 "dl-deps.c"
  ...
  ((void) sizeof ((map->l_searchlist.r_list[0] == map) ? 1 : 0), __extension__ ({ if (map->l_searchlist.r_list[0] == map) ; else __assert_fail ("map->l_searchlist.r_list[0] == map", "dl-deps.c", 559, __extension__ __PRETTY_FUNCTION__); }));
