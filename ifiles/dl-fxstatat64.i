# 1 "../sysdeps/unix/sysv/linux/wordsize-64/dl-fxstatat64.c"
...
# 1 "<command-line>" 2
# 1 "../sysdeps/unix/sysv/linux/wordsize-64/dl-fxstatat64.c"
# 1 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 1
# 22 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c"
# 1 "../include/errno.h" 1
...
# 23 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 2
# 1 "../include/fcntl.h" 1
...
# 24 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 2
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/recipe-sysroot-native/usr/lib/x86_64-poky-linux/gcc/x86_64-poky-linux/8.3.0/include/stddef.h" 1 3 4
...
# 25 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 2
# 1 "../include/stdio.h" 1
...
# 26 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 2
...
extern char *__strncat_chk (char *__restrict __dest,
       const char *__restrict __src,
       size_t __len, size_t __destlen) __attribute__ ((__nothrow__ ));
# 27 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 2
...
extern int __lxstat64 (int __ver, const char *__filename,
         struct stat64 *__stat_buf) __attribute__ ((__nothrow__ )) ;
extern int __fxstatat64_disable (int __ver, int __fildes, const char *__filename,
...
{
  return __fxstatat64_disable (1, __fd, __filename, __statbuf, __flag);
}
...
extern __typeof (__fxstatat64_disable) __fxstatat64_disable __attribute__ ((visibility ("hidden")));
# 28 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 2
...
# 30 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 2
...
__fxstatat (int vers, int fd, const char *file, struct stat *st, int flag)
{
  if (vers != 0 && vers != 1)
    {
      (rtld_errno = (
# 39 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 3 4
     22
# 39 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c"
     ));
      return -1;
    }

  return ({ unsigned long int resultvar = ({ unsigned long int resultvar; __typeof__ ((flag) - (flag)) __arg4 = ((__typeof__ ((flag) - (flag))) (flag)); __typeof__ ((st) - (st)) __arg3 = ((__typeof__ ((st) - (st))) (st)); __typeof__ ((file) - (file)) __arg2 = ((__typeof__ ((file) - (file))) (file)); __typeof__ ((fd) - (fd)) __arg1 = ((__typeof__ ((fd) - (fd))) (fd)); register __typeof__ ((flag) - (flag)) _a4 asm ("r10") = __arg4; register __typeof__ ((st) - (st)) _a3 asm ("rdx") = __arg3; register __typeof__ ((file) - (file)) _a2 asm ("rsi") = __arg2; register __typeof__ ((fd) - (fd)) _a1 asm ("rdi") = __arg1; asm volatile ( "syscall\n\t" : "=a" (resultvar) : "0" (
# 43 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c" 3 4
        262
# 43 "../sysdeps/unix/sysv/linux/wordsize-64/fxstatat.c"
        ), "r" (_a1), "r" (_a2), "r" (_a3), "r" (_a4) : "memory", "cc", "r11", "cx"); (long int) resultvar; }); if (__builtin_expect ((((unsigned long int) (long int) (resultvar) >= -4095L)), 0)) { (rtld_errno = ((-(resultvar)))); resultvar = (unsigned long int) -1; } (long int) resultvar; });
}


extern __typeof (__fxstatat) __fxstatat64 __attribute__ ((alias ("__fxstatat")));;
extern __typeof (__fxstatat64) __GI___fxstatat64 __attribute__ ((alias ("__fxstatat64")));
# 1 "../sysdeps/unix/sysv/linux/wordsize-64/dl-fxstatat64.c" 2
