...
void
_dl_resolve_conflicts (struct link_map *l, Elf64_Rela *conflict,
         Elf64_Rela *conflictend)
{
  ...
  {
# 55 "dl-conflict.c"
    ((void) sizeof ((l->l_ns == 0) ? 1 : 0), __extension__ ({ if (l->l_ns == 0) ; else __assert_fail ("l->l_ns == LM_ID_BASE", "dl-conflict.c", 55, __extension__ __PRETTY_FUNCTION__); }));
...
# 345 "../sysdeps/x86_64/dl-machine.h"
 ...
 case 7:
   *reloc_addr = value + reloc->r_addend;
   break;
# 453 "../sysdeps/x86_64/dl-machine.h"
 case 1:
...
# 468 "../sysdeps/x86_64/dl-machine.h"
   ...
   break;
# 511 "../sysdeps/x86_64/dl-machine.h"
 case 37:
...
# 60 "dl-conflict.c" 2
    ...
    _rtld_local._dl_num_cache_relocations += conflictend - conflict;

    for (; conflict < conflictend; ++conflict)
      elf_machine_rela (l, conflict, 
# 70 "dl-conflict.c" 3 4
                                    ((void *)0)
# 70 "dl-conflict.c"
                                        , 
# 70 "dl-conflict.c" 3 4
