# 1 "../sysdeps/unix/sysv/linux/dl-execstack.c"
...
# 20 "../sysdeps/unix/sysv/linux/dl-execstack.c" 2
...
# 22 "../sysdeps/unix/sysv/linux/dl-execstack.c" 2
...
# 23 "../sysdeps/unix/sysv/linux/dl-execstack.c" 2





extern int __stack_prot __attribute__ ((section (".data.rel.ro"))) __attribute__ ((visibility ("hidden")));
...
_dl_make_stack_executable (void **stack_endp)
{
  ...
  uintptr_t page = ((uintptr_t) *stack_endp
      & -(intptr_t) _rtld_local_ro._dl_pagesize);
  int result = 0;

  if (__builtin_expect (__mprotect ((void *) page, _rtld_local_ro._dl_pagesize,
        __stack_prot) == 0, 1))
    goto return_success;
  result = rtld_errno;
  goto out;
  ...
  *stack_endp = 
# 47 "../sysdeps/unix/sysv/linux/dl-execstack.c" 3 4
               ((void *)0)
# 47 "../sysdeps/unix/sysv/linux/dl-execstack.c"
                   ;


  _rtld_local._dl_stack_flags |= (1 << 0);
...
extern __typeof (_dl_make_stack_executable) __EI__dl_make_stack_executable __asm__("" "_dl_make_stack_executable"); extern __typeof (_dl_make_stack_executable) __EI__dl_make_stack_executable __attribute__((alias ("" "__GI__dl_make_stack_executable")));
