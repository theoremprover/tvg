...
# 1 "<command-line>" 2
# 1 "../sysdeps/x86_64/dl-runtime.c"
# 9 "../sysdeps/x86_64/dl-runtime.c"
# 1 "../elf/dl-runtime.c" 1
# 21 "../elf/dl-runtime.c"
...
# 26 "../elf/dl-runtime.c" 2
# 1 "../sysdeps/unix/sysv/linux/sysdep-cancel.h" 1
# 22 "../sysdeps/unix/sysv/linux/sysdep-cancel.h"
# 1 "../nptl/pthreadP.h" 1
# 22 "../nptl/pthreadP.h"
# 1 "../include/pthread.h" 1
...
extern void __pthread_initialize (void) __attribute__ ((weak));
# 23 "../nptl/pthreadP.h" 2



# 1 "../nptl/descr.h" 1
# 27 "../nptl/pthreadP.h" 2
...
# 35 "../nptl/pthreadP.h" 2
# 1 "../sysdeps/unix/sysv/linux/internal-signals.h" 1
# 23 "../sysdeps/unix/sysv/linux/internal-signals.h"
# 1 "../sysdeps/unix/sysv/linux/sigsetops.h" 1
# 24 "../sysdeps/unix/sysv/linux/internal-signals.h" 2
# 42 "../sysdeps/unix/sysv/linux/internal-signals.h"
static inline 
# 42 "../sysdeps/unix/sysv/linux/internal-signals.h" 3 4
             _Bool

# 43 "../sysdeps/unix/sysv/linux/internal-signals.h"
__is_internal_signal (int sig)
{
  return (sig == 32) || (sig == (32 + 1));
}
...
{
  (__extension__ ({ unsigned long int __mask = (((unsigned long int) 1) << (((32) - 1) % (8 * sizeof (unsigned long int)))); unsigned long int __word = (((32) - 1) / (8 * sizeof (unsigned long int))); (set)->__val[__word] &= ~__mask; (void)0; }));
  (__extension__ ({ unsigned long int __mask = (((unsigned long int) 1) << ((((32 + 1)) - 1) % (8 * sizeof (unsigned long int)))); unsigned long int __word = ((((32 + 1)) - 1) / (8 * sizeof (unsigned long int))); (set)->__val[__word] &= ~__mask; (void)0; }));
}
...
{
  do { } while (0);
  return ({ unsigned long int resultvar; __typeof__ (((64 + 1) / 8) - ((64 + 1) / 8)) __arg4 = ((__typeof__ (((64 + 1) / 8) - ((64 + 1) / 8))) ((64 + 1) / 8)); __typeof__ ((set) - (set)) __arg3 = ((__typeof__ ((set) - (set))) (set)); __typeof__ ((&((__sigset_t) { .__val = {[0 ... (1024 / (8 * sizeof (unsigned long int)))-1 ] = -1 } })) - (&((__sigset_t) { .__val = {[0 ... (1024 / (8 * sizeof (unsigned long int)))-1 ] = -1 } }))) __arg2 = ((__typeof__ ((&((__sigset_t) { .__val = {[0 ... (1024 / (8 * sizeof (unsigned long int)))-1 ] = -1 } })) - (&((__sigset_t) { .__val = {[0 ... (1024 / (8 * sizeof (unsigned long int)))-1 ] = -1 } })))) (&((__sigset_t) { .__val = {[0 ... (1024 / (8 * sizeof (unsigned long int)))-1 ] = -1 } }))); __typeof__ ((0) - (0)) __arg1 = ((__typeof__ ((0) - (0))) (0)); register __typeof__ (((64 + 1) / 8) - ((64 + 1) / 8)) _a4 asm ("r10") = __arg4; register __typeof__ ((set) - (set)) _a3 asm ("rdx") = __arg3; register __typeof__ ((&((__sigset_t) { .__val = {[0 ... (1024 / (8 * sizeof (unsigned long int)))-1 ] = -1 } })) - (&((__sigset_t) { .__val = {[0 ... (1024 / (8 * sizeof (unsigned long int)))-1 ] = -1 } }))) _a2 asm ("rsi") = __arg2; register __typeof__ ((0) - (0)) _a1 asm ("rdi") = __arg1; asm volatile ( "syscall\n\t" : "=a" (resultvar) : "0" (
# 64 "../sysdeps/unix/sysv/linux/internal-signals.h" 3 4
        14
# 64 "../sysdeps/unix/sysv/linux/internal-signals.h"
        ), "r" (_a1), "r" (_a2), "r" (_a3), "r" (_a4) : "memory", "cc", "r11", "cx"); (long int) resultvar; })
                     ;
}
...
{
  sigset_t allset = ((__sigset_t) { .__val = {[0 ... (1024 / (8 * sizeof (unsigned long int)))-1 ] = -1 } });
  __clear_internal_signals (&allset);
  do { } while (0);
  return ({ unsigned long int resultvar; __typeof__ (((64 + 1) / 8) - ((64 + 1) / 8)) __arg4 = ((__typeof__ (((64 + 1) / 8) - ((64 + 1) / 8))) ((64 + 1) / 8)); __typeof__ ((set) - (set)) __arg3 = ((__typeof__ ((set) - (set))) (set)); __typeof__ ((&allset) - (&allset)) __arg2 = ((__typeof__ ((&allset) - (&allset))) (&allset)); __typeof__ ((0) - (0)) __arg1 = ((__typeof__ ((0) - (0))) (0)); register __typeof__ (((64 + 1) / 8) - ((64 + 1) / 8)) _a4 asm ("r10") = __arg4; register __typeof__ ((set) - (set)) _a3 asm ("rdx") = __arg3; register __typeof__ ((&allset) - (&allset)) _a2 asm ("rsi") = __arg2; register __typeof__ ((0) - (0)) _a1 asm ("rdi") = __arg1; asm volatile ( "syscall\n\t" : "=a" (resultvar) : "0" (
# 75 "../sysdeps/unix/sysv/linux/internal-signals.h" 3 4
        14
# 75 "../sysdeps/unix/sysv/linux/internal-signals.h"
        ), "r" (_a1), "r" (_a2), "r" (_a3), "r" (_a4) : "memory", "cc", "r11", "cx"); (long int) resultvar; })
                ;
}
...
{
  do { } while (0);
  return ({ unsigned long int resultvar; __typeof__ (((64 + 1) / 8) - ((64 + 1) / 8)) __arg4 = ((__typeof__ (((64 + 1) / 8) - ((64 + 1) / 8))) ((64 + 1) / 8)); __typeof__ ((
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h" 3 4
        ((void *)0)
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h"
        ) - (
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h" 3 4
        ((void *)0)
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h"
...
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h" 3 4
        ((void *)0)
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h"
        )); __typeof__ ((set) - (set)) __arg2 = ((__typeof__ ((set) - (set))) (set)); __typeof__ ((2) - (2)) __arg1 = ((__typeof__ ((2) - (2))) (2)); register __typeof__ (((64 + 1) / 8) - ((64 + 1) / 8)) _a4 asm ("r10") = __arg4; register __typeof__ ((
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h" 3 4
        ((void *)0)
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h"
        ) - (
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h" 3 4
        ((void *)0)
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h"
        )) _a3 asm ("rdx") = __arg3; register __typeof__ ((set) - (set)) _a2 asm ("rsi") = __arg2; register __typeof__ ((2) - (2)) _a1 asm ("rdi") = __arg1; asm volatile ( "syscall\n\t" : "=a" (resultvar) : "0" (
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h" 3 4
        14
# 84 "../sysdeps/unix/sysv/linux/internal-signals.h"
        ), "r" (_a1), "r" (_a2), "r" (_a3), "r" (_a4) : "memory", "cc", "r11", "cx"); (long int) resultvar; })
...
# 195 "../nptl/pthreadP.h"
extern struct pthread_attr __default_pthread_attr __attribute__ ((visibility ("hidden")));
extern int __default_pthread_attr_lock __attribute__ ((visibility ("hidden")));
...
extern unsigned int __nptl_nthreads __attribute__ ((visibility ("hidden")));
...
__do_cancel (void)
{
  struct pthread *self = ({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 299 "../nptl/pthreadP.h" 3 4
                        __builtin_offsetof (
# 299 "../nptl/pthreadP.h"
                        struct pthread
# 299 "../nptl/pthreadP.h" 3 4
...
# 299 "../nptl/pthreadP.h"
  ...
  (void) ({ if (sizeof ((self)->cancelhandling) == 4) asm volatile ("lock;" "orl %1, %%fs:%P0" :: "i" (
# 302 "../nptl/pthreadP.h" 3 4
 __builtin_offsetof (
# 302 "../nptl/pthreadP.h"
 struct pthread
# 302 "../nptl/pthreadP.h" 3 4
...
# 302 "../nptl/pthreadP.h"
  ...
  __pthread_unwind ((__pthread_unwind_buf_t *)
      ({ __typeof (self->cleanup_jmp_buf) __value; if (sizeof (__value) == 1) asm volatile ("movb %%fs:%P2,%b0" : "=q" (__value) : "0" (0), "i" (
# 305 "../nptl/pthreadP.h" 3 4
     __builtin_offsetof (
# 305 "../nptl/pthreadP.h"
     struct pthread
# 305 "../nptl/pthreadP.h" 3 4
...
extern void __deallocate_stack (struct pthread *pd) __attribute__ ((visibility ("hidden")));
...
extern int __make_stacks_executable (void **stack_endp) __attribute__ ((visibility ("hidden")));
...
extern int __pthread_multiple_threads __attribute__ ((visibility ("hidden")));

extern int *__libc_multiple_threads_ptr __attribute__ ((visibility ("hidden")));
...
extern int __pthread_mutex_unlock_usercnt (pthread_mutex_t *__mutex,
        int __decr) __attribute__ ((visibility ("hidden")));
...
extern void __nptl_deallocate_tsd (void) __attribute__ ((visibility ("hidden")));
...
extern void __nptl_stacks_freeres (void) __attribute__ ((visibility ("hidden")));
extern void __shm_directory_freeres (void) __attribute__ ((visibility ("hidden")));
...
check_stacksize_attr (size_t st)
{
  ...
  return 
# 650 "../nptl/pthreadP.h" 3 4
        22
# 650 "../nptl/pthreadP.h"
              ;
}
# 23 "../sysdeps/unix/sysv/linux/sysdep-cancel.h" 2
# 27 "../elf/dl-runtime.c" 2
# 1 "../elf/dynamic-link.h" 1
# 45 "../elf/dynamic-link.h"
int _dl_try_allocate_static_tls (struct link_map *map) __attribute__ ((visibility ("hidden")));
# 91 "../elf/dynamic-link.h"
...
# 92 "../elf/dynamic-link.h" 2

# 1 "../elf/get-dynamic-info.h" 1
# 22 "../elf/get-dynamic-info.h"
...
# 23 "../elf/get-dynamic-info.h" 2
# 1 "../include/libc-diag.h" 1
# 24 "../elf/get-dynamic-info.h" 2
...
elf_get_dynamic_info (struct link_map *l, Elf64_Dyn *temp)
{
  ...
  if (dyn == 
# 42 "../elf/get-dynamic-info.h" 3 4
            ((void *)0)
# 42 "../elf/get-dynamic-info.h"
                )
    return;
...
# 57 "../elf/get-dynamic-info.h"
#pragma GCC diagnostic push
# 57 "../elf/get-dynamic-info.h"
  ;
  
#pragma GCC diagnostic ignored "-Warray-bounds"
# 58 "../elf/get-dynamic-info.h"
  
                          ;
   info[dyn->d_tag - 0x70000000 + 35] = dyn;
  
# 61 "../elf/get-dynamic-info.h"
  ...
  if (l->l_addr != 0)
    {
      ...
      int cnt = 0;
# 101 "../elf/get-dynamic-info.h"
      do if (info[4] != 
# 101 "../elf/get-dynamic-info.h" 3 4
     ((void *)0)
# 101 "../elf/get-dynamic-info.h"
      ...
      do if (info[3] != 
# 102 "../elf/get-dynamic-info.h" 3 4
     ((void *)0)
# 102 "../elf/get-dynamic-info.h"
      ...
      do if (info[5] != 
# 103 "../elf/get-dynamic-info.h" 3 4
     ((void *)0)
# 103 "../elf/get-dynamic-info.h"
      ...
      do if (info[6] != 
# 104 "../elf/get-dynamic-info.h" 3 4
     ((void *)0)
# 104 "../elf/get-dynamic-info.h"
      ...
      do if (info[7] != 
# 106 "../elf/get-dynamic-info.h" 3 4
     ((void *)0)
# 106 "../elf/get-dynamic-info.h"
      ...
      do if (info[23] != 
# 111 "../elf/get-dynamic-info.h" 3 4
     ((void *)0)
# 111 "../elf/get-dynamic-info.h"
...
# 112 "../elf/get-dynamic-info.h" 3 4
     ((void *)0)
# 112 "../elf/get-dynamic-info.h"
...
# 113 "../elf/get-dynamic-info.h" 3 4
     ((void *)0)
# 113 "../elf/get-dynamic-info.h"
      ...
      ((void) sizeof ((cnt <= 8) ? 1 : 0), __extension__ ({ if (cnt <= 8) ; else __assert_fail ("cnt <= DL_RO_DYN_TEMP_CNT", "../elf/get-dynamic-info.h", 115, __extension__ __PRETTY_FUNCTION__); }));
    }

  if (info[20] != 
# 118 "../elf/get-dynamic-info.h" 3 4
                        ((void *)0)
# 118 "../elf/get-dynamic-info.h"
                            )
    {



      ((void) sizeof ((info[20]->d_un.d_val == 7) ? 1 : 0), __extension__ ({ if (info[20]->d_un.d_val == 7) ; else __assert_fail ("info[DT_PLTREL]->d_un.d_val == DT_RELA", "../elf/get-dynamic-info.h", 123, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (info[7] != 
# 130 "../elf/get-dynamic-info.h" 3 4
                      ((void *)0)
# 130 "../elf/get-dynamic-info.h"
                          )
    ((void) sizeof ((info[9]->d_un.d_val == sizeof (Elf64_Rela)) ? 1 : 0), __extension__ ({ if (info[9]->d_un.d_val == sizeof (Elf64_Rela)) ; else __assert_fail ("info[DT_RELAENT]->d_un.d_val == sizeof (ElfW(Rela))", "../elf/get-dynamic-info.h", 131, __extension__ __PRETTY_FUNCTION__); }));
# 149 "../elf/get-dynamic-info.h"
  if (info[30] != 
# 149 "../elf/get-dynamic-info.h" 3 4
                       ((void *)0)
# 149 "../elf/get-dynamic-info.h"
                           )
    {
...
# 163 "../elf/get-dynamic-info.h" 3 4
                                     ((void *)0)
# 163 "../elf/get-dynamic-info.h"
                                         )
    {
 ...
 info[24] = info[(35 + 0 + (0x6fffffff - (0x6ffffffb)))];
  ...
  if (info[29] != 
# 181 "../elf/get-dynamic-info.h" 3 4
                         ((void *)0)
# 181 "../elf/get-dynamic-info.h"
                             )

    info[15] = 
# 183 "../elf/get-dynamic-info.h" 3 4
                    ((void *)0)
# 183 "../elf/get-dynamic-info.h"
                        ;

}
# 94 "../elf/dynamic-link.h" 2
# 28 "../elf/dl-runtime.c" 2

# 1 "../sysdeps/x86_64/dl-irel.h" 1
# 23 "../sysdeps/x86_64/dl-irel.h"
# 1 "../include/stdio.h" 1
...
extern FILE *_IO_stdin __attribute__ ((visibility ("hidden")));
extern FILE *_IO_stdout __attribute__ ((visibility ("hidden")));
extern FILE *_IO_stderr __attribute__ ((visibility ("hidden")));
...
extern int __fcloseall (void) __attribute__ ((visibility ("hidden")));
...
extern __ssize_t __getline (char **__lineptr, size_t *__n,
                            FILE *__stream) __attribute__ ((visibility ("hidden")));
...
extern int __path_search (char *__tmpl, size_t __tmpl_len,
     ...
     int __try_tempdir) __attribute__ ((visibility ("hidden")));

extern int __gen_tempname (char *__tmpl, int __suffixlen, int __flags,
      int __kind) __attribute__ ((visibility ("hidden")));
...
extern void __libc_message (enum __libc_message_action action,
       const char *__fnt, ...) __attribute__ ((visibility ("hidden")));
...
extern void __flockfile (FILE *__stream) __attribute__ ((visibility ("hidden")));


extern void __funlockfile (FILE *__stream) __attribute__ ((visibility ("hidden")));



extern int __ftrylockfile (FILE *__stream);

extern int __getc_unlocked (FILE *__fp) __attribute__ ((visibility ("hidden")));
extern wint_t __getwc_unlocked (FILE *__fp);

extern int __fxprintf (FILE *__fp, const char *__fmt, ...)
     __attribute__ ((__format__ (__printf__, 2, 3))) __attribute__ ((visibility ("hidden")));
...
extern const char *const _sys_errlist_internal[] __attribute__ ((visibility ("hidden")));
extern int _sys_nerr_internal __attribute__ ((visibility ("hidden")));
...
extern __typeof (feof_unlocked) __feof_unlocked __attribute__ ((visibility ("hidden")));

extern __typeof (ferror_unlocked) __ferror_unlocked __attribute__ ((visibility ("hidden")));



extern __typeof (putc_unlocked) __putc_unlocked __attribute__ ((visibility ("hidden")));
...
extern __typeof (__libc_fatal) __libc_fatal __asm__ ("" "__GI___libc_fatal") __attribute__ ((visibility ("hidden")));
...
elf_irela (const Elf64_Rela *reloc)
{
  ...
  if (__builtin_expect ((r_type == 37), 1))
    {
...
# 30 "../elf/dl-runtime.c" 2
# 59 "../elf/dl-runtime.c"
Elf64_Addr
__attribute__ ((visibility ("hidden"))) __attribute ((noinline))
_dl_fixup (



    struct link_map *l, Elf64_Word reloc_arg)
{
  const Elf64_Sym *const symtab
    = (const void *) (l)->l_info[6]->d_un.d_ptr;
  const char *strtab = (const void *) (l)->l_info[5]->d_un.d_ptr;

  const Elf64_Rela *const reloc
    = (const void *) ((l)->l_info[23]->d_un.d_ptr + reloc_arg * sizeof (Elf64_Rela));
  const Elf64_Sym *sym = &symtab[((reloc->r_info) >> 32)];
  const Elf64_Sym *refsym = sym;
  void *const rel_addr = (void *)(l->l_addr + reloc->r_offset);
  lookup_t result;
  Elf64_Addr value;


  ((void) sizeof ((((reloc->r_info) & 0xffffffff) == 7) ? 1 : 0), __extension__ ({ if (((reloc->r_info) & 0xffffffff) == 7) ; else __assert_fail ("ELFW(R_TYPE)(reloc->r_info) == ELF_MACHINE_JMP_SLOT", "../elf/dl-runtime.c", 80, __extension__ __PRETTY_FUNCTION__); }));
  ...
  if (__builtin_expect (((sym->st_other) & 0x03), 0) == 0)
    {
      const struct r_found_version *version = 
# 86 "../elf/dl-runtime.c" 3 4
                                             ((void *)0)
# 86 "../elf/dl-runtime.c"
                                                 ;

      if (l->l_info[(35 + 0 + (0x6fffffff - (0x6ffffff0)))] != 
# 88 "../elf/dl-runtime.c" 3 4
                                             ((void *)0)
# 88 "../elf/dl-runtime.c"
                                                 )
 {
   const Elf64_Half *vernum =
     (const void *) (l)->l_info[(35 + 0 + (0x6fffffff - (0x6ffffff0)))]->d_un.d_ptr;
   Elf64_Half ndx = vernum[((reloc->r_info) >> 32)] & 0x7fff;
   version = &l->l_versions[ndx];
   if (version->hash == 0)
     version = 
# 95 "../elf/dl-runtime.c" 3 4
              ((void *)0)
# 95 "../elf/dl-runtime.c"
                  ;
 }
      ...
      if (!__builtin_expect ((({ __typeof (({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 102 "../elf/dl-runtime.c" 3 4
          __builtin_offsetof (
# 102 "../elf/dl-runtime.c"
          struct pthread
# 102 "../elf/dl-runtime.c" 3 4
          , 
# 102 "../elf/dl-runtime.c"
...
# 102 "../elf/dl-runtime.c"
          )); __self;})->header.multiple_threads) __value; if (sizeof (__value) == 1) asm volatile ("movb %%fs:%P2,%b0" : "=q" (__value) : "0" (0), "i" (
# 102 "../elf/dl-runtime.c" 3 4
          __builtin_offsetof (
# 102 "../elf/dl-runtime.c"
          struct pthread
...
# 104 "../elf/dl-runtime.c" 3 4
  __builtin_offsetof (
# 104 "../elf/dl-runtime.c"
  struct pthread
# 104 "../elf/dl-runtime.c" 3 4
  , 
# 104 "../elf/dl-runtime.c"
...
# 104 "../elf/dl-runtime.c"
  )); __self;})->header.gscope_flag) == 1) asm volatile ("movb %b0,%%fs:%P1" : : "iq" (1), "i" (
# 104 "../elf/dl-runtime.c" 3 4
  __builtin_offsetof (
# 104 "../elf/dl-runtime.c"
  struct pthread
...
# 104 "../elf/dl-runtime.c"
  )); __self;})->header.gscope_flag) == 4) asm volatile ("movl %0,%%fs:%P1" : : "nr" (1), "i" (
# 104 "../elf/dl-runtime.c" 3 4
  __builtin_offsetof (
# 104 "../elf/dl-runtime.c"
  struct pthread
...
# 104 "../elf/dl-runtime.c"
  )); __self;})->header.gscope_flag) != 8) abort (); asm volatile ("movq %q0,%%fs:%P1" : : "nr" ((uint64_t) ((__typeof__ (*(0 ? (__typeof__ (0 ? (__typeof__ ((__typeof__ (1)) 0) *) 0 : (void *) ((__builtin_classify_type ((__typeof__ (1)) 0) == 5)))) 0 : (__typeof__ (0 ? (intptr_t *) 0 : (void *) (!((__builtin_classify_type ((__typeof__ (1)) 0) == 5))))) 0))) (1))), "i" (
# 104 "../elf/dl-runtime.c" 3 4
  __builtin_offsetof (
# 104 "../elf/dl-runtime.c"
  struct pthread
...
# 104 "../elf/dl-runtime.c"
   ...
   flags |= DL_LOOKUP_GSCOPE_LOCK;
      ...
      result = _dl_lookup_symbol_x (strtab + sym->st_name, l, &sym, l->l_scope,
        version, 1, flags, 
# 113 "../elf/dl-runtime.c" 3 4
                                            ((void *)0)
# 113 "../elf/dl-runtime.c"
                                                );


      if (!__builtin_expect ((({ __typeof (({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 116 "../elf/dl-runtime.c" 3 4
          __builtin_offsetof (
# 116 "../elf/dl-runtime.c"
          struct pthread
# 116 "../elf/dl-runtime.c" 3 4
          , 
# 116 "../elf/dl-runtime.c"
...
# 116 "../elf/dl-runtime.c"
 ...
 do { int __res; asm volatile ("xchgl %0, %%fs:%P1" : "=r" (__res) : "i" (
# 117 "../elf/dl-runtime.c" 3 4
__builtin_offsetof (
# 117 "../elf/dl-runtime.c"
struct pthread
# 117 "../elf/dl-runtime.c" 3 4
, 
# 117 "../elf/dl-runtime.c"
...
# 117 "../elf/dl-runtime.c"
), "0" (0)); if (__res == 2) ({ do { } while (0); long int __ret = ({ unsigned long int resultvar; __typeof__ ((0) - (0)) __arg4 = ((__typeof__ ((0) - (0))) (0)); __typeof__ ((1) - (1)) __arg3 = ((__typeof__ ((1) - (1))) (1)); __typeof__ ((({ int __lll_private_flag_priv __attribute__ ((unused)); __lll_private_flag_priv = (0); ((1) | 128); })) - (({ int __lll_private_flag_priv __attribute__ ((unused)); __lll_private_flag_priv = (0); ((1) | 128); }))) __arg2 = ((__typeof__ ((({ int __lll_private_flag_priv __attribute__ ((unused)); __lll_private_flag_priv = (0); ((1) | 128); })) - (({ int __lll_private_flag_priv __attribute__ ((unused)); __lll_private_flag_priv = (0); ((1) | 128); })))) (({ int __lll_private_flag_priv __attribute__ ((unused)); __lll_private_flag_priv = (0); ((1) | 128); }))); __typeof__ ((&({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 117 "../elf/dl-runtime.c" 3 4
__builtin_offsetof (
# 117 "../elf/dl-runtime.c"
struct pthread
...
# 117 "../elf/dl-runtime.c"
)); __self;})->header.gscope_flag) - (&({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 117 "../elf/dl-runtime.c" 3 4
__builtin_offsetof (
# 117 "../elf/dl-runtime.c"
struct pthread
...
# 117 "../elf/dl-runtime.c"
)); __self;})->header.gscope_flag)) __arg1 = ((__typeof__ ((&({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 117 "../elf/dl-runtime.c" 3 4
__builtin_offsetof (
# 117 "../elf/dl-runtime.c"
struct pthread
...
# 117 "../elf/dl-runtime.c"
)); __self;})->header.gscope_flag)); register __typeof__ ((0) - (0)) _a4 asm ("r10") = __arg4; register __typeof__ ((1) - (1)) _a3 asm ("rdx") = __arg3; register __typeof__ ((({ int __lll_private_flag_priv __attribute__ ((unused)); __lll_private_flag_priv = (0); ((1) | 128); })) - (({ int __lll_private_flag_priv __attribute__ ((unused)); __lll_private_flag_priv = (0); ((1) | 128); }))) _a2 asm ("rsi") = __arg2; register __typeof__ ((&({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 117 "../elf/dl-runtime.c" 3 4
__builtin_offsetof (
# 117 "../elf/dl-runtime.c"
struct pthread
...
# 117 "../elf/dl-runtime.c"
)); __self;})->header.gscope_flag)) _a1 asm ("rdi") = __arg1; asm volatile ( "syscall\n\t" : "=a" (resultvar) : "0" (
# 117 "../elf/dl-runtime.c" 3 4
202
# 117 "../elf/dl-runtime.c"
), "r" (_a1), "r" (_a2), "r" (_a3), "r" (_a4) : "memory", "cc", "r11", "cx"); (long int) resultvar; }); (__builtin_expect ((((unsigned long int) (long int) (__ret) >= -4095L)), 0) ? -(-(__ret)) : 0); }); } while (0);
# 126 "../elf/dl-runtime.c"
      value = (((sym) == 
# 126 "../elf/dl-runtime.c" 3 4
             ((void *)0) 
# 126 "../elf/dl-runtime.c"
...
# 126 "../elf/dl-runtime.c" 3 4
             0
# 126 "../elf/dl-runtime.c"
             ) || (result) ? (result)->l_addr : 0)) + (sym)->st_value))
                                           ;
    }
  else
    {
      ...
      value = (((sym) == 
# 133 "../elf/dl-runtime.c" 3 4
             ((void *)0) 
# 133 "../elf/dl-runtime.c"
             ? 0 : (__builtin_expect (((sym)->st_shndx == 0xfff1), 0) ? 0 : ((
# 133 "../elf/dl-runtime.c" 3 4
             1
# 133 "../elf/dl-runtime.c"
             ) || (l) ? (l)->l_addr : 0)) + (sym)->st_value));
      result = l;
    }
  ...
  if (sym != 
# 140 "../elf/dl-runtime.c" 3 4
            ((void *)0)
      
# 141 "../elf/dl-runtime.c"
     && __builtin_expect (((sym->st_info) & 0xf) == 10, 0))
    value = elf_ifunc_invoke ((value));


  if (__builtin_expect ((_rtld_local_ro._dl_bind_not), 0))
    return value;
...
_dl_profile_fixup (
     ...
     struct link_map *l, Elf64_Word reloc_arg,
     Elf64_Addr retaddr, void *regs, long int *framesizep)
{
  void (*mcount_fct) (Elf64_Addr, Elf64_Addr) = _dl_mcount;

  if (l->l_reloc_result == 
# 163 "../elf/dl-runtime.c" 3 4
                          ((void *)0)
# 163 "../elf/dl-runtime.c"
                              )
    {
  ...
  struct reloc_result *reloc_result = &l->l_reloc_result[reloc_arg];
# 212 "../elf/dl-runtime.c"
  Elf64_Addr value;
  unsigned int init = ({ if ((sizeof (*(&reloc_result->init)) != 1) && (sizeof (*(&reloc_result->init)) != 2) && (sizeof (*(&reloc_result->init)) != 4) && (sizeof (*(&reloc_result->init)) != 8)) __atomic_link_error ();; __atomic_load_n ((&reloc_result->init), 2); });
  ...
  if (init == 0)
    {
      ...
      const Elf64_Sym *const symtab
 = (const void *) (l)->l_info[6]->d_un.d_ptr;
      const char *strtab = (const char *) (l)->l_info[5]->d_un.d_ptr;

      const Elf64_Rela *const reloc
 = (const void *) ((l)->l_info[23]->d_un.d_ptr + reloc_arg * sizeof (Elf64_Rela));
      const Elf64_Sym *refsym = &symtab[((reloc->r_info) >> 32)];
      const Elf64_Sym *defsym = refsym;
      lookup_t result;


      ((void) sizeof ((((reloc->r_info) & 0xffffffff) == 7) ? 1 : 0), __extension__ ({ if (((reloc->r_info) & 0xffffffff) == 7) ; else __assert_fail ("ELFW(R_TYPE)(reloc->r_info) == ELF_MACHINE_JMP_SLOT", "../elf/dl-runtime.c", 229, __extension__ __PRETTY_FUNCTION__); }));



      if (__builtin_expect (((refsym->st_other) & 0x03), 0) == 0)
 {
   const struct r_found_version *version = 
# 235 "../elf/dl-runtime.c" 3 4
                                          ((void *)0)
# 235 "../elf/dl-runtime.c"
                                              ;

   if (l->l_info[(35 + 0 + (0x6fffffff - (0x6ffffff0)))] != 
# 237 "../elf/dl-runtime.c" 3 4
                                          ((void *)0)
# 237 "../elf/dl-runtime.c"
                                              )
     {
       const Elf64_Half *vernum =
  (const void *) (l)->l_info[(35 + 0 + (0x6fffffff - (0x6ffffff0)))]->d_un.d_ptr;
       ...
       if (version->hash == 0)
  version = 
# 244 "../elf/dl-runtime.c" 3 4
           ((void *)0)
# 244 "../elf/dl-runtime.c"
               ;
     }
   ...
   int flags = DL_LOOKUP_ADD_DEPENDENCY;
   if (!__builtin_expect ((({ __typeof (({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 251 "../elf/dl-runtime.c" 3 4
       __builtin_offsetof (
# 251 "../elf/dl-runtime.c"
       struct pthread
# 251 "../elf/dl-runtime.c" 3 4
       , 
# 251 "../elf/dl-runtime.c"
...
# 251 "../elf/dl-runtime.c"
     ...
     {
       ({ if (sizeof (({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 253 "../elf/dl-runtime.c" 3 4
      __builtin_offsetof (
# 253 "../elf/dl-runtime.c"
      struct pthread
# 253 "../elf/dl-runtime.c" 3 4
      , 
# 253 "../elf/dl-runtime.c"
...
# 253 "../elf/dl-runtime.c"
   ...
   result = _dl_lookup_symbol_x (strtab + refsym->st_name, l,
     ...
     1, flags, 
# 259 "../elf/dl-runtime.c" 3 4
                                ((void *)0)
# 259 "../elf/dl-runtime.c"
                                    );


   if (!__builtin_expect ((({ __typeof (({ struct pthread *__self; asm ("mov %%fs:%c1,%0" : "=r" (__self) : "i" (
# 262 "../elf/dl-runtime.c" 3 4
       __builtin_offsetof (
# 262 "../elf/dl-runtime.c"
       struct pthread
# 262 "../elf/dl-runtime.c" 3 4
       , 
# 262 "../elf/dl-runtime.c"
...
# 262 "../elf/dl-runtime.c"
     ...
     do { int __res; asm volatile ("xchgl %0, %%fs:%P1" : "=r" (__res) : "i" (
# 263 "../elf/dl-runtime.c" 3 4
    __builtin_offsetof (
# 263 "../elf/dl-runtime.c"
    struct pthread
# 263 "../elf/dl-runtime.c" 3 4
    , 
# 263 "../elf/dl-runtime.c"
...
# 263 "../elf/dl-runtime.c"
   ...
   value = (((defsym) == 
# 268 "../elf/dl-runtime.c" 3 4
          ((void *)0) 
# 268 "../elf/dl-runtime.c"
          ? 0 : (__builtin_expect (((defsym)->st_shndx == 0xfff1), 0) ? 0 : ((
# 268 "../elf/dl-runtime.c" 3 4
          0
# 268 "../elf/dl-runtime.c"
          ) || (result) ? (result)->l_addr : 0)) + (defsym)->st_value))
                                                  ;

   if (defsym != 
# 271 "../elf/dl-runtime.c" 3 4
                ((void *)0)
       
# 272 "../elf/dl-runtime.c"
      && __builtin_expect (((defsym->st_info) & 0xf)
       == 10, 0))
     value = elf_ifunc_invoke ((value));
 }
      else
 {
   ...
   value = (((refsym) == 
# 280 "../elf/dl-runtime.c" 3 4
          ((void *)0) 
# 280 "../elf/dl-runtime.c"
          ? 0 : (__builtin_expect (((refsym)->st_shndx == 0xfff1), 0) ? 0 : ((
# 280 "../elf/dl-runtime.c" 3 4
          1
# 280 "../elf/dl-runtime.c"
          ) || (l) ? (l)->l_addr : 0)) + (refsym)->st_value));

   if (__builtin_expect (((refsym->st_info) & 0xf)
    == 10, 0))
     value = elf_ifunc_invoke ((value));
   ...
   result = l;
      ...
      if (defsym != 
# 295 "../elf/dl-runtime.c" 3 4
                   ((void *)0) 
# 295 "../elf/dl-runtime.c"
                        && _rtld_local_ro._dl_naudit > 0)
 {
   reloc_result->bound = result;


   reloc_result->boundndx = (defsym
        - (Elf64_Sym *) (result)->l_info[6]->d_un.d_ptr
                            );
   ...
   if ((l->l_audit_any_plt | result->l_audit_any_plt) != 0)
     {
       ...
       Elf64_Sym sym = *defsym;
       sym.st_value = (value);



       ((void) sizeof ((16 * 2 <= sizeof (reloc_result->flags) * 8) ? 1 : 0), __extension__ ({ if (16 * 2 <= sizeof (reloc_result->flags) * 8) ; else __assert_fail ("DL_NNS * 2 <= sizeof (reloc_result->flags) * 8", "../elf/dl-runtime.c", 317, __extension__ __PRETTY_FUNCTION__); }));
       ((void) sizeof (((LA_SYMB_NOPLTENTER | LA_SYMB_NOPLTEXIT) == 3) ? 1 : 0), __extension__ ({ if ((LA_SYMB_NOPLTENTER | LA_SYMB_NOPLTEXIT) == 3) ; else __assert_fail ("(LA_SYMB_NOPLTENTER | LA_SYMB_NOPLTEXIT) == 3", "../elf/dl-runtime.c", 318, __extension__ __PRETTY_FUNCTION__); }));
       reloc_result->enterexit = LA_SYMB_NOPLTENTER | LA_SYMB_NOPLTEXIT;

       const char *strtab2 = (const void *) (result)->l_info[5]->d_un.d_ptr
                           ;
       ...
       for (unsigned int cnt = 0; cnt < _rtld_local_ro._dl_naudit; ++cnt)
  {
    ...
    if ((l->l_audit[cnt].bindflags & LA_FLG_BINDFROM) != 0
      ...
      {
        if (afct->symbind64 != 
# 331 "../elf/dl-runtime.c" 3 4
                            ((void *)0)
# 331 "../elf/dl-runtime.c"
                                )
   {
     uintptr_t new_value
       = afct->symbind64 (&sym, reloc_result->boundndx,
   ...
   |= ((flags & (LA_SYMB_NOPLTENTER | LA_SYMB_NOPLTEXIT))
    ...
    afct = afct->next;
     ...
     reloc_result->enterexit = (1u << 16) - 1;
      ...
      if (__builtin_expect ((! _rtld_local_ro._dl_bind_not), 1))
 {
   reloc_result->addr = value;


   do { if ((sizeof (*(&reloc_result->init)) != 1) && (sizeof (*(&reloc_result->init)) != 2) && (sizeof (*(&reloc_result->init)) != 4) && (sizeof (*(&reloc_result->init)) != 8)) __atomic_link_error ();; __atomic_store_n ((&reloc_result->init), (1), 3); } while (0);
 }
      init = 1;
    }
  else
  ...
  if (_rtld_local_ro._dl_naudit > 0

      && (reloc_result->enterexit & LA_SYMB_NOPLTENTER) == 0)
    {


      ((void) sizeof (((value) != 0) ? 1 : 0), __extension__ ({ if ((value) != 0) ; else __assert_fail ("DL_FIXUP_VALUE_CODE_ADDR (value) != 0", "../elf/dl-runtime.c", 399, __extension__ __PRETTY_FUNCTION__); }));
      Elf64_Sym *defsym = ((Elf64_Sym *) (reloc_result->bound)->l_info[6]->d_un.d_ptr
      ...
      const char *strtab = (const void *) (reloc_result->bound)->l_info[5]->d_un.d_ptr
                         ;
      ...
      for (unsigned int cnt = 0; cnt < _rtld_local_ro._dl_naudit; ++cnt)
 {
   if (afct->x86_64_gnu_pltenter != 
# 419 "../elf/dl-runtime.c" 3 4
                                ((void *)0)
       
# 420 "../elf/dl-runtime.c"
      && (reloc_result->enterexit
    & (LA_SYMB_NOPLTENTER << (2 * (cnt + 1)))) == 0)
     {
       long int new_framesize = -1;
       uintptr_t new_value
  = afct->x86_64_gnu_pltenter (&sym, reloc_result->boundndx,
       &l->l_audit[cnt].cookie,
    ...
    == 0 && new_framesize != -1 && framesize != -2)
  {
    ...
    if (framesize == -1)
      ...
      framesize = (((new_framesize)>(framesize))?(new_framesize):(framesize));
  }
     }
...
_dl_call_pltexit (struct link_map *l, Elf64_Word reloc_arg,
    const void *inregs, void *outregs)
{
  ...
  Elf64_Sym sym = *defsym;
  sym.st_value = (reloc_result->addr);
  ...
  for (unsigned int cnt = 0; cnt < _rtld_local_ro._dl_naudit; ++cnt)
    {
      if (afct->x86_64_gnu_pltexit != 
# 503 "../elf/dl-runtime.c" 3 4
                                  ((void *)0)
   
# 504 "../elf/dl-runtime.c"
  && (reloc_result->enterexit
       & (LA_SYMB_NOPLTEXIT >> (2 * cnt))) == 0)
 {
   afct->x86_64_gnu_pltexit (&sym, reloc_result->boundndx,
     &l->l_audit[cnt].cookie,
     &reloc_result->bound->l_audit[cnt].cookie,
...
# 9 "../sysdeps/x86_64/dl-runtime.c" 2
