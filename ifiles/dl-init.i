...
# 45 "dl-init.c"
  ...
  if (__builtin_expect ((_rtld_local_ro._dl_debug_mask & (1 << 1)), 0))
    _dl_debug_printf ("\ncalling init: %s\n\n",
...
# 57 "dl-init.c"
    ...
    ((init_t) (l->l_addr + l->l_info[12]->d_un.d_ptr)) (argc, argv, env);


  Elf64_Dyn *init_array = l->l_info[25];
  if (init_array != 
# 62 "dl-init.c" 3 4
                   ((void *)0)
# 62 "dl-init.c"
                       )
    {
      ...
      jm = l->l_info[27]->d_un.d_val / sizeof (Elf64_Addr);

      addrs = (Elf64_Addr *) (init_array->d_un.d_ptr + l->l_addr);
      for (j = 0; j < jm; ++j)
...
{
  Elf64_Dyn *preinit_array = main_map->l_info[32];
  Elf64_Dyn *preinit_array_size = main_map->l_info[33];
  unsigned int i;

  if (__builtin_expect ((_rtld_local._dl_initfirst != 
# 84 "dl-init.c" 3 4
     ((void *)0)
# 84 "dl-init.c"
     ), 0))
    {
      call_init (_rtld_local._dl_initfirst, argc, argv, env);
      _rtld_local._dl_initfirst = 
# 87 "dl-init.c" 3 4
                        ((void *)0)
# 87 "dl-init.c"
                            ;
  ...
  if (__builtin_expect (preinit_array != 
# 91 "dl-init.c" 3 4
                                        ((void *)0)
# 91 "dl-init.c"
                                            , 0)
...
# 93 "dl-init.c"
     && (i = preinit_array_size->d_un.d_val / sizeof (Elf64_Addr)) > 0)
    {
      ...
      if (__builtin_expect ((_rtld_local_ro._dl_debug_mask & (1 << 1)), 0))
 _dl_debug_printf ("\ncalling preinit: %s\n\n",
     ((main_map->l_name)[0] ? (main_map->l_name) : (_dl_argv[0] ?: "<main program>")));

      addrs = (Elf64_Addr *) (preinit_array->d_un.d_ptr + main_map->l_addr);
      for (cnt = 0; cnt < i; ++cnt)
