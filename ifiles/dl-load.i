...
# 26 "../misc/bits/types/struct_iovec.h"
struct iovec
  {
    void *iov_base;
    size_t iov_len;
...
# 94 "dynamic-link.h" 2
# 60 "dl-load.c" 2
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/build-x86_64-poky-linux/csu/./abi-tag.h" 1
# 61 "dl-load.c" 2




# 1 "../include/array_length.h" 1
# 66 "dl-load.c" 2

# 1 "./dl-dst.h" 1
# 19 "./dl-dst.h"
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/build-x86_64-poky-linux/elf/trusted-dirs.h" 1
# 20 "./dl-dst.h" 2
# 68 "dl-load.c" 2
# 1 "./dl-load.h" 1
# 75 "./dl-load.h"
...
static void __inline __attribute__ ((__always_inline__))
_dl_postprocess_loadcmd (struct link_map *l, const Elf64_Ehdr *header,
...
static const char *_dl_map_segments (struct link_map *l, int fd,
                                     const Elf64_Ehdr *header, int type,
...
# 69 "dl-load.c" 2
# 1 "./dl-map-segments.h" 1
# 28 "./dl-map-segments.h"
static __inline __attribute__ ((__always_inline__)) const char *
_dl_map_segments (struct link_map *l, int fd,
                  const Elf64_Ehdr *header, int type,
                  const struct loadcmd loadcmds[], size_t nloadcmds,
                  const size_t maplength, 
# 32 "./dl-map-segments.h" 3 4
                                         _Bool 
# 32 "./dl-map-segments.h"
                                              has_holes,
                  struct link_map *loader)
{
  const struct loadcmd *c = loadcmds;

  if (__builtin_expect ((type == 3), 1))
    {
# 50 "./dl-map-segments.h"
      Elf64_Addr mappref
        = ((c->mapstart & _rtld_local_ro._dl_use_load_bias)

           - 0);


      l->l_map_start = (Elf64_Addr) __mmap ((void *) mappref, maplength,
                                            c->prot,
                                            (0x02 | 0x00800)|0,
                                            fd, c->mapoff);
      if (__builtin_expect (((void *) l->l_map_start == ((void *) -1)), 0))
        return "failed to map segment from shared object";
      ...
      if (has_holes)
        {
          ...
          if (__builtin_expect ((__mprotect ((caddr_t) (l->l_addr + c->mapend), loadcmds[nloadcmds - 1].mapstart - c->mapend, 0x0) < 0), 0)


                                          )
            return "cannot change memory protections";
        }
      ...
      if (c->allocend > c->dataend)
        {
          ...
          zeropage = ((zero + _rtld_local_ro._dl_pagesize - 1)
                      & ~(_rtld_local_ro._dl_pagesize - 1));
          ...
          if (zeropage > zero)
            {
              ...
              if (__builtin_expect (((c->prot & 0x2) == 0), 0))
                {

                  if (__mprotect ((caddr_t) (zero
                                             & ~(_rtld_local_ro._dl_pagesize - 1)),
                                  _rtld_local_ro._dl_pagesize, c->prot|0x2) < 0)
                    return "cannot change memory protections";
                }
              memset ((void *) zero, '\0', zeropage - zero);
              if (__builtin_expect (((c->prot & 0x2) == 0), 0))
                __mprotect ((caddr_t) (zero & ~(_rtld_local_ro._dl_pagesize - 1)),
                            _rtld_local_ro._dl_pagesize, c->prot);
            }
          ...
          if (zeroend > zeropage)
            {
              ...
              mapat = __mmap ((caddr_t) zeropage, zeroend - zeropage,
                              c->prot, 0x20|0x02|0x10,
                              -1, 0);
              if (__builtin_expect ((mapat == ((void *) -1)), 0))
                return "cannot map zero-fill pages";
            }
        }
  ...
  return 
# 156 "./dl-map-segments.h" 3 4
        ((void *)0)
# 156 "./dl-map-segments.h"
            ;
}
# 70 "dl-load.c" 2
# 1 "./dl-unmap-segments.h" 1
# 29 "./dl-unmap-segments.h"
...
# 71 "dl-load.c" 2
# 1 "./dl-machine-reject-phdr.h" 1
# 26 "./dl-machine-reject-phdr.h"
static inline 
# 26 "./dl-machine-reject-phdr.h" 3 4
             _Bool

# 27 "./dl-machine-reject-phdr.h"
elf_machine_reject_phdr_p (const Elf64_Phdr *phdr, uint_fast16_t phnum,
      const char *buf, size_t len, struct link_map *map,
      int fd)
{
  return 
# 31 "./dl-machine-reject-phdr.h" 3 4
        0
# 31 "./dl-machine-reject-phdr.h"
             ;
}
# 72 "dl-load.c" 2
# 1 "./dl-sysdep-open.h" 1
# 22 "./dl-sysdep-open.h"
# 1 "../include/assert.h" 1
# 1 "../assert/assert.h" 1
# 64 "../assert/assert.h"
...
extern __typeof (__assert_fail) __assert_fail __asm__ ("" "__GI___assert_fail") __attribute__ ((visibility ("hidden")));
extern __typeof (__assert_perror_fail) __assert_perror_fail __asm__ ("" "__GI___assert_perror_fail") __attribute__ ((visibility ("hidden")));
# 23 "./dl-sysdep-open.h" 2
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/recipe-sysroot-native/usr/lib/x86_64-poky-linux/gcc/x86_64-poky-linux/8.3.0/include/stddef.h" 1 3 4
# 24 "./dl-sysdep-open.h" 2
# 38 "./dl-sysdep-open.h"
static inline char *
_dl_sysdep_open_object (const char *name, size_t namelen, int *fd)
{
  ((void) sizeof ((*fd == -1) ? 1 : 0), __extension__ ({ if (*fd == -1) ; else __assert_fail ("*fd == -1", "./dl-sysdep-open.h", 41, __extension__ __PRETTY_FUNCTION__); }));
  return 
# 42 "./dl-sysdep-open.h" 3 4
        ((void *)0)
# 42 "./dl-sysdep-open.h"
            ;
}
...
static inline int __attribute__ ((unused))
_dl_process_pt_note (struct link_map *l, const Elf64_Phdr *ph,
       int fd, struct filebuf *fbp)
{
# 183 "../sysdeps/x86/dl-prop.h"
  return 0;
}
...
# 77 "dl-load.c" 2
# 89 "dl-load.c"
int __stack_prot __attribute__ ((visibility ("hidden"))) __attribute__ ((section (".data.rel.ro")))

  = 0x01000000;
# 100 "dl-load.c"
static struct r_search_path_struct env_path_list __attribute__ ((section (".data.rel.ro")));


static const struct r_strlenpair *capstr __attribute__ ((section (".data.rel.ro")));
static size_t ncapstr __attribute__ ((section (".data.rel.ro")));
static size_t max_capstrlen __attribute__ ((section (".data.rel.ro")));
...
static const char system_dirs[] = "/lib/" "\0" "/usr/lib/";
...
# 124 "dl-load.c"
  ...
  char *npath = (char *) __builtin_alloca (len + 2);
  char *wnp = npath;
  while (*path != '\0')
    {
      if (path[0] == '/')
 {
  ...
  for (size_t idx = 0; idx < __extension__ ({ _Static_assert (!__builtin_types_compatible_p (__typeof (system_dirs_len), __typeof (&(system_dirs_len)[0])), "argument must be an array"); sizeof (system_dirs_len) / sizeof ((system_dirs_len)[0]); }); ++idx)
    {
...
# 310 "dl-load.c"
  ...
  repl = (const char *) -1;
     ...
     repl = _rtld_local_ro._dl_platform;
...
# 325 "dl-load.c"
      ...
      else
 {
  ...
  while (*input != '\0');
# 358 "dl-load.c"
  if (__builtin_expect ((check_for_trusted), 0)
...
expand_dynamic_string_token (struct link_map *l, const char *input)
{
  ...
  total = ({ size_t __len = (strlen (input)); size_t __cnt = (cnt); if (__cnt > 0) { size_t dst_len; if ((l)->l_origin == 
# 395 "dl-load.c" 3 4
         ((void *)0)
# 395 "dl-load.c"
         ) { ((void) sizeof (((l)->l_name[0] == '\0' || (l) == &_rtld_local._dl_rtld_map) ? 1 : 0), __extension__ ({ if ((l)->l_name[0] == '\0' || (l) == &_rtld_local._dl_rtld_map) ; else __assert_fail ("(l)->l_name[0] == '\\0' || IS_RTLD (l)", "dl-load.c", 395, __extension__ __PRETTY_FUNCTION__); })); (l)->l_origin = _dl_get_origin (); dst_len = ((l)->l_origin && (l)->l_origin != (char *) -1 ? strlen ((l)->l_origin) : 0); } else dst_len = (l)->l_origin == (char *) -1 ? 0 : strlen ((l)->l_origin); dst_len = ((((((dst_len)>(_rtld_local_ro._dl_platformlen))?(dst_len):(_rtld_local_ro._dl_platformlen)))>(strlen ("lib")))?((((dst_len)>(_rtld_local_ro._dl_platformlen))?(dst_len):(_rtld_local_ro._dl_platformlen))):(strlen ("lib"))); if (dst_len > 4) __len += __cnt * (dst_len - 4); } __len; });
...
# 417 "dl-load.c"
             ;
  for (lnp = l->l_libname; lnp != 
# 418 "dl-load.c" 3 4
                                 ((void *)0)
# 418 "dl-load.c"
                                     ; lastp = lnp, lnp = lnp->next)
...
# 431 "dl-load.c" 3 4
 ((void *)0)
# 431 "dl-load.c"
 ) ? 1 : 0), __extension__ ({ if (lastp != 
# 431 "dl-load.c" 3 4
 ((void *)0)
# 431 "dl-load.c"
 ) ; else __assert_fail ("lastp != NULL", "dl-load.c", 431, __extension__ __PRETTY_FUNCTION__); }));
...
static struct r_search_path_struct rtld_search_dirs __attribute__ ((section (".data.rel.ro")));
...
# 464 "dl-load.c"
   ...
   if (len > 0 && cp[len - 1] != '/')
     cp[len++] = '/';
      ...
      for (dirp = _rtld_local._dl_all_dirs; dirp != 
# 486 "dl-load.c" 3 4
                                          ((void *)0)
# 486 "dl-load.c"
                                              ; dirp = dirp->next)
...
# 512 "dl-load.c"
   ...
   *((char *) __builtin_mempcpy ((char *) dirp->dirname, cp, len)) = '\0';
   dirp->dirnamelen = len;
...
# 536 "dl-load.c"
   ...
   dirp->next = _rtld_local._dl_all_dirs;
   _rtld_local._dl_all_dirs = dirp;
...
# 564 "dl-load.c"
  ...
  if (__builtin_expect ((_rtld_local_ro._dl_inhibit_rpath != 
# 568 "dl-load.c" 3 4
     ((void *)0)
# 568 "dl-load.c"
     ), 0)
    ...
    {
      const char *inhp = _rtld_local_ro._dl_inhibit_rpath;
...
# 607 "dl-load.c"
    ...
    {
      errstring = "cannot create RUNPATH/RPATH copy";
      goto signal_error;
    }
...
# 623 "dl-load.c"
    ...
    {
      free (copy);
      errstring = "cannot create cache for search path";
    signal_error:
      _dl_signal_error (
# 628 "dl-load.c" 3 4
                       12
...
# 669 "dl-load.c"
  ...
  return decompose_rpath (sp, (const char *) ((l)->l_info[5]->d_un.d_ptr
...
_dl_init_paths (const char *llp)
{
  ...
  size_t round_size;
  struct link_map __attribute__ ((unused)) *l = 
# 686 "dl-load.c" 3 4
                                               ((void *)0)
# 686 "dl-load.c"
                                                   ;
...
# 688 "dl-load.c"
  ...
  capstr = _dl_important_hwcaps (_rtld_local_ro._dl_platform, _rtld_local_ro._dl_platformlen,
     &ncapstr, &max_capstrlen);


  aelem = rtld_search_dirs.dirs = (struct r_search_path_elem **)
    malloc ((__extension__ ({ _Static_assert (!__builtin_types_compatible_p (__typeof (system_dirs_len), __typeof (&(system_dirs_len)[0])), "argument must be an array"); sizeof (system_dirs_len) / sizeof ((system_dirs_len)[0]); }) + 1) * sizeof (struct r_search_path_elem *));
  if (rtld_search_dirs.dirs == 
# 700 "dl-load.c" 3 4
                              ((void *)0)
# 700 "dl-load.c"
                                  )
    {
      errstring = "cannot create search path array";
    signal_error:
      _dl_signal_error (
# 704 "dl-load.c" 3 4
                       12
...
# 704 "dl-load.c"
  ...
  rtld_search_dirs.dirs[0] = malloc (__extension__ ({ _Static_assert (!__builtin_types_compatible_p (__typeof (system_dirs_len), __typeof (&(system_dirs_len)[0])), "argument must be an array"); sizeof (system_dirs_len) / sizeof ((system_dirs_len)[0]); }) * round_size
         * sizeof (*rtld_search_dirs.dirs[0]));
  if (rtld_search_dirs.dirs[0] == 
# 713 "dl-load.c" 3 4
                                 ((void *)0)
# 713 "dl-load.c"
                                     )
  ...
  pelem = _rtld_local._dl_all_dirs = rtld_search_dirs.dirs[0];
  strp = system_dirs;
  idx = 0;
...
# 731 "dl-load.c"
      ...
      ((void) sizeof ((pelem->dirname[0] == '/') ? 1 : 0), __extension__ ({ if (pelem->dirname[0] == '/') ; else __assert_fail ("pelem->dirname[0] == '/'", "dl-load.c", 738, __extension__ __PRETTY_FUNCTION__); }));
      for (cnt = 0; cnt < ncapstr; ++cnt)
 pelem->status[cnt] = unknown;

      pelem->next = (++idx == __extension__ ({ _Static_assert (!__builtin_types_compatible_p (__typeof (system_dirs_len), __typeof (&(system_dirs_len)[0])), "argument must be an array"); sizeof (system_dirs_len) / sizeof ((system_dirs_len)[0]); }) ? 
# 742 "dl-load.c" 3 4
                                                ((void *)0) 
# 742 "dl-load.c"
                                                     : (pelem + round_size));
  ...
  while (idx < __extension__ ({ _Static_assert (!__builtin_types_compatible_p (__typeof (system_dirs_len), __typeof (&(system_dirs_len)[0])), "argument must be an array"); sizeof (system_dirs_len) / sizeof ((system_dirs_len)[0]); }));
...
# 749 "dl-load.c"
  ...
  l = _rtld_local._dl_ns[0]._ns_loaded;
  if (l != 
# 754 "dl-load.c" 3 4
          ((void *)0)
# 754 "dl-load.c"
    ...
    {
      ((void) sizeof ((l->l_type != lt_loaded) ? 1 : 0), __extension__ ({ if (l->l_type != lt_loaded) ; else __assert_fail ("l->l_type != lt_loaded", "dl-load.c", 756, __extension__ __PRETTY_FUNCTION__); }));
      ...
      if (l->l_info[29])
 {
   ...
   decompose_rpath (&l->l_runpath_dirs,
      (const void *) ((l)->l_info[5]->d_un.d_ptr
        + l->l_info[29]->d_un.d_val),
      l, "RUNPATH");
...
# 796 "dl-load.c"
                 && *llp != '\0')
    {
      char *llp_tmp = (__extension__ ({ const char *__old = (llp); size_t __len = strlen (__old) + 1; char *__new = (char *) __builtin_alloca (__len); (char *) memcpy (__new, __old, __len); }));
...
# 877 "dl-load.c"
  ...
  struct r_file_id id;
  if (__builtin_expect ((!_dl_get_file_id (fd, &id)), 0))
    {
...
# 888 "dl-load.c"
  ...
  for (l = _rtld_local._dl_ns[nsid]._ns_loaded; l != 
# 892 "dl-load.c" 3 4
                                           ((void *)0)
# 892 "dl-load.c"
                                               ; l = l->l_next)
 ...
 return l;
  ...
  if (__builtin_expect ((nsid != 0), 0)
      && (_dl_file_id_match_p (&id, &_rtld_local._dl_rtld_map.l_file_id)
   || _dl_name_match_p (name, &_rtld_local._dl_rtld_map)))
    {
...
# 917 "dl-load.c"
 ...
 goto fail_new;
      ...
      l->l_real = &_rtld_local._dl_rtld_map;
...
# 966 "dl-load.c"
  if (r->r_state == RT_CONSISTENT)
   ...
   && __builtin_expect ((_rtld_local_ro._dl_naudit > 0), 0))
 {
   struct link_map *head = _rtld_local._dl_ns[nsid]._ns_loaded;
...
# 995 "dl-load.c"
    ...
    ((void) sizeof ((r->r_state == RT_ADD) ? 1 : 0), __extension__ ({ if (r->r_state == RT_ADD) ; else __assert_fail ("r->r_state == RT_ADD", "dl-load.c", 998, __extension__ __PRETTY_FUNCTION__); }));
...
# 1002 "dl-load.c"
    ...
    fail_new:
      ...
      errstring = "cannot create shared object descriptor";
  ...
  maplength = header->e_phnum * sizeof (Elf64_Phdr);
  if (header->e_phoff + maplength <= (size_t) fbp->len)
    phdr = (void *) (fbp->buf + header->e_phoff);
  else
    {
      phdr = __builtin_alloca (maplength);
      __lseek (fd, header->e_phoff, 0);
      if ((size_t) __read_nocancel (fd, (void *) phdr, maplength) != maplength)
 {
   ...
   uint_fast16_t stack_flags = ((1 << 2)|(1 << 1)|(1 << 0));
...
# 1040 "dl-load.c"
 ...
 case 1:
   ...
   if (__builtin_expect (((ph->p_align & (_rtld_local_ro._dl_pagesize - 1)) != 0), 0))
     {
  ...
  = "ELF load command address/offset not properly aligned";
   ...
   c->mapstart = ((ph->p_vaddr) & -((__typeof__ (ph->p_vaddr)) (_rtld_local_ro._dl_pagesize)));
   c->mapend = (((ph->p_vaddr + ph->p_filesz) + (_rtld_local_ro._dl_pagesize) - 1) & -((__typeof__ ((ph->p_vaddr + ph->p_filesz) + (_rtld_local_ro._dl_pagesize) - 1)) ((_rtld_local_ro._dl_pagesize))));
   c->dataend = ph->p_vaddr + ph->p_filesz;
   c->allocend = ph->p_vaddr + ph->p_memsz;
   c->mapoff = ((ph->p_offset) & -((__typeof__ (ph->p_offset)) (_rtld_local_ro._dl_pagesize)));
...
# 1093 "dl-load.c"
   ...
   c->prot = (((0x1 << ((1 << 2) * 4)) | (0x2 << ((1 << 1) * 4)) | (0x4 << ((1 << 0) * 4)) | ((0x1 | 0x2) << (((1 << 2) | (1 << 1)) * 4)) | ((0x1 | 0x4) << (((1 << 2) | (1 << 0)) * 4)) | ((0x2 | 0x4) << ((1 << 1) | (1 << 0)) * 4) | ((0x1 | 0x2 | 0x4) << (((1 << 2) | (1 << 1) | (1 << 0)) * 4)))
...
# 1108 "dl-load.c"
 ...
 case 7:
   ...
   if (__builtin_expect ((l->l_type == lt_library), 1)
       ...
       || __builtin_expect ((_rtld_local._dl_tls_dtv_slotinfo_list != 
# 1131 "dl-load.c" 3 4
         ((void *)0)
# 1131 "dl-load.c"
         ), 1))
   ...
   ((void) sizeof ((l->l_prev == 
# 1143 "dl-load.c" 3 4
  ((void *)0) 
# 1143 "dl-load.c"
  || (mode & 0x08000000) != 0) ? 1 : 0), __extension__ ({ if (l->l_prev == 
# 1143 "dl-load.c" 3 4
  ((void *)0) 
# 1143 "dl-load.c"
  || (mode & 0x08000000) != 0) ; else __assert_fail ("l->l_prev == NULL || (mode & __RTLD_AUDIT) != 0", "dl-load.c", 1143, __extension__ __PRETTY_FUNCTION__); }));
 ...
 case 4:
   if (_dl_process_pt_note (l, ph, fd, fbp))
     {
       errstring = "cannot process note segment";
       goto call_lose;
     }
   break;
 }
 ...
 && __builtin_expect (((mode & 0x20000000) == 0), 0))
      {


 errstring = "cannot dynamically load executable";
 goto call_lose;
      }
...
# 1209 "dl-load.c"
  ...
  if (__builtin_expect ((l->l_flags_1 & 0x00000040), 0)
      && (mode & 0x80000000))
    {
 ...
 free ((void *) l->l_phdr);
      ...
      errstring = "shared object cannot be dlopen()ed";
      goto call_lose;
    }
...
# 1229 "dl-load.c"
                      )
    {
      ...
      Elf64_Phdr *newp = (Elf64_Phdr *) malloc (header->e_phnum
      * sizeof (Elf64_Phdr));
      if (newp == 
# 1236 "dl-load.c" 3 4
                 ((void *)0)
# 1236 "dl-load.c"
                     )
 {
  ...
  if (__builtin_expect (((stack_flags &~ _rtld_local._dl_stack_flags) & (1 << 0)), 0))
    {
      ...
      if ((mode & (0x80000000 | 0x08000000)) == 0x80000000)
 {
   const uintptr_t p = (uintptr_t) &__stack_prot & -_rtld_local_ro._dl_pagesize;
   const size_t s = (uintptr_t) (&__stack_prot + 1) - p;

   struct link_map *const m = &_rtld_local._dl_rtld_map;
   const uintptr_t relro_end = ((m->l_addr + m->l_relro_addr
     + m->l_relro_size)
           & -_rtld_local_ro._dl_pagesize);
   if (__builtin_expect ((p + s <= relro_end), 1))
     {

       if (__mprotect ((void *) p, s, 0x1|0x2) < 0)
  {
    errstring = "cannot change memory protections";
    goto call_lose_errno;
  }
       __stack_prot |= 0x1|0x2|0x4;
       __mprotect ((void *) p, s, 0x1);
     }
   else
     __stack_prot |= 0x1|0x2|0x4;
 }
 ...
 __stack_prot |= 0x1|0x2|0x4;
      ...
      errval = (*_rtld_local._dl_make_stack_executable_hook) (stack_endp);
      if (errval)
 {
   errstring = "cannot enable executable stack as shared object requires"
                                                          ;
   goto call_lose;
 }
    }
...
# 1298 "dl-load.c"
  ...
  if (__builtin_expect ((__close_nocancel (fd) != 0), 0))
    {
  ...
  ((void) sizeof ((type != 2 || l->l_type == lt_executable) ? 1 : 0), __extension__ ({ if (type != 2 || l->l_type == lt_executable) ; else __assert_fail ("type != ET_EXEC || l->l_type == lt_executable", "dl-load.c", 1311, __extension__ __PRETTY_FUNCTION__); }));
...
# 1336 "dl-load.c"
  ...
  if (l->l_flags_1 & 0x00000020)
    _rtld_local._dl_initfirst = l;
...
# 1372 "dl-load.c"
  if (__builtin_expect ((_rtld_local_ro._dl_profile != 
# 1372 "dl-load.c" 3 4
     ((void *)0)
# 1372 "dl-load.c"
     ), 0)
...
# 1373 "dl-load.c"
    ...
    add_name_to_object (l, ((const char *) (l)->l_info[5]->d_un.d_ptr
  ...
  if (__builtin_expect ((_rtld_local_ro._dl_naudit > 0), 0)
      && !_rtld_local._dl_ns[l->l_ns]._ns_loaded->l_auditing)
    {
      struct audit_ifaces *afct = _rtld_local_ro._dl_audit;
      for (unsigned int cnt = 0; cnt < _rtld_local_ro._dl_naudit; ++cnt)
 {
...
# 1418 "dl-load.c"
                      && (*list)->what == what)
    {
      char *endp = __builtin_mempcpy (buf, (*list)->dirname, (*list)->dirnamelen);
      size_t cnt;

      for (cnt = 0; cnt < ncapstr; ++cnt)
 if ((*list)->status[cnt] != nonexisting)
   {
     char *cp = __builtin_mempcpy (endp, capstr[cnt].str, capstr[cnt].len);
...
# 1439 "dl-load.c"
   ...
   ((name)[0] ? (name) : (_dl_argv[0] ?: "<main program>")));
  else
...
{
# 1467 "dl-load.c"
  static const unsigned char expected2[9] = { [0] = 0x7f, [1] = 'E', [2] = 'L', [3] = 'F', [4] = 2, [5] = 1, [6] = 1, [7] = 3 };
...
# 1489 "dl-load.c"
  ...
  if (__builtin_expect ((_rtld_local_ro._dl_naudit > 0), 0) && whatcode != 0
      && loader->l_auditing == 0)
    {
...
# 1505 "dl-load.c"
  ...
  if (fd == -1)
    ...
    fd = __open64_nocancel (name, 00 | 02000000);
...
# 1532 "dl-load.c"
      ...
      (rtld_errno = (0));
      fbp->len = 0;
      ((void) sizeof ((sizeof (fbp->buf) > sizeof (Elf64_Ehdr)) ? 1 : 0), __extension__ ({ if (sizeof (fbp->buf) > sizeof (Elf64_Ehdr)) ; else __assert_fail ("sizeof (fbp->buf) > sizeof (ElfW(Ehdr))", "dl-load.c", 1540, __extension__ __PRETTY_FUNCTION__); }));
      ...
      do
 {
   ...
   fbp->len += retlen;
      ...
      while (__builtin_expect ((fbp->len < sizeof (Elf64_Ehdr)), 0));


      ehdr = (Elf64_Ehdr *) fbp->buf;


      if (__builtin_expect ((fbp->len < (ssize_t) sizeof (Elf64_Ehdr)), 0))
 {
   errval = rtld_errno;
   errstring = (errval == 0
         ? "file too short" : "cannot read file data");
 call_lose:
   if (free_name)
     {
       char *realname = (char *) name;
       name = (__extension__ ({ const char *__old = (realname); size_t __len = strlen (__old) + 1; char *__new = (char *) __builtin_alloca (__len); (char *) memcpy (__new, __old, __len); }));
       free (realname);
     }
   lose (errval, fd, name, 
# 1568 "dl-load.c" 3 4
...
# 1568 "dl-load.c"
      ...
      if (__builtin_expect ((! (memcmp (ehdr->e_ident, expected, 8) == 0 || memcmp (ehdr->e_ident, expected2, 8) == 0) || !(ehdr->e_ident[8] == 0 || (ehdr->e_ident[7] == 3 && ehdr->e_ident[8] < LIBC_ABI_MAX)) || memcmp (&ehdr->e_ident[9], &expected[9], (16) - 9) != 0), 0)
...
# 1601 "dl-load.c"
  ...
  errstring = "ELF file data encoding not little-endian";
   ...
   else if (ehdr->e_ident[6] != 1)
     errstring
       = "ELF file version ident does not match current one";


   else if (!(ehdr->e_ident[7] == 0 || ehdr->e_ident[7] == 3))
     errstring = "ELF file OS ABI invalid";
   else if (!(ehdr->e_ident[8] == 0 || (ehdr->e_ident[7] == 3 && ehdr->e_ident[8] < LIBC_ABI_MAX))
                                    )
     errstring = "ELF file ABI version invalid";
   else if (memcmp (&ehdr->e_ident[9], &expected[9],
      (16) - 9) != 0)
   ...
   goto call_lose;
      ...
      if (__builtin_expect ((ehdr->e_version != 1), 0))
 {
 ...
 goto close_and_out;
      else if (__builtin_expect ((ehdr->e_type != 3 && ehdr->e_type != 2), 0)
                                )
 {
   errstring = "only ET_DYN and ET_EXEC can be loaded";
   goto call_lose;
 }
      else if (__builtin_expect ((ehdr->e_type == 2 && (mode & 0x20000000) == 0), 0)
                                      )
 {
   ...
   goto call_lose;
      ...
      else if (__builtin_expect ((ehdr->e_phentsize != sizeof (Elf64_Phdr)), 0))
 {
   errstring = "ELF file's phentsize not the expected size";
   goto call_lose;
 }

      maplength = ehdr->e_phnum * sizeof (Elf64_Phdr);
      if (ehdr->e_phoff + maplength <= (size_t) fbp->len)
 phdr = (void *) (fbp->buf + ehdr->e_phoff);
      else
 {
   phdr = __builtin_alloca (maplength);
   __lseek (fd, ehdr->e_phoff, 0);
   if ((size_t) __read_nocancel (fd, (void *) phdr, maplength)
     ...
     read_error:
      ...
      if (__builtin_expect ((elf_machine_reject_phdr_p (phdr, ehdr->e_phnum, fbp->buf, fbp->len, loader, fd)), 0)
 ...
 if (ph->p_type == 4 && ph->p_filesz >= 32 && ph->p_align >= 4)
   {
     Elf64_Addr size = ph->p_filesz;
  ...
  if (size < 65536)
    abi_note = __builtin_alloca (size);
  else
    {

      abi_note_malloced = realloc (abi_note_malloced, size);
      if (abi_note_malloced == 
# 1713 "dl-load.c" 3 4
                              ((void *)0)
# 1713 "dl-load.c"
                                  )
  ...
  abi_note = (void *) abi_note + note_size;
   ...
   + (abi_note[7] & 0xff);
     if (abi_note[4] != 0
  || (_rtld_local_ro._dl_osversion && _rtld_local_ro._dl_osversion < osversion))
       {
       close_and_out:
  __close_nocancel (fd);
  (rtld_errno = (
...
# 1783 "dl-load.c"
  ...
  buf = __builtin_alloca (max_dirnamelen + max_capstrlen + namelen);
  do
    {
   ...
   && current_what != this_dir->what)
 {
   ...
   print_search_path (dirs, current_what, this_dir->where);
      ...
      edp = (char *) __builtin_mempcpy (buf, this_dir->dirname, this_dir->dirnamelen);
      for (cnt = 0; fd == -1 && cnt < ncapstr; ++cnt)
 {
   ...
   buflen =
     ((char *) __builtin_mempcpy (__builtin_mempcpy (edp, capstr[cnt].str, capstr[cnt].len), name, namelen)
...
# 1834 "dl-load.c"
        || _rtld_local._dl_ns[loader->l_ns]._ns_loaded->l_auditing == 0)
  {
   ...
   if (fd != -1 && __builtin_expect ((mode & 0x04000000), 0)
       && __libc_enable_secure)
     {
...
# 1926 "dl-load.c"
  ...
  ((void) sizeof ((nsid >= 0) ? 1 : 0), __extension__ ({ if (nsid >= 0) ; else __assert_fail ("nsid >= 0", "dl-load.c", 1932, __extension__ __PRETTY_FUNCTION__); }));
  ((void) sizeof ((nsid < _rtld_local._dl_nns) ? 1 : 0), __extension__ ({ if (nsid < _rtld_local._dl_nns) ; else __assert_fail ("nsid < GL(dl_nns)", "dl-load.c", 1933, __extension__ __PRETTY_FUNCTION__); }));


  for (l = _rtld_local._dl_ns[nsid]._ns_loaded; l; l = l->l_next)
    {



      if (__builtin_expect (((l->l_faked | l->l_removed) != 0), 0))
 continue;
...
# 1948 "dl-load.c"
   ...
   soname = ((const char *) (l)->l_info[5]->d_un.d_ptr
      + l->l_info[14]->d_un.d_val);
...
# 1967 "dl-load.c"
    ...
    _dl_debug_printf ((mode & 0x10000000) == 0
        ? "\nfile=%s [%lu];  needed by %s [%lu]\n"
        : "\nfile=%s [%lu];  dynamically loaded by %s [%lu]\n",
        name, nsid, ((loader->l_name)[0] ? (loader->l_name) : (_dl_argv[0] ?: "<main program>")), loader->l_ns);
...
# 2025 "dl-load.c"
                                                             )
 {
   ...
   struct link_map *main_map = _rtld_local._dl_ns[0]._ns_loaded;
...
# 2030 "dl-load.c"
   ...
   for (l = loader; l; l = l->l_loader)
     if (cache_rpath (l, &l->l_rpath_dirs, 15, "RPATH"))
       {
...
# 2050 "dl-load.c"
       ...
       && cache_rpath (main_map, &main_map->l_rpath_dirs, 15,
         "RPATH"))
     fd = open_path (name, namelen, mode,
 ...
 fd = open_path (name, namelen, mode, &env_path_list,
   &realname, &fb,
   loader ?: _rtld_local._dl_ns[0]._ns_loaded,
...
# 2077 "dl-load.c"
                             )
            {
              fd = open_verify (realname, fd,
                                &fb, loader ?: _rtld_local._dl_ns[nsid]._ns_loaded,
...
# 2082 "dl-load.c"
      ...
      if (fd == -1
   && (__builtin_expect (((mode & 0x04000000) == 0), 1)
       || ! __libc_enable_secure)
   && __builtin_expect ((_rtld_local_ro._dl_inhibit_cache == 0), 1))
 {
...
# 2098 "dl-load.c"
                    )
     {
       ...
       l = (loader
     ?: _rtld_local._dl_ns[0]._ns_loaded
     ...
     ?: &_rtld_local._dl_rtld_map
       ...
       if (__builtin_expect ((l->l_flags_1 & 0x00000800), 0))
  {
...
# 2121 "dl-load.c"
    ...
    while (cnt < __extension__ ({ _Static_assert (!__builtin_types_compatible_p (__typeof (system_dirs_len), __typeof (&(system_dirs_len)[0])), "argument must be an array"); sizeof (system_dirs_len) / sizeof ((system_dirs_len)[0]); }));
  }
...
# 2136 "dl-load.c"
    ...
    if (__builtin_expect ((fd != -1), 1))
      ...
      if (fd == -1
   && ((l = loader ?: _rtld_local._dl_ns[nsid]._ns_loaded) == 
# 2148 "dl-load.c" 3 4
                                                    ((void *)0)
       
# 2149 "dl-load.c"
      || __builtin_expect ((!(l->l_flags_1 & 0x00000800)), 1))
...
# 2164 "dl-load.c"
      ...
      else
 {
   fd = open_verify (realname, -1, &fb,
       loader ?: _rtld_local._dl_ns[nsid]._ns_loaded, 0, mode,
       &found_other_class, 
# 2170 "dl-load.c" 3 4
                          1
# 2170 "dl-load.c"
...
# 2183 "dl-load.c"
  ...
  if (__builtin_expect ((fd == -1), 0))
    {
      if (trace_mode
   && __builtin_expect (((_rtld_local_ro._dl_debug_mask & (1 << 11)) == 0), 1))
 {




   static const Elf_Symndx dummy_bucket = 0;


   if ((name_copy = __strdup (name)) == 
# 2197 "dl-load.c" 3 4
                                       ((void *)0)
...
# 2220 "dl-load.c"
 ...
 _dl_signal_error (rtld_errno, name, 
# 2225 "dl-load.c" 3 4
                               ((void *)0)
# 2225 "dl-load.c"
                                   ,
   ...
   unsigned int flags)
{
      ...
      do
 {
   ...
   if (p->counting)
     {
       p->si->dls_cnt++;
       p->si->dls_size += (((2)>(r->dirnamelen))?(2):(r->dirnamelen));
     }
   else
     {
  ...
  *p->allocptr++ = r->dirnamelen ? '/' : '.';
  ...
  p->allocptr = __builtin_mempcpy (p->allocptr, r->dirname, r->dirnamelen - 1)
                                     ;
       *p->allocptr++ = '\0';
       sp->dls_flags = flags;
     }
...
void
_dl_rtld_di_serinfo (struct link_map *loader, Dl_serinfo *si, 
# 2275 "dl-load.c" 3 4
                                                             _Bool 
# 2275 "dl-load.c"
                                                                  counting)
...
# 2312 "dl-load.c"
  ...
  add_path(&p, &env_path_list, 0);


  if (cache_rpath (loader, &loader->l_runpath_dirs, 29, "RUNPATH"))
    add_path(&p, &loader->l_runpath_dirs, 0);
  ...
  if (!(loader->l_flags_1 & 0x00000800))
    add_path(&p, &rtld_search_dirs, 0);
