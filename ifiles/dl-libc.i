...
extern int __libc_argc __attribute__ ((visibility ("hidden")));
extern char **__libc_argv __attribute__ ((visibility ("hidden")));
...
do_dlopen (void *ptr)
{
  ...
  args->map = _rtld_global_ro._dl_open (args->name, args->mode, args->caller_dlopen,
        -2, __libc_argc, __libc_argv,
        __environ);
}
...
# 105 "dl-libc.c"
                 ;
  args->loadbase = _rtld_global_ro._dl_lookup_symbol_x (args->name, args->map, &args->ref,
...
# 115 "dl-libc.c"
                       ;
  args->dlsym.loadbase
    = _rtld_global_ro._dl_lookup_symbol_x (args->dlsym.name, args->dlsym.map,
    &args->dlsym.ref,
...
do_dlclose (void *ptr)
{
  _rtld_global_ro._dl_close ((struct link_map *) ptr);
}
...
extern __typeof (_dl_open_hook) _dl_open_hook __asm__ ("" "__GI__dl_open_hook") __attribute__ ((visibility ("hidden")));;
struct dl_open_hook *_dl_open_hook __attribute__ ((nocommon));
extern __typeof (_dl_open_hook) __EI__dl_open_hook __asm__("" "_dl_open_hook"); extern __typeof (_dl_open_hook) __EI__dl_open_hook __attribute__((alias ("" "__GI__dl_open_hook")));;




extern struct dl_open_hook *_dl_open_hook2;
extern __typeof (_dl_open_hook2) _dl_open_hook2 __asm__ ("" "__GI__dl_open_hook2") __attribute__ ((visibility ("hidden")));;
struct dl_open_hook *_dl_open_hook2 __attribute__ ((nocommon));
extern __typeof (_dl_open_hook2) __EI__dl_open_hook2 __asm__("" "_dl_open_hook2"); extern __typeof (_dl_open_hook2) __EI__dl_open_hook2 __attribute__((alias ("" "__GI__dl_open_hook2")));;
# 184 "dl-libc.c"
void *
__libc_dlopen_mode (const char *name, int mode)
{
  ...
  args.name = name;
  args.mode = mode;
  args.caller_dlopen = __builtin_extract_return_addr (__builtin_return_address (0));


  if (!rtld_active ())
    return _dl_open_hook->dlopen_mode (name, mode);
  return (dlerror_run (do_dlopen, &args) ? 
# 195 "dl-libc.c" 3 4
                                          ((void *)0) 
# 195 "dl-libc.c"
                                               : (void *) args.map);
...
extern __typeof (__libc_dlopen_mode) __EI___libc_dlopen_mode __asm__("" "__libc_dlopen_mode"); extern __typeof (__libc_dlopen_mode) __EI___libc_dlopen_mode __attribute__((alias ("" "__GI___libc_dlopen_mode")));
# 236 "dl-libc.c"
void *
__libc_dlsym (void *map, const char *name)
{
  ...
  return (dlerror_run (do_dlsym, &args) ? 
# 247 "dl-libc.c" 3 4
                                         ((void *)0)
...
# 248 "dl-libc.c" 3 4
              ((void *)0) 
# 248 "dl-libc.c"
              ? 0 : (__builtin_expect (((args.ref)->st_shndx == 0xfff1), 0) ? 0 : ((
# 248 "dl-libc.c" 3 4
              0
# 248 "dl-libc.c"
              ) || (args.loadbase) ? (args.loadbase)->l_addr : 0)) + (args.ref)->st_value)));
}
extern __typeof (__libc_dlsym) __EI___libc_dlsym __asm__("" "__libc_dlsym"); extern __typeof (__libc_dlsym) __EI___libc_dlsym __attribute__((alias ("" "__GI___libc_dlsym")));
...
# 277 "dl-libc.c"
  ...
  return (dlerror_run (do_dlvsym, &args) ? 
# 279 "dl-libc.c" 3 4
                                          ((void *)0)
   
# 280 "dl-libc.c"
  : (void *) ((void *) ((args.dlsym.ref) == 
# 280 "dl-libc.c" 3 4
              ((void *)0) 
# 280 "dl-libc.c"
              ? 0 : (__builtin_expect (((args.dlsym.ref)->st_shndx == 0xfff1), 0) ? 0 : ((
# 280 "dl-libc.c" 3 4
              0
# 280 "dl-libc.c"
              ) || (args.dlsym.loadbase) ? (args.dlsym.loadbase)->l_addr : 0)) + (args.dlsym.ref)->st_value)
                     ));
}
extern __typeof (__libc_dlvsym) __EI___libc_dlvsym __asm__("" "__libc_dlvsym"); extern __typeof (__libc_dlvsym) __EI___libc_dlvsym __attribute__((alias ("" "__GI___libc_dlvsym")));
...
extern __typeof (__libc_dlclose) __EI___libc_dlclose __asm__("" "__libc_dlclose"); extern __typeof (__libc_dlclose) __EI___libc_dlclose __attribute__((alias ("" "__GI___libc_dlclose")));
...
static void free_mem (void) __attribute__ ((__used__)) __attribute__ ((section ("__libc_freeres_fn"))); static const void *__elf_set___libc_subfreeres_element_free_mem__ __attribute__ ((used, section ("__libc_subfreeres"))) = &(free_mem); static void free_mem (void)
{
  struct link_map *l;
  struct r_search_path_elem *d;


  d = _rtld_global._dl_all_dirs;
  while (d != _rtld_global_ro._dl_init_all_dirs)
    {
  ...
  for (Lmid_t ns = 0; ns < _rtld_global._dl_nns; ++ns)
    {
      for (l = _rtld_global._dl_ns[ns]._ns_loaded; l != 
# 341 "dl-libc.c" 3 4
                                             ((void *)0)
# 341 "dl-libc.c"
                                                 ; l = l->l_next)
...
# 359 "dl-libc.c"
      ...
      if (__builtin_expect (_rtld_global._dl_ns[ns]._ns_global_scope_alloc, 0) != 0
   && (_rtld_global._dl_ns[ns]._ns_main_searchlist->r_nlist

       == _rtld_global_ro._dl_initial_searchlist.r_nlist))
 {


   struct link_map **old = _rtld_global._dl_ns[ns]._ns_main_searchlist->r_list;


   _rtld_global._dl_ns[ns]._ns_main_searchlist->r_list

     = _rtld_global_ro._dl_initial_searchlist.r_list;

   _rtld_global._dl_ns[ns]._ns_global_scope_alloc = 0;
  ...
  if (_rtld_global._dl_initial_dtv == 
# 386 "dl-libc.c" 3 4
                           ((void *)0)
# 386 "dl-libc.c"
                               )
    ...
    free_slotinfo (&_rtld_global._dl_tls_dtv_slotinfo_list);
  else




    free_slotinfo (&_rtld_global._dl_tls_dtv_slotinfo_list->next);

  void *scope_free_list = _rtld_global._dl_scope_free_list;
  _rtld_global._dl_scope_free_list = 
# 398 "dl-libc.c" 3 4
                          ((void *)0)
# 398 "dl-libc.c"
                              ;
