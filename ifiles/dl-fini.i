...
# 47 "dl-fini.c"
 ...
 again:
  ...
  for (Lmid_t ns = _rtld_local._dl_nns - 1; ns >= 0; --ns)
    {

      _rtld_local._dl_rtld_lock_recursive (&(_rtld_local._dl_load_lock).mutex);

      unsigned int nloaded = _rtld_local._dl_ns[ns]._ns_nloaded;


      if (nloaded == 0

   || _rtld_local._dl_ns[ns]._ns_loaded->l_auditing != do_audit
      ...
      else
 {
   ...
   unsigned int i;
   struct link_map *l;
   ((void) sizeof ((nloaded != 0 || _rtld_local._dl_ns[ns]._ns_loaded == 
# 72 "dl-fini.c" 3 4
  ((void *)0)
# 72 "dl-fini.c"
  ) ? 1 : 0), __extension__ ({ if (nloaded != 0 || _rtld_local._dl_ns[ns]._ns_loaded == 
# 72 "dl-fini.c" 3 4
  ((void *)0)
# 72 "dl-fini.c"
  ) ; else __assert_fail ("nloaded != 0 || GL(dl_ns)[ns]._ns_loaded == NULL", "dl-fini.c", 72, __extension__ __PRETTY_FUNCTION__); }));
   for (l = _rtld_local._dl_ns[ns]._ns_loaded, i = 0; l != 
# 73 "dl-fini.c" 3 4
                                                 ((void *)0)
# 73 "dl-fini.c"
                                                     ; l = l->l_next)
     ...
     if (l == l->l_real)
       {
  ((void) sizeof ((i < nloaded) ? 1 : 0), __extension__ ({ if (i < nloaded) ; else __assert_fail ("i < nloaded", "dl-fini.c", 77, __extension__ __PRETTY_FUNCTION__); }));
  ...
  ++l->l_direct_opencount;
   ...
   ((void) sizeof ((ns != 0 || i == nloaded) ? 1 : 0), __extension__ ({ if (ns != 0 || i == nloaded) ; else __assert_fail ("ns != LM_ID_BASE || i == nloaded", "dl-fini.c", 87, __extension__ __PRETTY_FUNCTION__); }));
   ((void) sizeof ((ns == 0 || i == nloaded || i == nloaded - 1) ? 1 : 0), __extension__ ({ if (ns == 0 || i == nloaded || i == nloaded - 1) ; else __assert_fail ("ns == LM_ID_BASE || i == nloaded || i == nloaded - 1", "dl-fini.c", 88, __extension__ __PRETTY_FUNCTION__); }));
   unsigned int nmaps = i;




   _dl_sort_maps (maps + (ns == 0), nmaps - (ns == 0),
...
# 130 "dl-fini.c"
                                           )
   {
     Elf64_Addr *array =
       (Elf64_Addr *) (l->l_addr
         + l->l_info[26]->d_un.d_ptr);
     unsigned int i = (l->l_info[28]->d_un.d_val
         / sizeof (Elf64_Addr));
     while (i-- > 0)
       ((fini_t) array[i]) ();
   }
...
# 142 "dl-fini.c"
   ...
   ((fini_t) (l->l_addr + l->l_info[13]->d_un.d_ptr)) ()
                                                    ;
      }



    if (!do_audit && __builtin_expect (_rtld_local_ro._dl_naudit > 0, 0))
      {
...
# 154 "dl-fini.c"
  ...
  if (! do_audit && _rtld_local_ro._dl_naudit > 0)
    {
      do_audit = 1;
      goto again;
    }
