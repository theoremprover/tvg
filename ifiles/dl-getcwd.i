# 1 "../sysdeps/unix/sysv/linux/dl-getcwd.c"
...
# 1 "<command-line>" 2
# 1 "../sysdeps/unix/sysv/linux/dl-getcwd.c"
# 1 "../sysdeps/unix/sysv/linux/getcwd.c" 1
# 20 "../sysdeps/unix/sysv/linux/getcwd.c"
...
# 21 "../sysdeps/unix/sysv/linux/getcwd.c" 2
# 1 "../include/errno.h" 1
...
# 22 "../sysdeps/unix/sysv/linux/getcwd.c" 2
...
# 23 "../sysdeps/unix/sysv/linux/getcwd.c" 2
...
# 24 "../sysdeps/unix/sysv/linux/getcwd.c" 2
...
# 25 "../sysdeps/unix/sysv/linux/getcwd.c" 2
...
# 26 "../sysdeps/unix/sysv/linux/getcwd.c" 2
...
# 24 "../sysdeps/unix/sysv/linux/lowlevellock-futex.h"
# 1 "../sysdeps/x86_64/nptl/tls.h" 1
# 25 "../sysdeps/unix/sysv/linux/lowlevellock-futex.h" 2
# 1 "../sysdeps/unix/sysv/linux/x86_64/kernel-features.h" 1
# 26 "../sysdeps/unix/sysv/linux/x86_64/kernel-features.h"
# 1 "../sysdeps/unix/sysv/linux/kernel-features.h" 1
# 26 "../sysdeps/unix/sysv/linux/x86_64/kernel-features.h" 2
...
# 28 "../sysdeps/unix/sysv/linux/getcwd.c" 2
# 43 "../sysdeps/unix/sysv/linux/getcwd.c"
...
__getcwd (char *buf, size_t size)
{
  char *path;
  char *result;
# 74 "../sysdeps/unix/sysv/linux/getcwd.c"
    path = buf;

  int retval;

  retval = ({ unsigned long int resultvar = ({ unsigned long int resultvar; __typeof__ ((size) - (size)) __arg2 = ((__typeof__ ((size) - (size))) (size)); __typeof__ ((path) - (path)) __arg1 = ((__typeof__ ((path) - (path))) (path)); register __typeof__ ((size) - (size)) _a2 asm ("rsi") = __arg2; register __typeof__ ((path) - (path)) _a1 asm ("rdi") = __arg1; asm volatile ( "syscall\n\t" : "=a" (resultvar) : "0" (
# 78 "../sysdeps/unix/sysv/linux/getcwd.c" 3 4
          79
# 78 "../sysdeps/unix/sysv/linux/getcwd.c"
          ), "r" (_a1), "r" (_a2) : "memory", "cc", "r11", "cx"); (long int) resultvar; }); if (__builtin_expect ((((unsigned long int) (long int) (resultvar) >= -4095L)), 0)) { (rtld_errno = ((-(resultvar)))); resultvar = (unsigned long int) -1; } (long int) resultvar; });
  if (retval > 0 && path[0] == '/')
    {
# 92 "../sysdeps/unix/sysv/linux/getcwd.c"
      return buf;
    }
  ...
  if (retval >= 0 || rtld_errno == 
# 98 "../sysdeps/unix/sysv/linux/getcwd.c" 3 4
                             36
# 98 "../sysdeps/unix/sysv/linux/getcwd.c"
                                         )
    {
# 108 "../sysdeps/unix/sysv/linux/getcwd.c"
  ...
  ((void) sizeof ((rtld_errno != 
# 121 "../sysdeps/unix/sysv/linux/getcwd.c" 3 4
 34 
# 121 "../sysdeps/unix/sysv/linux/getcwd.c"
 || buf != 
# 121 "../sysdeps/unix/sysv/linux/getcwd.c" 3 4
 ((void *)0) 
# 121 "../sysdeps/unix/sysv/linux/getcwd.c"
 || size != 0) ? 1 : 0), __extension__ ({ if (rtld_errno != 
# 121 "../sysdeps/unix/sysv/linux/getcwd.c" 3 4
 34 
# 121 "../sysdeps/unix/sysv/linux/getcwd.c"
 || buf != 
# 121 "../sysdeps/unix/sysv/linux/getcwd.c" 3 4
 ((void *)0) 
# 121 "../sysdeps/unix/sysv/linux/getcwd.c"
 || size != 0) ; else __assert_fail ("errno != ERANGE || buf != NULL || size != 0", "../sysdeps/unix/sysv/linux/getcwd.c", 121, __extension__ __PRETTY_FUNCTION__); }));
  ...
  return 
# 128 "../sysdeps/unix/sysv/linux/getcwd.c" 3 4
        ((void *)0)
# 128 "../sysdeps/unix/sysv/linux/getcwd.c"
            ;
}
extern __typeof (__getcwd) getcwd __attribute__ ((weak, alias ("__getcwd")));




# 1 "../sysdeps/posix/getcwd.c" 1
# 33 "../sysdeps/posix/getcwd.c"
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/build-x86_64-poky-linux/config.h" 1
# 34 "../sysdeps/posix/getcwd.c" 2
...
# 38 "../sysdeps/posix/getcwd.c" 2
# 1 "../include/sys/types.h" 1
# 39 "../sysdeps/posix/getcwd.c" 2



# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/recipe-sysroot-native/usr/lib/x86_64-poky-linux/gcc/x86_64-poky-linux/8.3.0/include/stddef.h" 1 3 4
# 43 "../sysdeps/posix/getcwd.c" 2
# 64 "../sysdeps/posix/getcwd.c"
# 1 "../include/dirent.h" 1


# 1 "../sysdeps/posix/dirstream.h" 1
# 21 "../sysdeps/posix/dirstream.h"
# 1 "../include/sys/types.h" 1
# 22 "../sysdeps/posix/dirstream.h" 2
...
# 24 "../sysdeps/posix/dirstream.h" 2
...
# 1 "../include/bits/types.h" 1
# 30 "../dirent/dirent.h" 2
# 61 "../dirent/dirent.h"
# 1 "../sysdeps/unix/sysv/linux/bits/dirent.h" 1
# 22 "../sysdeps/unix/sysv/linux/bits/dirent.h"
struct dirent
  {
...
extern void rewinddir (DIR *__dirp) __attribute__ ((__nothrow__ )) ;


# 1 "../include/bits/types.h" 1
# 213 "../dirent/dirent.h" 2


extern void seekdir (DIR *__dirp, long int __pos) __attribute__ ((__nothrow__ )) ;


extern long int telldir (DIR *__dirp) __attribute__ ((__nothrow__ )) ;





extern int dirfd (DIR *__dirp) __attribute__ ((__nothrow__ )) ;
# 233 "../dirent/dirent.h"
# 1 "../include/bits/posix1_lim.h" 1
# 234 "../dirent/dirent.h" 2
# 245 "../dirent/dirent.h"
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/recipe-sysroot-native/usr/lib/x86_64-poky-linux/gcc/x86_64-poky-linux/8.3.0/include/stddef.h" 1 3 4
# 246 "../dirent/dirent.h" 2
# 255 "../dirent/dirent.h"
...
extern DIR *__opendir (const char *__name) __attribute__ ((visibility ("hidden")));
extern DIR *__opendirat (int dfd, const char *__name) __attribute__ ((visibility ("hidden")));
extern DIR *__fdopendir (int __fd) __attribute__ ((visibility ("hidden")));
extern int __closedir (DIR *__dirp) __attribute__ ((visibility ("hidden")));
extern struct dirent *__readdir (DIR *__dirp) __attribute__ ((visibility ("hidden")));
...
extern int __versionsort64 (const struct dirent64 **a,
     ...
     __attribute__ ((__pure__));
extern DIR *__alloc_dir (int fd, 
# 47 "../include/dirent.h" 3 4
                                _Bool 
# 47 "../include/dirent.h"
                                     close_fd, int flags,
    const struct stat64 *statp) __attribute__ ((visibility ("hidden")));
extern __typeof (rewinddir) __rewinddir;
extern __typeof (seekdir) __seekdir;
extern __typeof (dirfd) __dirfd;
;

extern void __scandir_cancel_handler (void *arg) __attribute__ ((visibility ("hidden")));
...
extern __typeof (__rewinddir) __rewinddir __attribute__ ((visibility ("hidden")));
# 65 "../sysdeps/posix/getcwd.c" 2
# 169 "../sysdeps/posix/getcwd.c"
# 1 "../include/limits.h" 1
# 183 "../include/limits.h"
# 1 "../include/bits/posix1_lim.h" 1
# 184 "../include/limits.h" 2
...
# 176 "../sysdeps/posix/getcwd.c" 2
# 1 "../sysdeps/unix/sysv/linux/x86_64/kernel-features.h" 1
# 26 "../sysdeps/unix/sysv/linux/x86_64/kernel-features.h"
# 1 "../sysdeps/unix/sysv/linux/kernel-features.h" 1
# 26 "../sysdeps/unix/sysv/linux/x86_64/kernel-features.h" 2
# 177 "../sysdeps/posix/getcwd.c" 2
# 224 "../sysdeps/posix/getcwd.c"
static char *
generic_getcwd (char *buf, size_t size)
{
# 236 "../sysdeps/posix/getcwd.c"
  int prev_errno = rtld_errno;
  DIR *dirstream = 
# 237 "../sysdeps/posix/getcwd.c" 3 4
                  ((void *)0)
# 237 "../sysdeps/posix/getcwd.c"
                      ;
  
# 238 "../sysdeps/posix/getcwd.c" 3 4
 _Bool 
# 238 "../sysdeps/posix/getcwd.c"
      fd_needs_closing = 
# 238 "../sysdeps/posix/getcwd.c" 3 4
                         0
# 238 "../sysdeps/posix/getcwd.c"
  ...
  char *path;
# 265 "../sysdeps/posix/getcwd.c"
    path = buf;

  char *pathp = path + size;
  *--pathp = '\0';

  struct stat64 st;
  if (__lxstat64 (1, ".", &st) < 0)
    goto lose;
  ...
  while (!(thisdev == rootdev && thisino == rootino))
    {
      if (1 >= 0)
   fd = __openat64_nocancel (fd, "..", 00 | 02000000);
      else
 fd = -1;
      if (fd >= 0)
 {
   fd_needs_closing = 
# 289 "../sysdeps/posix/getcwd.c" 3 4
                     1
# 289 "../sysdeps/posix/getcwd.c"
                         ;
   if (__fxstat64 (1, fd, &st) < 0)
     goto lose;
 }
# 345 "../sysdeps/posix/getcwd.c"
      else
 goto lose;
 ...
 {
   dirstream = 
# 350 "../sysdeps/posix/getcwd.c" 3 4
              ((void *)0)
# 350 "../sysdeps/posix/getcwd.c"
                  ;
   goto lose;
       }
...
# 356 "../sysdeps/posix/getcwd.c" 3 4
     _Bool 
# 356 "../sysdeps/posix/getcwd.c"
 ...
 dirstream = __fdopendir (fd);
      ...
      if (dirstream == 
# 365 "../sysdeps/posix/getcwd.c" 3 4
                      ((void *)0)
# 365 "../sysdeps/posix/getcwd.c"
                          )
 goto lose;
      fd_needs_closing = 
# 367 "../sysdeps/posix/getcwd.c" 3 4
                        0
# 367 "../sysdeps/posix/getcwd.c"
                             ;

      struct dirent *d;
      
# 370 "../sysdeps/posix/getcwd.c" 3 4
     _Bool 
# 370 "../sysdeps/posix/getcwd.c"
          use_d_ino = 
# 370 "../sysdeps/posix/getcwd.c" 3 4
                      1
# 370 "../sysdeps/posix/getcwd.c"
      ...
      while (1)
 {
   ...
   if (d == 
# 377 "../sysdeps/posix/getcwd.c" 3 4
           ((void *)0)
# 377 "../sysdeps/posix/getcwd.c"
               )
     {
       if (rtld_errno == 0)
  {
    ...
    if (use_d_ino)
      {
        use_d_ino = 
# 388 "../sysdeps/posix/getcwd.c" 3 4
                   0
# 388 "../sysdeps/posix/getcwd.c"
                        ;
    ...
    (rtld_errno = (
# 395 "../sysdeps/posix/getcwd.c" 3 4
   2
# 395 "../sysdeps/posix/getcwd.c"
   ));
  }
       goto lose;
     }
   ...
   if (1 >= 0)
     {
       ...
       if (__fxstatat64 (1, fd, d->d_name, &st, 0x100) < 0)
  continue;
     }
# 443 "../sysdeps/posix/getcwd.c"
 ...
 {
# 471 "../sysdeps/posix/getcwd.c"
     {
       (rtld_errno = (
# 472 "../sysdeps/posix/getcwd.c" 3 4
      34
# 472 "../sysdeps/posix/getcwd.c"
      ));
       goto lose;
     }
 }
  ...
  if (dirstream != 
# 484 "../sysdeps/posix/getcwd.c" 3 4
                  ((void *)0) 
# 484 "../sysdeps/posix/getcwd.c"
                       && __closedir (dirstream) != 0)
    {
      dirstream = 
# 486 "../sysdeps/posix/getcwd.c" 3 4
                 ((void *)0)
# 486 "../sysdeps/posix/getcwd.c"
                     ;
      goto lose;
    }
  ...
  if (buf == 
# 505 "../sysdeps/posix/getcwd.c" 3 4
            ((void *)0)
# 505 "../sysdeps/posix/getcwd.c"
                )
  ...
  (rtld_errno = (prev_errno));

  return buf;

 lose:;
  int save_errno = rtld_errno;




  if (dirstream != 
# 521 "../sysdeps/posix/getcwd.c" 3 4
                  ((void *)0)
# 521 "../sysdeps/posix/getcwd.c"
                      )
  ...
  (rtld_errno = (save_errno));
  return 
# 530 "../sysdeps/posix/getcwd.c" 3 4
        ((void *)0)
# 530 "../sysdeps/posix/getcwd.c"
            ;
}
# 135 "../sysdeps/unix/sysv/linux/getcwd.c" 2
# 1 "../sysdeps/unix/sysv/linux/dl-getcwd.c" 2
