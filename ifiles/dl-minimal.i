...
# 25 "../sysdeps/x86_64/nptl/tls.h" 2
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/recipe-sysroot-native/usr/lib/x86_64-poky-linux/gcc/x86_64-poky-linux/8.3.0/include/stddef.h" 1 3 4
...
# 1 "../malloc/malloc-internal.h" 1
# 22 "../malloc/malloc-internal.h"
# 1 "../sysdeps/nptl/malloc-machine.h" 1
# 25 "../sysdeps/nptl/malloc-machine.h"
# 1 "../sysdeps/generic/malloc-machine.h" 1
# 24 "../sysdeps/generic/malloc-machine.h"
# 1 "../sysdeps/generic/malloc-alignment.h" 1
# 25 "../sysdeps/generic/malloc-machine.h" 2
# 26 "../sysdeps/nptl/malloc-machine.h" 2
# 23 "../malloc/malloc-internal.h" 2
# 1 "../sysdeps/unix/sysv/linux/malloc-sysdep.h" 1
# 19 "../sysdeps/unix/sysv/linux/malloc-sysdep.h"
# 1 "../include/fcntl.h" 1
...
# 20 "../sysdeps/unix/sysv/linux/malloc-sysdep.h" 2
...
# 21 "../sysdeps/unix/sysv/linux/malloc-sysdep.h" 2
# 33 "../sysdeps/unix/sysv/linux/malloc-sysdep.h"
static inline 
# 33 "../sysdeps/unix/sysv/linux/malloc-sysdep.h" 3 4
             _Bool

# 34 "../sysdeps/unix/sysv/linux/malloc-sysdep.h"
...
# 24 "../malloc/malloc-internal.h" 2
# 66 "../malloc/malloc-internal.h"
void __malloc_fork_lock_parent (void) __attribute__ ((visibility ("hidden")));


void __malloc_fork_unlock_parent (void) __attribute__ ((visibility ("hidden")));


void __malloc_fork_unlock_child (void) __attribute__ ((visibility ("hidden")));


void __malloc_arena_thread_freeres (void) __attribute__ ((visibility ("hidden")));



static inline 
# 79 "../malloc/malloc-internal.h" 3 4
             _Bool

# 80 "../malloc/malloc-internal.h"
check_mul_overflow_size_t (size_t left, size_t right, size_t *result)
{

  return __builtin_mul_overflow (left, right, result);
# 95 "../malloc/malloc-internal.h"
}
# 31 "dl-minimal.c" 2
...
extern void __attribute__ ((weak)) free (void *ptr);
extern void * __attribute__ ((weak)) realloc (void *ptr, size_t n);
...
malloc (size_t n)
{
  ...
  alloc_ptr = (void *) 0 + (((alloc_ptr - (void *) 0) + (2 * (sizeof (size_t)) < __alignof__ (long double) ? __alignof__ (long double) : 2 * (sizeof (size_t))) - 1)
       & ~((2 * (sizeof (size_t)) < __alignof__ (long double) ? __alignof__ (long double) : 2 * (sizeof (size_t))) - 1));
  ...
  if (alloc_ptr + n >= alloc_end || n >= -(uintptr_t) alloc_ptr)
    {
      ...
      caddr_t page;
      size_t nup = (n + _rtld_local_ro._dl_pagesize - 1) & ~(_rtld_local_ro._dl_pagesize - 1);
...
# 71 "dl-minimal.c"
           ;
      nup += _rtld_local_ro._dl_pagesize;
      page = __mmap (0, nup, 0x1|0x2,
       0x20|0x02, -1, 0);
      if (page == ((void *) -1))
 return 
# 76 "dl-minimal.c" 3 4
...
calloc (size_t nmemb, size_t size)
{
  ...
  if (__builtin_expect ((nmemb | size) >= (((size_t) 1) << (8 * sizeof (size_t) / 2)), 0)
      && size != 0 && bytes / size != nmemb)
    return 
# 101 "dl-minimal.c" 3 4
          ((void *)0)
# 101 "dl-minimal.c"
              ;
...
{
  if (ptr == 
# 124 "dl-minimal.c" 3 4
            ((void *)0)
# 124 "dl-minimal.c"
                )
    return malloc (n);
  ((void) sizeof ((ptr == alloc_last_block) ? 1 : 0), __extension__ ({ if (ptr == alloc_last_block) ; else __assert_fail ("ptr == alloc_last_block", "dl-minimal.c", 126, __extension__ __PRETTY_FUNCTION__); }));
...
{
  do { _dl_dprintf (2, "%s", message); _exit (127); } while (1);
}
extern __typeof (__libc_fatal) __EI___libc_fatal __asm__("" "__libc_fatal"); extern __typeof (__libc_fatal) __EI___libc_fatal __attribute__((alias ("" "__GI___libc_fatal")));
...
extern __typeof (__chk_fail) __EI___chk_fail __asm__("" "__chk_fail"); extern __typeof (__chk_fail) __EI___chk_fail __attribute__((alias ("" "__GI___chk_fail")));
...
{
  do { _dl_dprintf (2, "Inconsistency detected by ld.so: %s: %u: %s%sAssertion `%s' failed!\n", file, line, function ?: "", function ? ": " : "", assertion); _exit (127); } while (1)


                ;

}
extern __typeof (__assert_fail) __EI___assert_fail __asm__("" "__assert_fail"); extern __typeof (__assert_fail) __EI___assert_fail __attribute__((alias ("" "__GI___assert_fail"))) __attribute__((weak));
...
{
  char errbuf[400];
  do { _dl_dprintf (2, "Inconsistency detected by ld.so: %s: %u: %s%sUnexpected error: %s.\n", file, line, function ?: "", function ? ": " : "", __strerror_r (errnum, errbuf, sizeof errbuf)); _exit (127); } while (1)


                                                   ;

}
extern __typeof (__assert_perror_fail) __EI___assert_perror_fail __asm__("" "__assert_perror_fail"); extern __typeof (__assert_perror_fail) __EI___assert_perror_fail __attribute__((alias ("" "__GI___assert_perror_fail"))) __attribute__((weak));
...
_itoa (unsigned long long int value, char *buflim, unsigned int base,
       int upper_case)
{
  ((void) sizeof ((! upper_case) ? 1 : 0), __extension__ ({ if (! upper_case) ; else __assert_fail ("! upper_case", "dl-minimal.c", 241, __extension__ __PRETTY_FUNCTION__); }));
...
extern __typeof (_itoa_lower_digits) __EI__itoa_lower_digits __asm__("" "_itoa_lower_digits"); extern __typeof (_itoa_lower_digits) __EI__itoa_lower_digits __attribute__((alias ("" "__GI__itoa_lower_digits")));
...
__strsep (char **stringp, const char *delim)
{
  ...
  ((void) sizeof ((delim[0] != '\0') ? 1 : 0), __extension__ ({ if (delim[0] != '\0') ; else __assert_fail ("delim[0] != '\\0'", "dl-minimal.c", 265, __extension__ __PRETTY_FUNCTION__); }));

  begin = *stringp;
  if (begin != 
# 268 "dl-minimal.c" 3 4
              ((void *)0)
# 268 "dl-minimal.c"
                  )
    {
...
extern __typeof (__strsep) strsep __attribute__ ((weak, alias ("__strsep")));
extern __typeof (__strsep) __strsep_g __attribute__ ((alias ("__strsep")));
