...
# 57 "dl-error-skeleton.c"
static struct catch *catch_hook;
# 68 "dl-error-skeleton.c"
...
_dl_signal_cexception (int errcode, struct dl_exception *exception,
         const char *occasion)
{
  if (__builtin_expect (_rtld_local_ro._dl_debug_mask
   & ~((1 << 7)|(1 << 11)), 0))
...
_dl_receive_error (receiver_fct fct, void (*operate) (void *), void *args)
{
  ...
  catch_hook = 
# 231 "dl-error-skeleton.c" 3 4
              ((void *)0)
# 231 "dl-error-skeleton.c"
                  ;
  receiver = fct;
