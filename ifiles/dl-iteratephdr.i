...
# 22 "dl-iteratephdr.c" 2
# 1 "/home/flaig/EB_2.1/build/tmp/work/corei7-64-poky-linux/glibc/2.28-r0/recipe-sysroot-native/usr/lib/x86_64-poky-linux/gcc/x86_64-poky-linux/8.3.0/include/stddef.h" 1 3 4
# 23 "dl-iteratephdr.c" 2


static void
cancel_handler (void *arg __attribute__((unused)))
{
  _rtld_global._dl_rtld_unlock_recursive (&(_rtld_global._dl_load_write_lock).mutex);
}
        ...
        size_t size, void *data), void *data)
{
  ...
  _rtld_global._dl_rtld_lock_recursive (&(_rtld_global._dl_load_write_lock).mutex);
  do { struct __pthread_cleanup_frame __clframe __attribute__ ((__cleanup__ (__libc_cleanup_routine))) = { .__cancel_routine = (cancel_handler), .__cancel_arg = (
# 41 "dl-iteratephdr.c" 3 4
 ((void *)0)
# 41 "dl-iteratephdr.c"
 ), .__do_it = 1 };;
  ...
  size_t nloaded = _rtld_global._dl_ns[0]._ns_nloaded;
  Lmid_t ns = 0;

  const void *caller = __builtin_extract_return_addr (__builtin_return_address (0));
  for (Lmid_t cnt = _rtld_global._dl_nns - 1; cnt > 0; --cnt)
    for (struct link_map *l = _rtld_global._dl_ns[cnt]._ns_loaded; l; l = l->l_next)
      {

 nloaded += _rtld_global._dl_ns[cnt]._ns_nloaded;

 if (caller >= (const void *) l->l_map_start
     && caller < (const void *) l->l_map_end
     && (l->l_contiguous
  || _dl_addr_inside_object (l, (Elf64_Addr) caller)))
   ns = cnt;
      }


  for (l = _rtld_global._dl_ns[ns]._ns_loaded; l != 
# 63 "dl-iteratephdr.c" 3 4
                                         ((void *)0)
# 63 "dl-iteratephdr.c"
                                             ; l = l->l_next)
    {
      ...
      info.dlpi_adds = _rtld_global._dl_load_adds;
      info.dlpi_subs = _rtld_global._dl_load_adds - nloaded;
      info.dlpi_tls_data = 
# 71 "dl-iteratephdr.c" 3 4
                          ((void *)0)
# 71 "dl-iteratephdr.c"
                              ;
      info.dlpi_tls_modid = l->l_real->l_tls_modid;
      if (info.dlpi_tls_modid != 0)
 info.dlpi_tls_data = _rtld_global_ro._dl_tls_get_addr_soft (l->l_real);
...
extern __typeof (__dl_iterate_phdr) __EI___dl_iterate_phdr __asm__("" "__dl_iterate_phdr"); extern __typeof (__dl_iterate_phdr) __EI___dl_iterate_phdr __attribute__((alias ("" "__GI___dl_iterate_phdr")));

extern __typeof (__dl_iterate_phdr) dl_iterate_phdr __attribute__ ((weak, alias ("__dl_iterate_phdr")));;
