...
oom_exception (struct dl_exception *exception)
{
  ...
  exception->message_buffer = 
# 39 "dl-exception.c" 3 4
                             ((void *)0)
# 39 "dl-exception.c"
                                 ;
}
...
{
  do { _dl_dprintf (2, "Fatal error: " "length accounting in _dl_exception_create_format\n"); _exit (127); } while (1)
                                                                         ;
}
...
# 58 "dl-exception.c"
  ...
  malloced = (_rtld_local._dl_ns[0]._ns_loaded != 
# 60 "dl-exception.c" 3 4
                                                 ((void *)0)
              
# 61 "dl-exception.c"
             && (_rtld_local._dl_ns[0]._ns_loaded->l_relocated != 0));

  if (malloced)
    exception->message_buffer = (char *) exception->errstring;
  else
    exception->message_buffer = 
# 66 "dl-exception.c" 3 4
                               ((void *)0)
# 66 "dl-exception.c"
                                   ;
}
...
# 73 "dl-exception.c"
  ...
  if (errstring_copy != 
# 78 "dl-exception.c" 3 4
                       ((void *)0)
# 78 "dl-exception.c"
                           )
    {

      exception->objname = memcpy (__builtin_mempcpy (errstring_copy, errstring, len_errstring)
                                                                       ,
                                   objname, len_objname);
...
extern __typeof (_dl_exception_create) __EI__dl_exception_create __asm__("" "_dl_exception_create"); extern __typeof (_dl_exception_create) __EI__dl_exception_create __attribute__((alias ("" "__GI__dl_exception_create")));
...
# 122 "dl-exception.c"
  ...
  if (length > (9223372036854775807L))
    {
      oom_exception (exception);
      return;
    }
...
# 157 "dl-exception.c"
                ...
                if (len_ptr > end - wptr)
                  length_mismatch ();
                wptr = __builtin_mempcpy (wptr, ptr, len_ptr);
              }
              break;
            case '%':
              if (wptr == end)
              ...
              *wptr = '%';
              ...
              break;
            default:
              do { _dl_dprintf (2, "Fatal error:" " invalid format in exception string\n"); _exit (127); } while (1)
                                                                        ;
            }
        }
      else
...
extern __typeof (_dl_exception_create_format) __EI__dl_exception_create_format __asm__("" "_dl_exception_create_format"); extern __typeof (_dl_exception_create_format) __EI__dl_exception_create_format __attribute__((alias ("" "__GI__dl_exception_create_format")));
...
_dl_exception_free (struct dl_exception *exception)
{
  ...
  exception->objname = 
# 198 "dl-exception.c" 3 4
                      ((void *)0)
# 198 "dl-exception.c"
                          ;
  exception->errstring = 
# 199 "dl-exception.c" 3 4
                        ((void *)0)
# 199 "dl-exception.c"
                            ;
  exception->message_buffer = 
# 200 "dl-exception.c" 3 4
                             ((void *)0)
# 200 "dl-exception.c"
                                 ;
}
extern __typeof (_dl_exception_free) __EI__dl_exception_free __asm__("" "_dl_exception_free"); extern __typeof (_dl_exception_free) __EI__dl_exception_free __attribute__((alias ("" "__GI__dl_exception_free")));
