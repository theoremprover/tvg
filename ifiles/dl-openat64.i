# 1 "../sysdeps/unix/sysv/linux/dl-openat64.c"
...
# 1 "<command-line>" 2
# 1 "../sysdeps/unix/sysv/linux/dl-openat64.c"
# 19 "../sysdeps/unix/sysv/linux/dl-openat64.c"
...
# 20 "../sysdeps/unix/sysv/linux/dl-openat64.c" 2
# 1 "../include/errno.h" 1
...
# 21 "../sysdeps/unix/sysv/linux/dl-openat64.c" 2
# 1 "../include/fcntl.h" 1
...
# 22 "../sysdeps/unix/sysv/linux/dl-openat64.c" 2
...
# 23 "../sysdeps/unix/sysv/linux/dl-openat64.c" 2


int
openat64 (int dfd, const char *file, int oflag, ...)
{
  ((void) sizeof ((!(((oflag) & 0100) != 0 || ((oflag) & (020000000 | 0200000)) == (020000000 | 0200000))) ? 1 : 0), __extension__ ({ if (!(((oflag) & 0100) != 0 || ((oflag) & (020000000 | 0200000)) == (020000000 | 0200000))) ; else __assert_fail ("!__OPEN_NEEDS_MODE (oflag)", "../sysdeps/unix/sysv/linux/dl-openat64.c", 28, __extension__ __PRETTY_FUNCTION__); }));

  return ({ unsigned long int resultvar = ({ unsigned long int resultvar; __typeof__ ((oflag | 0) - (oflag | 0)) __arg3 = ((__typeof__ ((oflag | 0) - (oflag | 0))) (oflag | 0)); __typeof__ ((file) - (file)) __arg2 = ((__typeof__ ((file) - (file))) (file)); __typeof__ ((dfd) - (dfd)) __arg1 = ((__typeof__ ((dfd) - (dfd))) (dfd)); register __typeof__ ((oflag | 0) - (oflag | 0)) _a3 asm ("rdx") = __arg3; register __typeof__ ((file) - (file)) _a2 asm ("rsi") = __arg2; register __typeof__ ((dfd) - (dfd)) _a1 asm ("rdi") = __arg1; asm volatile ( "syscall\n\t" : "=a" (resultvar) : "0" (
# 30 "../sysdeps/unix/sysv/linux/dl-openat64.c" 3 4
        257
# 30 "../sysdeps/unix/sysv/linux/dl-openat64.c"
        ), "r" (_a1), "r" (_a2), "r" (_a3) : "memory", "cc", "r11", "cx"); (long int) resultvar; }); if (__builtin_expect ((((unsigned long int) (long int) (resultvar) >= -4095L)), 0)) { (rtld_errno = ((-(resultvar)))); resultvar = (unsigned long int) -1; } (long int) resultvar; });
}
