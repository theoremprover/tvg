# 1 "../sysdeps/unix/sysv/linux/dl-brk.c"
...
extern void *__curbrk __attribute__ ((visibility ("hidden")));

# 1 "../sysdeps/unix/sysv/linux/x86_64/brk.c" 1
# 19 "../sysdeps/unix/sysv/linux/x86_64/brk.c"
# 1 "../include/errno.h" 1
...
# 20 "../sysdeps/unix/sysv/linux/x86_64/brk.c" 2
...
# 21 "../sysdeps/unix/sysv/linux/x86_64/brk.c" 2
...
# 22 "../sysdeps/unix/sysv/linux/x86_64/brk.c" 2
...
__brk (void *addr)
{
  ...
  __curbrk = newbrk = (void *) ({ unsigned long int resultvar = ({ unsigned long int resultvar; __typeof__ ((addr) - (addr)) __arg1 = ((__typeof__ ((addr) - (addr))) (addr)); register __typeof__ ((addr) - (addr)) _a1 asm ("rdi") = __arg1; asm volatile ( "syscall\n\t" : "=a" (resultvar) : "0" (
# 31 "../sysdeps/unix/sysv/linux/x86_64/brk.c" 3 4
                              12
# 31 "../sysdeps/unix/sysv/linux/x86_64/brk.c"
                              ), "r" (_a1) : "memory", "cc", "r11", "cx"); (long int) resultvar; }); if (__builtin_expect ((((unsigned long int) (long int) (resultvar) >= -4095L)), 0)) { (rtld_errno = ((-(resultvar)))); resultvar = (unsigned long int) -1; } (long int) resultvar; });

  if (newbrk < addr)
    {
      (rtld_errno = (
# 35 "../sysdeps/unix/sysv/linux/x86_64/brk.c" 3 4
     12
# 35 "../sysdeps/unix/sysv/linux/x86_64/brk.c"
     ));
      return -1;
    }
...
extern __typeof (__brk) brk __attribute__ ((weak, alias ("__brk")));
# 5 "../sysdeps/unix/sysv/linux/dl-brk.c" 2
