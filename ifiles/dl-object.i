...
# 35 "dl-object.c"
    ...
    {
      struct link_map *l = _rtld_local._dl_ns[nsid]._ns_loaded;
      while (l->l_next != 
# 38 "dl-object.c" 3 4
                         ((void *)0)
# 38 "dl-object.c"
 ...
 l = l->l_next;
    ...
    _rtld_local._dl_ns[nsid]._ns_loaded = new;
  ++_rtld_local._dl_ns[nsid]._ns_nloaded;
  new->l_serial = _rtld_local._dl_load_adds;
  ...
  struct link_map *loader, int mode, Lmid_t nsid)
{
  ...
  unsigned int naudit = _rtld_local_ro._dl_naudit ?: ((mode & 0x20000000)
         ? 16 : 0);
...
# 77 "dl-object.c"
  ...
  if ((_rtld_local_ro._dl_debug_mask & (1 << 8)) == 0)
    new->l_used = 1;
  new->l_loader = loader;
...
# 126 "dl-object.c"
    ...
    new->l_scope[idx++] = &_rtld_local._dl_ns[nsid]._ns_loaded->l_searchlist;
...
# 183 "dl-object.c"
  ...
  break;
   ...
   while ((result = __getcwd (origin, len - realname_len)) == 
# 188 "dl-object.c" 3 4
                                                             ((void *)0)
...
# 191 "dl-object.c"
   ...
   if (cp[-1] != '/')
     *cp++ = '/';
      ...
      cp = __builtin_mempcpy (cp, realname, realname_len);
