...
# 25 "dl-lookup.c" 2
# 1 "../sysdeps/generic/dl-hash.h" 1
# 26 "../sysdeps/generic/dl-hash.h"
static unsigned int
...
check_match (const char *const undef_name,
      ...
      const Elf64_Sym **const versioned_sym,
      int *const num_versions)
{
  unsigned int stt = ((sym->st_info) & 0xf);
  ((void) sizeof ((1 == 1) ? 1 : 0), __extension__ ({ if (1 == 1) ; else __assert_fail ("ELF_RTYPE_CLASS_PLT == 1", "dl-lookup.c", 77, __extension__ __PRETTY_FUNCTION__); }));
  if (__builtin_expect (((sym->st_value == 0 && sym->st_shndx != 0xfff1 && stt != 6) || 0 || (type_class & (sym->st_shndx == 0))), 0)
...
# 83 "dl-lookup.c"
  ...
  if (__builtin_expect ((((1 << stt) & ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 5) | (1 << 6) | (1 << 10))) == 0), 0))
    return 
# 92 "dl-lookup.c" 3 4
          ((void *)0)
# 92 "dl-lookup.c"
...
# 96 "dl-lookup.c"
  ...
  const Elf64_Half *verstab = map->l_versyms;
  if (version != 
# 99 "dl-lookup.c" 3 4
                ((void *)0)
# 99 "dl-lookup.c"
...
# 101 "dl-lookup.c"
 ...
 {
# 111 "dl-lookup.c"
   ((void) sizeof ((version->filename == 
# 111 "dl-lookup.c" 3 4
  ((void *)0) 
# 111 "dl-lookup.c"
  || ! _dl_name_match_p (version->filename, map)) ? 1 : 0), __extension__ ({ if (version->filename == 
# 111 "dl-lookup.c" 3 4
  ((void *)0) 
# 111 "dl-lookup.c"
  || ! _dl_name_match_p (version->filename, map)) ; else __assert_fail ("version->filename == NULL || ! _dl_name_match_p (version->filename, map)",
                                                  "dl-lookup.c"
# 111 "dl-lookup.c"
   ,
                                                  112
# 111 "dl-lookup.c"
      ...
      else
 {
   ...
   Elf64_Half ndx = verstab[symidx] & 0x7fff;
...
enter_unique_sym (struct unique_sym *table, size_t size,
                  ...
                  const Elf64_Sym *sym, const struct link_map *map)
{
...
do_lookup_unique (const char *undef_name, uint_fast32_t new_hash,
    ...
    int type_class, const Elf64_Sym *sym, const char *strtab,
    const Elf64_Sym *ref, const struct link_map *undef_map)
{
  ...
  struct unique_sym_table *tab
    = &_rtld_local._dl_ns[map->l_ns]._ns_unique_sym_table;

  _rtld_local._dl_rtld_lock_recursive (&(tab->lock).mutex);
      ...
      while (1)
 {
       ...
       else
  {
    ...
    result->m = (struct link_map *) entries[idx].map;
       ...
       _rtld_local._dl_rtld_unlock_recursive (&(tab->lock).mutex);
       return;
     }
...
# 287 "dl-lookup.c"
 ...
 {
   ((void) sizeof ((_rtld_local_ro._dl_debug_mask & (1 << 11)) ? 1 : 0), __extension__ ({ if (_rtld_local_ro._dl_debug_mask & (1 << 11)) ; else __assert_fail ("GLRO(dl_debug_mask) & DL_DEBUG_PRELINK", "dl-lookup.c", 289, __extension__ __PRETTY_FUNCTION__); }));
   goto success;
 }
...
# 297 "dl-lookup.c"
 ...
 ((struct link_map *) map)->l_flags_1 |= 0x00000008;
    }
  ++tab->n_elements;
      ...
      struct link_map *skip, int type_class, struct link_map *undef_map)
{
 ...
 continue;
      ...
      if ((type_class & 2) && map->l_type == lt_executable)
 continue;
 ...
 continue;
      ...
      if (__builtin_expect ((_rtld_local_ro._dl_debug_mask & (1 << 3)), 0))
 _dl_debug_printf ("symbol=%s;  lookup in file=%s [%lu]\n",
     undef_name, ((map->l_name)[0] ? (map->l_name) : (_dl_argv[0] ?: "<main program>")),
     map->l_ns);
...
# 376 "dl-lookup.c"
      ...
      const Elf64_Sym *symtab = (const void *) (map)->l_info[6]->d_un.d_ptr;
      const char *strtab = (const void *) (map)->l_info[5]->d_un.d_ptr;

      const Elf64_Sym *sym;
      const Elf64_Addr *bitmask = map->l_gnu_bitmask;
      if (__builtin_expect ((bitmask != 
# 384 "dl-lookup.c" 3 4
         ((void *)0)
# 384 "dl-lookup.c"
         ), 1))
 {
   ...
   unsigned int hashbit1 = new_hash & (64 - 1);
...
# 436 "dl-lookup.c"
  ...
  goto found_it;
      ...
      sym = num_versions == 1 ? versioned_sym : 
# 445 "dl-lookup.c" 3 4
                                               ((void *)0)
# 445 "dl-lookup.c"
                                                   ;
...
# 464 "dl-lookup.c"
   && map->l_info[8]->d_un.d_val != 0)
  {
    const Elf64_Rela *rela
      = (const Elf64_Rela *) (map)->l_info[7]->d_un.d_ptr;
    unsigned int rela_count
      = map->l_info[8]->d_un.d_val / sizeof (*rela);

    for (i = 0; i < rela_count; i++, rela++)
      if (((((((rela->r_info) & 0xffffffff)) == 7 || (((rela->r_info) & 0xffffffff)) == 16 || (((rela->r_info) & 0xffffffff)) == 17 || (((rela->r_info) & 0xffffffff)) == 18 || (((rela->r_info) & 0xffffffff)) == 36) * 1) | (((((rela->r_info) & 0xffffffff)) == 5) * 2) | (((((rela->r_info) & 0xffffffff)) == 6) * 4))
   == 2)
        {
   s = &symtab[((rela->r_info) >> 32)];
...
# 501 "dl-lookup.c"
   ...
   if (__builtin_expect ((dl_symbol_visibility_binds_local_p (sym)), 0))
     goto skip;
   ...
   switch ((((unsigned char) (sym->st_info)) >> 4))
     ...
     case 2:
       ...
       if (__builtin_expect ((_rtld_local_ro._dl_dynamic_weak), 0))
  {
    if (! result->s)
      {
        result->s = sym;
...
add_dependency (struct link_map *undef_map, struct link_map *map, int flags)
{
  ...
  ((void) sizeof ((map->l_type == lt_loaded) ? 1 : 0), __extension__ ({ if (map->l_type == lt_loaded) ; else __assert_fail ("map->l_type == lt_loaded", "dl-lookup.c", 576, __extension__ __PRETTY_FUNCTION__); }));
  if ((map->l_flags_1 & 0x00000008) != 0)
    return 0;

  struct link_map_reldeps *l_reldeps
    = ({ __typeof (undef_map->l_reldeps) __x; __asm ("" : "=r" (__x) : "0" (undef_map->l_reldeps)); __x; });
  ...
  struct link_map **l_initfini = ({ __typeof (undef_map->l_initfini) __x; __asm ("" : "=r" (__x) : "0" (undef_map->l_initfini)); __x; });
  if (l_initfini != 
# 589 "dl-lookup.c" 3 4
                   ((void *)0)
# 589 "dl-lookup.c"
...
# 616 "dl-lookup.c"
      ...
      map = ({ __typeof (map) __x; __asm ("" : "=r" (__x) : "0" (map)); __x; });
...
# 640 "dl-lookup.c"
                                     )
 {
  ...
  runp = _rtld_local._dl_ns[undef_map->l_ns]._ns_loaded;
  while (runp != 
# 671 "dl-lookup.c" 3 4
                ((void *)0) 
# 671 "dl-lookup.c"
...
# 674 "dl-lookup.c"
 ...
 goto out;
   ...
   || (undef_map->l_flags_1 & 0x00000008) != 0)
 {
   map->l_flags_1 |= 0x00000008;
   goto out;
 }
...
# 713 "dl-lookup.c"
 ...
 _dl_debug_printf ("\nfile=%s [%lu];  needed by %s [%lu] (relocation dependency)\n\n",
     ...
     map->l_ns,
     ((undef_map->l_name)[0] ? (undef_map->l_name) : (_dl_argv[0] ?: "<main program>")),
     undef_map->l_ns);
    }
  else
...
_dl_debug_bindings (const char *undef_name, struct link_map *undef_map,
      const Elf64_Sym **ref, struct sym_val *value,
...
# 801 "dl-lookup.c" 3 4
 ((void *)0) 
# 801 "dl-lookup.c"
 || (flags & ~(DL_LOOKUP_ADD_DEPENDENCY | DL_LOOKUP_GSCOPE_LOCK)) == 0) ? 1 : 0), __extension__ ({ if (version == 
# 801 "dl-lookup.c" 3 4
 ((void *)0) 
# 801 "dl-lookup.c"
 || (flags & ~(DL_LOOKUP_ADD_DEPENDENCY | DL_LOOKUP_GSCOPE_LOCK)) == 0) ; else __assert_fail ("version == NULL || (flags & ~(DL_LOOKUP_ADD_DEPENDENCY | DL_LOOKUP_GSCOPE_LOCK)) == 0",
...
# 812 "dl-lookup.c"
 ...
 break;
      ...
      if (__builtin_expect ((res < 0), 0) && skip_map == 
# 820 "dl-lookup.c" 3 4
                                                   ((void *)0)
# 820 "dl-lookup.c"
                                                       )
...
# 825 "dl-lookup.c" 3 4
  ((void *)0)
# 825 "dl-lookup.c"
  ) ? 1 : 0), __extension__ ({ if (version != 
# 825 "dl-lookup.c" 3 4
  ((void *)0)
# 825 "dl-lookup.c"
  ) ; else __assert_fail ("version != NULL", "dl-lookup.c", 825, __extension__ __PRETTY_FUNCTION__); }));
   const char *reference_name = undef_map ? undef_map->l_name : "";
   struct dl_exception exception;

   _dl_exception_create_format
     (&exception, ((reference_name)[0] ? (reference_name) : (_dl_argv[0] ?: "<main program>")),
      "symbol %s version %s not defined in file %s"
      " with link time reference%s",
      undef_name, version->name, version->filename,
      res == -2 ? " (no version symbols)" : "");
   _dl_signal_cexception (0, &exception, "relocation error");
...
# 837 "dl-lookup.c"
  ...
  if (__builtin_expect ((current_value.s == 
# 842 "dl-lookup.c" 3 4
     ((void *)0)
# 842 "dl-lookup.c"
     ), 0))
...
# 844 "dl-lookup.c" 3 4
                  ((void *)0) 
# 844 "dl-lookup.c"
                       || (((unsigned char) ((*ref)->st_info)) >> 4) != 2)
   && !(_rtld_local_ro._dl_debug_mask & (1 << 8)))
 {
   ...
   _dl_signal_cexception (0, &exception, "symbol lookup error");
   _dl_exception_free (&exception);
 }
      *ref = 
# 861 "dl-lookup.c" 3 4
...
# 873 "dl-lookup.c"
 ...
 {
   struct sym_val protected_value = { 
# 881 "dl-lookup.c" 3 4
                                     ((void *)0)
# 881 "dl-lookup.c"
                                         , 
...
# 894 "dl-lookup.c"
  ...
  if (__builtin_expect ((_rtld_local_ro._dl_debug_mask & ((1 << 2)|(1 << 11))), 0)
                                          )
...
_dl_setup_hash (struct link_map *map)
{
  ...
  if (__builtin_expect ((map->l_info[(35 + 0 + 16 + 3 + 12 + (0x6ffffeff - (0x6ffffef5)))] != 
# 940 "dl-lookup.c" 3 4
     ((void *)0)
# 940 "dl-lookup.c"
     ), 1))
    {
      Elf32_Word *hash32
 = (void *) (map)->l_info[(35 + 0 + 16 + 3 + 12 + (0x6ffffeff - (0x6ffffef5)))]->d_un.d_ptr;
      map->l_nbuckets = *hash32++;
      Elf32_Word symbias = *hash32++;
      Elf32_Word bitmask_nwords = *hash32++;

      ((void) sizeof (((bitmask_nwords & (bitmask_nwords - 1)) == 0) ? 1 : 0), __extension__ ({ if ((bitmask_nwords & (bitmask_nwords - 1)) == 0) ; else __assert_fail ("(bitmask_nwords & (bitmask_nwords - 1)) == 0", "dl-lookup.c", 948, __extension__ __PRETTY_FUNCTION__); }));
      map->l_gnu_bitmask_idxbits = bitmask_nwords - 1;
      map->l_gnu_shift = *hash32++;

      map->l_gnu_bitmask = (Elf64_Addr *) hash32;
  ...
  if (!map->l_info[4])
    return;
  hash = (void *) (map)->l_info[4]->d_un.d_ptr;
      ...
      int protected)
{
  ...
  if (_rtld_local_ro._dl_debug_mask & (1 << 2))
    {
      _dl_debug_printf ("binding file %s [%lu] to %s [%lu]: %s symbol `%s'",
   ((reference_name)[0] ? (reference_name) : (_dl_argv[0] ?: "<main program>")),
   undef_map->l_ns,
   ((value->m->l_name)[0] ? (value->m->l_name) : (_dl_argv[0] ?: "<main program>")),
   value->m->l_ns,
...
# 1011 "dl-lookup.c"
      ...
      if ((_rtld_local_ro._dl_trace_prelink_map == 
# 1013 "dl-lookup.c" 3 4
                                        ((void *)0)
    
# 1014 "dl-lookup.c"
   || _rtld_local_ro._dl_trace_prelink_map == _rtld_local._dl_ns[0]._ns_loaded)
   && undef_map != _rtld_local._dl_ns[0]._ns_loaded)
 {
   const uint_fast32_t new_hash = dl_new_hash (undef_name);
   unsigned long int old_hash = 0xffffffff;
   struct unique_sym *saved_entries
     = _rtld_local._dl_ns[0]._ns_unique_sym_table.entries;

   _rtld_local._dl_ns[0]._ns_unique_sym_table.entries = 
# 1022 "dl-lookup.c" 3 4
                                                       ((void *)0)
# 1022 "dl-lookup.c"
                                                           ;
   do_lookup_x (undef_name, new_hash, &old_hash, *ref, &val,
         undef_map->l_local_scope[0], 0, version, 0, 
# 1024 "dl-lookup.c" 3 4
                                                    ((void *)0)
# 1024 "dl-lookup.c"
                                                        ,
   ...
   if (val.s != value->s || val.m != value->m)
     ...
     && val.s
     && __builtin_expect (((((unsigned char) (val.s->st_info)) >> 4) == 10), 0)
                       )
     {
...
# 1039 "dl-lookup.c"
  ...
  if (scope->r_list[n]->l_info[16] != 
# 1048 "dl-lookup.c" 3 4
                                              ((void *)0)
...
# 1052 "dl-lookup.c"
   ...
   _rtld_local._dl_ns[0]._ns_unique_sym_table.entries = saved_entries;
 }
      ...
      if (value->s)
 {
   ...
   type_class &= 1 | 2;
   if (__builtin_expect ((((value->s->st_info) & 0xf) == 6), 0)
               )

     type_class = (8|4) & ~8;
   else if (__builtin_expect ((((value->s->st_info) & 0xf) == 10), 0)
                          )
     ...
     type_class |= 8;
      ...
      if (conflict
   || _rtld_local_ro._dl_trace_prelink_map == undef_map
   || _rtld_local_ro._dl_trace_prelink_map == 
# 1080 "dl-lookup.c" 3 4
                                   ((void *)0)
   
# 1081 "dl-lookup.c"
  || type_class >= 4)
 {
   _dl_dprintf (1, "%s 0x%0*Zx 0x%0*Zx -> 0x%0*Zx 0x%0*Zx ", conflict ? "conflict" : "lookup", (int) sizeof (Elf64_Addr) * 2, (size_t) undef_map->l_map_start, (int) sizeof (Elf64_Addr) * 2, (size_t) (((Elf64_Addr) *ref) - undef_map->l_map_start), (int) sizeof (Elf64_Addr) * 2, (size_t) (value->s ? value->m->l_map_start : 0), (int) sizeof (Elf64_Addr) * 2, (size_t) (value->s ? value->s->st_value : 0))
# 1092 "dl-lookup.c"
                                                     ;

   if (conflict)
     _dl_dprintf (1, "x 0x%0*Zx 0x%0*Zx ", (int) sizeof (Elf64_Addr) * 2, (size_t) (val.s ? val.m->l_map_start : 0), (int) sizeof (Elf64_Addr) * 2, (size_t) (val.s ? val.s->st_value : 0))
