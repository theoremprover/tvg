...
extern const int verify_link_map_members[((
# 26 "dl-debug.c" 3 4
                                         __builtin_offsetof (
# 26 "dl-debug.c"
                                         struct link_map_public
...
struct r_debug *
_dl_debug_initialize (Elf64_Addr ldbase, Lmid_t ns)
{
  struct r_debug *r;
  ...
  if (ns == 0)
    ...
    r = &_rtld_local._dl_ns[ns]._ns_debug;
...
# 54 "dl-debug.c"
                      || ldbase != 0)
    {
      ...
      r->r_map = (void *) _rtld_local._dl_ns[ns]._ns_loaded;
      r->r_brk = (Elf64_Addr) &_dl_debug_state;
    }
...
extern __typeof (_dl_debug_state) __EI__dl_debug_state __asm__("" "_dl_debug_state"); extern __typeof (_dl_debug_state) __EI__dl_debug_state __attribute__((alias ("" "__GI__dl_debug_state")));
